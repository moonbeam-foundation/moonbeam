...
docker run --network="host" purestake/moonbeam:v0.9.4 --chain alphanet
```
...
docker run --network="host" purestake/moonbeam:v0.9.4 --dev
```
...
docker run --network="host" purestake/moonbeam:v0.9.4 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" purestake/moonbeam:v0.9.4 --dev --sealing manual
```
