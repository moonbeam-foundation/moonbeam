...
docker run --network="host" purestake/moonbeam:v0.14.1 --chain alphanet
```
...
docker run --network="host" purestake/moonbeam:v0.14.1 --dev
```
...
docker run --network="host" purestake/moonbeam:v0.14.1 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" purestake/moonbeam:v0.14.1 --dev --sealing manual
```
