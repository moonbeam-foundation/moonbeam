...
docker run --network="host" moonbeamfoundation/moonbeam:v0.49.1 --chain alphanet
```
...
docker run --network="host" moonbeamfoundation/moonbeam:v0.49.1 --dev
```
...
docker run --network="host" moonbeamfoundation/moonbeam:v0.49.1 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" moonbeamfoundation/moonbeam:v0.49.1 --dev --sealing manual
```
