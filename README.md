...
docker run --network="host" purestake/moonbeam:v0.27.2 --chain alphanet
```
...
docker run --network="host" purestake/moonbeam:v0.27.2 --dev
```
...
docker run --network="host" purestake/moonbeam:v0.27.2 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" purestake/moonbeam:v0.27.2 --dev --sealing manual
```
