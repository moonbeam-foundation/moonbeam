...
docker run --network="host" purestake/moonbeam:v0.15.0 --chain alphanet
```
...
docker run --network="host" purestake/moonbeam:v0.15.0 --dev
```
...
docker run --network="host" purestake/moonbeam:v0.15.0 --dev --sealing 6000

# Manually control the block authorship and finality
docker run --network="host" purestake/moonbeam:v0.15.0 --dev --sealing manual
```
