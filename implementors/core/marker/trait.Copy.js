...
implementors["moonbase_runtime"] = [{"text":"impl Copy for Runtime","synthetic":false,"types":[]}];
...
implementors["moonriver_runtime"] = [{"text":"impl Copy for Runtime","synthetic":false,"types":[]}];
implementors["moonshadow_runtime"] = [{"text":"impl Copy for Runtime","synthetic":false,"types":[]}];
