...
export default {
  ...
  /**
   * Lookup354: pallet_proxy::ProxyDefinition<account::AccountId20, moonbeam_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup394: pallet_scheduler::ScheduledV2<moonbeam_runtime::Call, BlockNumber, moonbeam_runtime::OriginCaller, account::AccountId20>
   **/
