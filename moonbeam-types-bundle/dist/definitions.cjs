...
__export(definitions_exports, {
  ...
  moonbeamDefinitions: () => moonbeamDefinitions,
  moonbeamDefinitionsDeprecated: () => moonbeamDefinitionsDeprecated,
  types: () => types,
  typesBundleDeprecated: () => typesBundleDeprecated,
  typesBundlePre900: () => typesBundlePre900
});
...
var moonbeamDefinitionsDeprecated = {
  ...moonbeamDefinitions,
  types: [
    ...moonbeamDefinitions.types,
    {
      minmax: [900, void 0],
