...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetIdType: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<MoonbaseRuntimeAssetType>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Reverse mapping of AssetIdType. Mapping from an asset type to an asset id.
       * This is mostly used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetTypeId: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonbaseRuntimeAssetType]> & QueryableStorageEntry<ApiType, [MoonbaseRuntimeAssetType]>;
      /**
       ...
       **/
      assetTypeUnitsPerSecond: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonbaseRuntimeAssetType]> & QueryableStorageEntry<ApiType, [MoonbaseRuntimeAssetType]>;
      /**
       * Generic query
       **/
    ...
    assets: {
       ...
       **/
      account: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<PalletAssetsAssetBalance>, [u128, AccountId20]> & QueryableStorageEntry<ApiType, [u128, AccountId20]>;
      /**
    ...
    democracy: {
       ...
       **/
      blacklist: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<ITuple<[u32, Vec<AccountId20>]>>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       ...
       **/
      depositOf: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[Vec<AccountId20>, u128]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      locks: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<u32>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      publicProps: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, H256, AccountId20]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      votingOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<PalletDemocracyVoteVoting>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parachainStaking: {
       ...
       **/
      atStake: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<ParachainStakingCollatorSnapshot>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       ...
       **/
      bottomDelegations: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingDelegations>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Get collator candidate info associated with an account if account is candidate else None
       **/
      candidateInfo: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingCandidateMetadata>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      candidateState: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingCollatorCandidate>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      collatorState2: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingCollator2>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Delayed payouts
       **/
       ...
       **/
      delegatorState: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingDelegator>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      nominatorState2: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingNominator2>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      topDelegations: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<ParachainStakingDelegations>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
    ...
    xcmTransactor: {
      ...
      transactInfoWithWeightLimit: AugmentedQuery<ApiType, (arg: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<XcmTransactorRemoteTransactInfoWithMaxWeight>>, [XcmV1MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV1MultiLocation]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
