...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * assetType
       **/
      changeExistingAssetType: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, newAssetType: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, MoonbaseRuntimeAssetType]>;
      /**
       * Register new asset with the asset manager
       **/
      registerAsset: AugmentedSubmittable<(asset: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonbaseRuntimeAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array, isSufficient: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeAssetType, MoonbaseRuntimeAssetRegistrarMetadata, u128, bool]>;
      /**
       * Change the amount of units we are charging per execution second for a given AssetId
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeAssetType, u128]>;
      /**
       * Generic tx
       **/
