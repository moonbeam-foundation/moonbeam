...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionLegacyTransaction, MoonbaseRuntimeAssetRegistrarMetadata, MoonbaseRuntimeAssetType, MoonbaseRuntimeCurrencyId, MoonbaseRuntimeProxyType, MoonbaseRuntimeTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, ParachainStakingInflationRangePerbill, ParachainStakingInflationRangeU128, SpCoreChangesTrieChangesTrieConfiguration, SpRuntimeMultiSignature, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      registerAsset: AugmentedSubmittable<(asset: MoonbaseRuntimeAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonbaseRuntimeAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeAssetType, MoonbaseRuntimeAssetRegistrarMetadata, u128]>;
      /**
    ...
    parachainStaking: {
       ...
       **/
      delegate: AugmentedSubmittable<(collator: AccountId20 | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, candidateDelegationCount: u32 | AnyNumber | Uint8Array, delegationCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, u128, u32, u32]>;
      /**
       ...
       **/
      executeLeaveCandidates: AugmentedSubmittable<(candidate: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20]>;
      /**
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbaseRuntimeProxyType> | null | object | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbaseRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    sudo: {
       ...
       * # </weight>
       **/
      sudoAs: AugmentedSubmittable<(who: AccountId20 | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Call]>;
      /**
       * Authenticates the sudo key and dispatches a function call with `Root` origin.
    ...
    xcmTransactor: {
       ...
       **/
      setTransactInfo: AugmentedSubmittable<(location: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, transactExtraWeight: u64 | AnyNumber | Uint8Array, feePerByte: u128 | AnyNumber | Uint8Array, baseWeight: u64 | AnyNumber | Uint8Array, feePerWeight: u128 | AnyNumber | Uint8Array, metadataSize: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, u64, u128, u64, u128, u64]>;
      /**
       ...
       **/
      transactThroughDerivative: AugmentedSubmittable<(dest: MoonbaseRuntimeTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, currencyId: MoonbaseRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array, innerCall: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeTransactors, u16, MoonbaseRuntimeCurrencyId, u64, Bytes]>;
      /**
       * Transact the inner call through a derivative account in a destination chain,
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transfer: AugmentedSubmittable<(currencyId: MoonbaseRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeCurrencyId, u128, XcmVersionedMultiLocation, u64]>;
      /**
       * Transfer `MultiAsset`.
       * 
       * `dest_weight` is the weight for XCM execution on the dest chain, and
