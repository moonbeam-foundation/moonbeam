...
export default {
  ...
  /**
   * Lookup20: frame_system::EventRecord<moonbase_runtime::Event, primitive_types::H256>
   **/
  ...
  /**
   * Lookup36: pallet_evm::pallet::Event<T>
   **/
  PalletEvmEvent: {
    _enum: {
      Log: 'EthereumLog',
  ...
  /**
   * Lookup52: parachain_staking::pallet::DelegationRequest<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup53: parachain_staking::pallet::DelegationChange
   **/
  ParachainStakingDelegationChange: {
    _enum: ['Revoke', 'Decrease']
  },
  /**
   * Lookup54: parachain_staking::pallet::DelegatorAdded<B>
   **/
  ...
  PalletProxyEvent: {
    _enum: {
      ...
      AnonymousCreated: '(AccountId20,AccountId20,MoonbaseRuntimeProxyType,u16)',
      Announced: '(AccountId20,AccountId20,H256)',
      ProxyAdded: '(AccountId20,AccountId20,MoonbaseRuntimeProxyType,u32)'
    }
  },
  /**
  ...
  /**
   * Lookup84: xcm::v2::traits::Outcome
   **/
  XcmV2TraitsOutcome: {
    _enum: {
      Complete: 'u64',
  ...
  /**
   * Lookup85: cumulus_pallet_dmp_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup87: xcm::v1::multilocation::MultiLocation
   **/
  XcmV1MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup88: xcm::v1::multilocation::Junctions
   **/
  ...
  /**
   * Lookup89: xcm::v1::junction::Junction
   **/
  XcmV1Junction: {
    _enum: {
  ...
  PalletAssetsEvent: {
    _enum: {
      Created: '(u128,AccountId20,AccountId20)',
      Issued: '(u128,AccountId20,u128)',
      Transferred: '(u128,AccountId20,AccountId20,u128)',
      Burned: '(u128,AccountId20,u128)',
      TeamChanged: '(u128,AccountId20,AccountId20,AccountId20)',
      OwnerChanged: '(u128,AccountId20)',
      Frozen: '(u128,AccountId20)',
      Thawed: '(u128,AccountId20)',
      AssetFrozen: 'u128',
      AssetThawed: 'u128',
      Destroyed: 'u128',
      ForceCreated: '(u128,AccountId20)',
      MetadataSet: '(u128,Bytes,Bytes,u8,bool)',
      MetadataCleared: 'u128',
      ApprovedTransfer: '(u128,AccountId20,AccountId20,u128)',
      ApprovalCancelled: '(u128,AccountId20,AccountId20)',
      TransferredApproved: '(u128,AccountId20,AccountId20,AccountId20,u128)',
      AssetStatusChanged: 'u128'
    }
  },
  /**
  ...
  OrmlXtokensModuleEvent: {
    _enum: {
      ...
      TransferredMultiAssetWithFee: '(AccountId20,XcmV1MultiAsset,XcmV1MultiAsset,XcmV1MultiLocation)'
    }
  },
  /**
   * Lookup124: moonbase_runtime::CurrencyId
   **/
  ...
  PalletAssetManagerEvent: {
    _enum: {
      ...
      UnitsPerSecondChanged: '(u128,u128)'
    }
  },
  /**
   * Lookup126: moonbase_runtime::AssetType
   **/
  ...
  /**
   * Lookup127: moonbase_runtime::AssetRegistrarMetadata
   **/
  ...
  XcmTransactorEvent: {
    _enum: {
      ...
      TransactInfoChanged: '(XcmV1MultiLocation,XcmTransactorRemoteTransactInfo)'
    }
  },
  /**
   * Lookup130: xcm_transactor::pallet::RemoteTransactInfo
   **/
  XcmTransactorRemoteTransactInfo: {
  ...
  /**
   * Lookup158: polkadot_primitives::v1::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup160: sp_trie::storage_proof::StorageProof
   **/
  SpTrieStorageProof: {
    trieNodes: 'Vec<Bytes>'
  },
  ...
  /**
   * Lookup169: pallet_evm::pallet::Call<T>
   **/
  PalletEvmCall: {
    _enum: {
      withdraw: {
  ...
  /**
   * Lookup171: pallet_ethereum::pallet::Call<T>
   **/
  PalletEthereumCall: {
    _enum: {
      transact: {
  ...
  /**
   * Lookup172: ethereum::transaction::LegacyTransaction
   **/
  ...
  /**
   * Lookup173: ethereum::transaction::TransactionAction
   **/
  ...
  /**
   * Lookup174: ethereum::transaction::TransactionSignature
   **/
  ...
  /**
   * Lookup177: parachain_staking::inflation::Range<T>
   **/
  ...
  /**
   * Lookup178: parachain_staking::inflation::Range<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup179: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  /**
   * Lookup181: pallet_democracy::pallet::Call<T>
   **/
  PalletDemocracyCall: {
    _enum: {
      propose: {
  ...
  /**
   * Lookup184: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup186: pallet_treasury::pallet::Call<T, I>
   **/
  PalletTreasuryCall: {
    _enum: {
      propose_spend: {
  ...
  /**
   * Lookup187: pallet_author_inherent::pallet::Call<T>
   **/
  PalletAuthorInherentCall: {
    _enum: ['kick_off_authorship_validation']
  },
  /**
   * Lookup188: pallet_author_slot_filter::pallet::Call<T>
   **/
  ...
  /**
   * Lookup189: pallet_crowdloan_rewards::pallet::Call<T>
   **/
  ...
  /**
   * Lookup191: sp_core::ed25519::Signature
   **/
  ...
  /**
   * Lookup200: pallet_author_mapping::pallet::Call<T>
   **/
  ...
  /**
   * Lookup205: pallet_identity::types::IdentityInfo<FieldLimit>
   **/
  ...
  /**
   * Lookup247: xcm::VersionedXcm<Call>
   **/
  XcmVersionedXcm: {
    _enum: {
      V0: 'XcmV0Xcm',
  ...
  /**
   * Lookup250: xcm::v0::order::Order<Call>
   **/
  XcmV0Order: {
    _enum: {
      Null: 'Null',
  ...
  /**
   * Lookup255: xcm::v1::order::Order<Call>
   **/
  XcmV1Order: {
    _enum: {
      Noop: 'Null',
  ...
  /**
   * Lookup271: pallet_assets::pallet::Call<T, I>
   **/
  PalletAssetsCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup272: pallet_assets::types::DestroyWitness
   **/
  ...
  /**
   * Lookup273: orml_xtokens::module::Call<T>
   **/
  ...
  /**
   * Lookup274: xcm::VersionedMultiAsset
   **/
  ...
  /**
   * Lookup275: pallet_asset_manager::pallet::Call<T>
   **/
  ...
  /**
   * Lookup276: xcm_transactor::pallet::Call<T>
   **/
  XcmTransactorCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup277: moonbase_runtime::Transactors
   **/
  MoonbaseRuntimeTransactors: {
    _enum: ['Relay']
  },
  /**
   * Lookup278: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls']
  },
  ...
  /**
   * Lookup286: pallet_balances::Releases
   **/
  ...
  /**
   * Lookup288: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo']
  },
  /**
   * Lookup290: polkadot_primitives::v1::UpgradeRestriction
   **/
  ...
  /**
   * Lookup294: polkadot_primitives::v1::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup295: polkadot_primitives::v1::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup306: frame_support::weights::WeightToFeeCoefficient<Balance>
   **/
  ...
  /**
   * Lookup316: ethereum::receipt::Receipt
   **/
  EthereumReceipt: {
    stateRoot: 'H256',
    usedGas: 'U256',
  ...
  /**
   * Lookup317: ethereum::block::Block<ethereum::transaction::LegacyTransaction>
   **/
  EthereumBlock: {
  ...
  /**
   * Lookup318: ethereum::header::Header
   **/
  EthereumHeader: {
    parentHash: 'H256',
    ommersHash: 'H256',
  ...
  /**
   * Lookup319: ethereum_types::hash::H64
   **/
  EthereumTypesHashH64: '[u8;8]',
  /**
   * Lookup324: pallet_ethereum::pallet::Error<T>
   **/
  PalletEthereumError: {
    _enum: ['InvalidSignature', 'PreLogExists']
  },
  /**
   * Lookup325: parachain_staking::pallet::ParachainBondConfig<account::AccountId20>
   **/
  ...
  /**
   * Lookup326: parachain_staking::pallet::RoundInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup327: parachain_staking::pallet::Nominator2<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup328: parachain_staking::set::OrderedSet<parachain_staking::pallet::Bond<account::AccountId20, Balance>>
   **/
  ParachainStakingSetOrderedSetBond: 'Vec<ParachainStakingBond>',
  /**
   * Lookup329: parachain_staking::pallet::Bond<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup331: parachain_staking::set::OrderedSet<account::AccountId20>
   **/
  ParachainStakingSetOrderedSetAccountId20: 'Vec<AccountId20>',
  /**
   * Lookup332: parachain_staking::pallet::DelegatorStatus
   **/
  ...
  /**
   * Lookup333: parachain_staking::pallet::Delegator<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup334: parachain_staking::pallet::PendingDelegationRequests<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup338: parachain_staking::pallet::CollatorCandidate<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup340: parachain_staking::pallet::CandidateBondLessRequest<Balance>
   **/
  ...
  /**
   * Lookup341: parachain_staking::pallet::CollatorStatus
   **/
  ...
  /**
   * Lookup342: parachain_staking::pallet::Collator2<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup343: parachain_staking::pallet::ExitQ<account::AccountId20>
   **/
  ...
  /**
   * Lookup349: parachain_staking::pallet::CollatorSnapshot<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup350: parachain_staking::pallet::DelayedPayout<Balance>
   **/
  ...
  /**
   * Lookup351: parachain_staking::inflation::InflationInfo<Balance>
   **/
  ...
  /**
   * Lookup352: parachain_staking::pallet::Error<T>
   **/
  ...
  /**
   * Lookup355: pallet_scheduler::ScheduledV2<moonbase_runtime::Call, BlockNumber, moonbase_runtime::OriginCaller, account::AccountId20>
   **/
  ...
  /**
   * Lookup356: moonbase_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup357: frame_system::RawOrigin<account::AccountId20>
   **/
  ...
  /**
   * Lookup359: pallet_collective::RawOrigin<account::AccountId20, I>
   **/
  ...
  /**
   * Lookup361: cumulus_pallet_xcm::pallet::Origin
   **/
  ...
  /**
   * Lookup362: pallet_xcm::pallet::Origin
   **/
  PalletXcmOrigin: {
    _enum: {
      Xcm: 'XcmV1MultiLocation',
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup364: pallet_scheduler::Releases
   **/
  ...
  /**
   * Lookup369: pallet_democracy::PreimageStatus<account::AccountId20, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup373: pallet_democracy::vote::Voting<Balance, account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup383: pallet_collective::Votes<account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup387: pallet_treasury::Proposal<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup394: pallet_crowdloan_rewards::pallet::RewardInfo<T>
   **/
  ...
  /**
   * Lookup396: pallet_crowdloan_rewards::pallet::Error<T>
   **/
  ...
  /**
   * Lookup397: pallet_author_mapping::pallet::RegistrationInfo<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup398: pallet_author_mapping::pallet::Error<T>
   **/
  PalletAuthorMappingError: {
    _enum: ['AssociationNotFound', 'NotYourAssociation', 'CannotAffordSecurityDeposit', 'AlreadyAssociated']
  },
  /**
   * Lookup401: pallet_proxy::ProxyDefinition<account::AccountId20, moonbase_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup405: pallet_proxy::Announcement<account::AccountId20, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup408: pallet_maintenance_mode::pallet::Error<T>
   **/
  ...
  /**
   * Lookup417: pallet_identity::types::RegistrarInfo<Balance, account::AccountId20>
   **/
  ...
  /**
   * Lookup422: cumulus_pallet_xcmp_queue::InboundStatus
   **/
  CumulusPalletXcmpQueueInboundStatus: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup425: polkadot_parachain::primitives::XcmpMessageFormat
   **/
  PolkadotParachainPrimitivesXcmpMessageFormat: {
    _enum: ['ConcatenatedVersionedXcm', 'ConcatenatedEncodedBlob', 'Signals']
  },
  /**
   * Lookup429: cumulus_pallet_xcmp_queue::OutboundStatus
   **/
  CumulusPalletXcmpQueueOutboundStatus: {
    _enum: ['Ok', 'Suspended']
  },
  /**
   * Lookup431: cumulus_pallet_xcmp_queue::QueueConfigData
   **/
  ...
  /**
   * Lookup432: cumulus_pallet_xcmp_queue::pallet::Error<T>
   **/
  ...
  /**
   * Lookup449: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
    _enum: ['Unreachable', 'SendFailure', 'Filtered', 'UnweighableMessage', 'DestinationNotInvertible', 'Empty', 'CannotReanchor', 'TooManyAssets', 'InvalidOrigin', 'BadVersion', 'BadLocation', 'NoSubscription', 'AlreadySubscribed']
  },
  /**
   * Lookup450: pallet_assets::types::AssetDetails<Balance, account::AccountId20, DepositBalance>
   **/
  ...
  /**
   * Lookup452: pallet_assets::types::AssetBalance<Balance, Extra>
   **/
  ...
  /**
   * Lookup455: pallet_assets::types::AssetMetadata<DepositBalance, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup459: pallet_asset_manager::pallet::Error<T>
   **/
  PalletAssetManagerError: {
    _enum: ['ErrorCreatingAsset', 'AssetAlreadyExists', 'AssetDoesNotExist']
  },
  /**
   * Lookup460: xcm_transactor::pallet::Error<T>
   **/
  XcmTransactorError: {
  ...
  /**
   * Lookup462: account::EthereumSignature
   **/
  AccountEthereumSignature: 'SpCoreEcdsaSignature',
  /**
   * Lookup464: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup465: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup466: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup469: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup470: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup471: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup473: moonbase_runtime::Runtime
   **/
