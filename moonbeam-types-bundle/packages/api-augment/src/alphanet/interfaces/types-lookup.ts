...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletSudoEvent extends Enum {
    ...
    readonly asKeyChanged: AccountId20;
  ...
  /** @name EvmCoreErrorExitRevert (48) */
  export interface EvmCoreErrorExitRevert extends Enum {
    readonly isReverted: boolean;
    readonly type: 'Reverted';
  }

  /** @name EvmCoreErrorExitFatal (49) */
  ...
  /** @name ParachainStakingDelegationRequest (52) */
  ...
  /** @name ParachainStakingDelegationChange (53) */
  ...
  /** @name ParachainStakingDelegatorAdded (54) */
  ...
  /** @name PalletDemocracyVoteThreshold (62) */
  ...
  /** @name PalletDemocracyVoteAccountVote (63) */
  ...
  export interface PalletProxyEvent extends Enum {
    ...
    readonly asAnonymousCreated: ITuple<[AccountId20, AccountId20, MoonbaseRuntimeProxyType, u16]>;
    readonly isAnnounced: boolean;
    readonly asAnnounced: ITuple<[AccountId20, AccountId20, H256]>;
    readonly isProxyAdded: boolean;
    readonly asProxyAdded: ITuple<[AccountId20, AccountId20, MoonbaseRuntimeProxyType, u32]>;
  ...
  /** @name CumulusPalletDmpQueueEvent (85) */
  ...
  /** @name XcmV1MultiLocation (87) */
  export interface XcmV1MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV1MultilocationJunctions;
  }

  /** @name XcmV1MultilocationJunctions (88) */
  ...
  export interface PalletAssetsEvent extends Enum {
    readonly isCreated: boolean;
    readonly asCreated: ITuple<[u128, AccountId20, AccountId20]>;
    readonly isIssued: boolean;
    readonly asIssued: ITuple<[u128, AccountId20, u128]>;
    readonly isTransferred: boolean;
    readonly asTransferred: ITuple<[u128, AccountId20, AccountId20, u128]>;
    readonly isBurned: boolean;
    readonly asBurned: ITuple<[u128, AccountId20, u128]>;
    readonly isTeamChanged: boolean;
    readonly asTeamChanged: ITuple<[u128, AccountId20, AccountId20, AccountId20]>;
    readonly isOwnerChanged: boolean;
    readonly asOwnerChanged: ITuple<[u128, AccountId20]>;
    readonly isFrozen: boolean;
    readonly asFrozen: ITuple<[u128, AccountId20]>;
    readonly isThawed: boolean;
    readonly asThawed: ITuple<[u128, AccountId20]>;
    readonly isAssetFrozen: boolean;
    readonly asAssetFrozen: u128;
    readonly isAssetThawed: boolean;
    readonly asAssetThawed: u128;
    readonly isDestroyed: boolean;
    readonly asDestroyed: u128;
    readonly isForceCreated: boolean;
    readonly asForceCreated: ITuple<[u128, AccountId20]>;
    readonly isMetadataSet: boolean;
    readonly asMetadataSet: ITuple<[u128, Bytes, Bytes, u8, bool]>;
    readonly isMetadataCleared: boolean;
    readonly asMetadataCleared: u128;
    readonly isApprovedTransfer: boolean;
    readonly asApprovedTransfer: ITuple<[u128, AccountId20, AccountId20, u128]>;
    readonly isApprovalCancelled: boolean;
    readonly asApprovalCancelled: ITuple<[u128, AccountId20, AccountId20]>;
    readonly isTransferredApproved: boolean;
    readonly asTransferredApproved: ITuple<[u128, AccountId20, AccountId20, AccountId20, u128]>;
    readonly isAssetStatusChanged: boolean;
    readonly asAssetStatusChanged: u128;
  ...
  /** @name MoonbaseRuntimeCurrencyId (124) */
  ...
  /** @name PalletAssetManagerEvent (125) */
  export interface PalletAssetManagerEvent extends Enum {
    ...
    readonly asUnitsPerSecondChanged: ITuple<[u128, u128]>;
    readonly type: 'AssetRegistered' | 'UnitsPerSecondChanged';
  }

  /** @name MoonbaseRuntimeAssetType (126) */
  ...
  /** @name MoonbaseRuntimeAssetRegistrarMetadata (127) */
  ...
  /** @name PalletMigrationsEvent (128) */
  ...
  export interface XcmTransactorEvent extends Enum {
    ...
    readonly asTransactInfoChanged: ITuple<[XcmV1MultiLocation, XcmTransactorRemoteTransactInfo]>;
    readonly type: 'TransactedDerivative' | 'TransactedSovereign' | 'RegisterdDerivative' | 'TransactFailed' | 'TransactInfoChanged';
  }

  /** @name XcmTransactorRemoteTransactInfo (130) */
  export interface XcmTransactorRemoteTransactInfo extends Struct {
    readonly transactExtraWeight: u64;
    readonly feePerByte: u128;
    readonly metadataSize: u64;
    readonly baseWeight: u64;
    readonly feePerWeight: u128;
  }
  ...
  /** @name PolkadotPrimitivesV1PersistedValidationData (158) */
  ...
  /** @name EthereumTransactionLegacyTransaction (172) */
  ...
  /** @name EthereumTransactionTransactionAction (173) */
  ...
  /** @name EthereumTransactionTransactionSignature (174) */
  ...
  /** @name ParachainStakingInflationRangeU128 (177) */
  ...
  /** @name ParachainStakingInflationRangePerbill (178) */
  ...
  /** @name PalletAuthorInherentCall (187) */
  ...
  /** @name PalletAuthorSlotFilterCall (188) */
  ...
  /** @name PalletCrowdloanRewardsCall (189) */
  ...
  /** @name SpCoreEd25519Signature (191) */
  ...
  /** @name PalletAuthorMappingCall (200) */
  ...
  /** @name PalletIdentityIdentityInfo (205) */
  ...
  /** @name PalletAssetsDestroyWitness (272) */
  ...
  /** @name OrmlXtokensModuleCall (273) */
  ...
  /** @name XcmVersionedMultiAsset (274) */
  ...
  /** @name PalletAssetManagerCall (275) */
  export interface PalletAssetManagerCall extends Enum {
    ...
    readonly type: 'RegisterAsset' | 'SetAssetUnitsPerSecond';
  }

  /** @name XcmTransactorCall (276) */
  ...
  /** @name MoonbaseRuntimeTransactors (277) */
  export interface MoonbaseRuntimeTransactors extends Enum {
    readonly isRelay: boolean;
    readonly type: 'Relay';
  }

  /** @name PalletUtilityError (278) */
  ...
  /** @name PalletBalancesReleases (286) */
  ...
  /** @name PalletSudoError (288) */
  export interface PalletSudoError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PolkadotPrimitivesV1UpgradeRestriction (290) */
  ...
  /** @name PolkadotPrimitivesV1AbridgedHrmpChannel (294) */
  ...
  /** @name PolkadotPrimitivesV1AbridgedHostConfiguration (295) */
  ...
  /** @name FrameSupportWeightsWeightToFeeCoefficient (306) */
  ...
  /** @name EthereumTypesHashH64 (319) */
  export interface EthereumTypesHashH64 extends U8aFixed {}

  /** @name PalletEthereumError (324) */
  ...
  /** @name ParachainStakingParachainBondConfig (325) */
  export interface ParachainStakingParachainBondConfig extends Struct {
    readonly account: AccountId20;
    readonly percent: Percent;
  }

  /** @name ParachainStakingRoundInfo (326) */
  ...
  /** @name ParachainStakingNominator2 (327) */
  ...
  /** @name ParachainStakingDelegator (333) */
  ...
  /** @name ParachainStakingPendingDelegationRequests (334) */
  ...
  /** @name ParachainStakingCollatorCandidate (338) */
  ...
  /** @name ParachainStakingCandidateBondLessRequest (340) */
  export interface ParachainStakingCandidateBondLessRequest extends Struct {
    readonly amount: u128;
    readonly whenExecutable: u32;
  }

  /** @name ParachainStakingCollatorStatus (341) */
  ...
  /** @name ParachainStakingCollator2 (342) */
  ...
  /** @name ParachainStakingExitQ (343) */
  ...
  /** @name ParachainStakingCollatorSnapshot (349) */
  ...
  /** @name ParachainStakingDelayedPayout (350) */
  ...
  /** @name ParachainStakingInflationInflationInfo (351) */
  ...
  /** @name ParachainStakingError (352) */
  ...
  /** @name PalletSchedulerScheduledV2 (355) */
  ...
  /** @name MoonbaseRuntimeOriginCaller (356) */
  ...
  /** @name CumulusPalletXcmOrigin (361) */
  ...
  /** @name PalletSchedulerReleases (364) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (394) */
  ...
  /** @name PalletCrowdloanRewardsError (396) */
  ...
  /** @name PalletAuthorMappingRegistrationInfo (397) */
  export interface PalletAuthorMappingRegistrationInfo extends Struct {
    readonly account: AccountId20;
    readonly deposit: u128;
  }

  /** @name PalletAuthorMappingError (398) */
  ...
  /** @name CumulusPalletXcmpQueueInboundStatus (422) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (425) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundStatus (429) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (431) */
  ...
  /** @name CumulusPalletXcmpQueueError (432) */
  ...
  /** @name PalletAssetsAssetDetails (450) */
  ...
  /** @name PalletAssetsAssetBalance (452) */
  ...
  /** @name PalletAssetManagerError (459) */
  ...
  /** @name AccountEthereumSignature (462) */
  export interface AccountEthereumSignature extends SpCoreEcdsaSignature {}

  /** @name FrameSystemExtensionsCheckSpecVersion (464) */
  export type FrameSystemExtensionsCheckSpecVersion = Null;

  /** @name FrameSystemExtensionsCheckTxVersion (465) */
  export type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (466) */
  export type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (469) */
  export interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (470) */
  export type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (471) */
  export interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name MoonbaseRuntimeRuntime (473) */
