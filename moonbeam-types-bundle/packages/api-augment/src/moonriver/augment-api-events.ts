...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [AccountId20, AccountId20, MoonriverRuntimeProxyType, u16]>;
      /**
       * A proxy was added. \[delegator, delegatee, proxy_type, delay\]
       **/
      ProxyAdded: AugmentedEvent<ApiType, [AccountId20, AccountId20, MoonriverRuntimeProxyType, u32]>;
      /**
    ...
    xcmTransactor: {
      ...
      TransactInfoChanged: AugmentedEvent<ApiType, [XcmV1MultiLocation, XcmTransactorRemoteTransactInfo]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xTokens: {
       ...
       **/
      Transferred: AugmentedEvent<ApiType, [AccountId20, MoonriverRuntimeCurrencyId, u128, XcmV1MultiLocation]>;
      /**
       ...
       **/
      TransferredWithFee: AugmentedEvent<ApiType, [AccountId20, MoonriverRuntimeCurrencyId, u128, u128, XcmV1MultiLocation]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
