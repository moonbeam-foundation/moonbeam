...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      registerAsset: AugmentedSubmittable<(asset: MoonriverRuntimeAssetType | { Xcm: any } | string | Uint8Array, metadata: MoonriverRuntimeAssetRegistrarMetadata | { name?: any; symbol?: any; decimals?: any; isFrozen?: any } | string | Uint8Array, minAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeAssetType, MoonriverRuntimeAssetRegistrarMetadata, u128]>;
      /**
    ...
    proxy: {
       ...
       * # </weight>
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonriverRuntimeProxyType, u32]>;
      /**
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonriverRuntimeProxyType> | null | object | string | Uint8Array, call: Call | { callIndex?: any; args?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonriverRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonriverRuntimeProxyType, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    xcmTransactor: {
       ...
       **/
      transactThroughDerivative: AugmentedSubmittable<(dest: MoonriverRuntimeTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, currencyId: MoonriverRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array, innerCall: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeTransactors, u16, MoonriverRuntimeCurrencyId, u64, Bytes]>;
      /**
       * Transact the inner call through a derivative account in a destination chain,
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transfer: AugmentedSubmittable<(currencyId: MoonriverRuntimeCurrencyId | { SelfReserve: any } | { OtherReserve: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeCurrencyId, u128, XcmVersionedMultiLocation, u64]>;
      /**
       * Transfer `MultiAsset`.
       * 
       * `dest_weight` is the weight for XCM execution on the dest chain, and
