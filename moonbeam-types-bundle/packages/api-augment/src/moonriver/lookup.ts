...
export default {
  ...
  /**
   * Lookup20: frame_system::EventRecord<moonriver_runtime::Event, primitive_types::H256>
   **/
  ...
  PalletProxyEvent: {
    _enum: {
      ...
      AnonymousCreated: '(AccountId20,AccountId20,MoonriverRuntimeProxyType,u16)',
      Announced: '(AccountId20,AccountId20,H256)',
      ProxyAdded: '(AccountId20,AccountId20,MoonriverRuntimeProxyType,u32)'
    }
  },
  /**
   * Lookup47: moonriver_runtime::ProxyType
   **/
  ...
  /**
   * Lookup123: pallet_asset_manager::pallet::Event<T>
   **/
  ...
  /**
   * Lookup124: moonriver_runtime::AssetType
   **/
  ...
  /**
   * Lookup125: moonriver_runtime::AssetRegistrarMetadata
   **/
  ...
  /**
   * Lookup127: moonriver_runtime::CurrencyId
   **/
  ...
  /**
   * Lookup129: xcm_transactor::pallet::RemoteTransactInfo
   **/
  ...
  /**
   * Lookup149: polkadot_primitives::v1::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup152: polkadot_primitives::v1::UpgradeRestriction
   **/
  ...
  /**
   * Lookup157: polkadot_primitives::v1::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup158: polkadot_primitives::v1::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup190: frame_support::weights::WeightToFeeCoefficient<Balance>
   **/
  ...
  /**
   * Lookup191: parachain_staking::pallet::ParachainBondConfig<account::AccountId20>
   **/
  ...
  /**
   * Lookup192: parachain_staking::pallet::RoundInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup193: parachain_staking::pallet::Nominator2<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup194: parachain_staking::set::OrderedSet<parachain_staking::pallet::Bond<account::AccountId20, Balance>>
   **/
  ParachainStakingSetOrderedSetBond: 'Vec<ParachainStakingBond>',
  /**
   * Lookup195: parachain_staking::pallet::Bond<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup197: parachain_staking::set::OrderedSet<account::AccountId20>
   **/
  ParachainStakingSetOrderedSetAccountId20: 'Vec<AccountId20>',
  /**
   * Lookup198: parachain_staking::pallet::DelegatorStatus
   **/
  ...
  /**
   * Lookup199: parachain_staking::pallet::Delegator<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup200: parachain_staking::pallet::PendingDelegationRequests<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup204: parachain_staking::pallet::CollatorCandidate<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup206: parachain_staking::pallet::CandidateBondLessRequest<Balance>
   **/
  ...
  /**
   * Lookup207: parachain_staking::pallet::CollatorStatus
   **/
  ...
  /**
   * Lookup208: parachain_staking::pallet::Collator2<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup209: parachain_staking::pallet::ExitQ<account::AccountId20>
   **/
  ...
  /**
   * Lookup276: pallet_ethereum::pallet::Call<T>
   **/
  PalletEthereumCall: {
    _enum: {
      transact: {
  ...
  /**
   * Lookup283: pallet_democracy::pallet::Call<T>
   **/
  PalletDemocracyCall: {
    _enum: {
      propose: {
  ...
  /**
   * Lookup284: pallet_democracy::conviction::Conviction
   **/
  ...
  /**
   * Lookup289: pallet_crowdloan_rewards::pallet::Call<T>
   **/
  ...
  /**
   * Lookup291: sp_core::ed25519::Signature
   **/
  ...
  /**
   * Lookup327: pallet_assets::types::DestroyWitness
   **/
  ...
  /**
   * Lookup331: xcm_transactor::pallet::Call<T>
   **/
  XcmTransactorCall: {
    _enum: {
      register: {
  ...
  /**
   * Lookup332: moonriver_runtime::Transactors
   **/
  ...
  /**
   * Lookup336: pallet_proxy::ProxyDefinition<account::AccountId20, moonriver_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup340: pallet_proxy::Announcement<account::AccountId20, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup343: pallet_maintenance_mode::pallet::Error<T>
   **/
  ...
  /**
   * Lookup352: pallet_identity::types::RegistrarInfo<Balance, account::AccountId20>
   **/
  ...
  /**
   * Lookup356: pallet_evm::pallet::Error<T>
   **/
  PalletEvmError: {
    _enum: ['BalanceLow', 'FeeOverflow', 'PaymentOverflow', 'WithdrawFailed', 'GasPriceTooLow', 'InvalidNonce']
  },
  /**
   * Lookup359: fp_rpc::TransactionStatus
   **/
  ...
  /**
   * Lookup362: ethbloom::Bloom
   **/
  EthbloomBloom: '[u8;256]',
  /**
   * Lookup364: ethereum::receipt::Receipt
   **/
  EthereumReceipt: {
    stateRoot: 'H256',
    usedGas: 'U256',
  ...
  /**
   * Lookup365: ethereum::block::Block<ethereum::transaction::LegacyTransaction>
   **/
  EthereumBlock: {
  ...
  /**
   * Lookup375: pallet_scheduler::ScheduledV2<moonriver_runtime::Call, BlockNumber, moonriver_runtime::OriginCaller, account::AccountId20>
   **/
  ...
  /**
   * Lookup376: moonriver_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup377: frame_system::RawOrigin<account::AccountId20>
   **/
  ...
  /**
   * Lookup379: pallet_collective::RawOrigin<account::AccountId20, I>
   **/
  ...
  /**
   * Lookup389: pallet_democracy::PreimageStatus<account::AccountId20, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup393: pallet_democracy::vote::Voting<Balance, account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup403: pallet_collective::Votes<account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup407: pallet_treasury::Proposal<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup415: pallet_crowdloan_rewards::pallet::Error<T>
   **/
  ...
  /**
   * Lookup418: cumulus_pallet_xcmp_queue::InboundStatus
   **/
  ...
  /**
   * Lookup425: cumulus_pallet_xcmp_queue::OutboundStatus
   **/
  ...
  /**
   * Lookup428: cumulus_pallet_xcmp_queue::pallet::Error<T>
   **/
  ...
  /**
   * Lookup446: pallet_assets::types::AssetDetails<Balance, account::AccountId20, DepositBalance>
   **/
  ...
  /**
   * Lookup448: pallet_assets::types::AssetBalance<Balance, Extra>
   **/
  ...
  /**
   * Lookup450: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup451: pallet_assets::types::AssetMetadata<DepositBalance, frame_support::storage::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup453: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup454: pallet_asset_manager::pallet::Error<T>
   **/
  ...
  /**
   * Lookup456: xcm_transactor::pallet::Error<T>
   **/
  XcmTransactorError: {
  ...
  /**
   * Lookup458: account::EthereumSignature
   **/
  ...
  /**
   * Lookup469: moonriver_runtime::Runtime
   **/
