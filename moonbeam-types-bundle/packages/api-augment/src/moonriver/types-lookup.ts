...
declare module '@polkadot/types/lookup' {
  ...
  export interface PalletProxyEvent extends Enum {
    ...
    readonly asAnonymousCreated: ITuple<[AccountId20, AccountId20, MoonriverRuntimeProxyType, u16]>;
    readonly isAnnounced: boolean;
    readonly asAnnounced: ITuple<[AccountId20, AccountId20, H256]>;
    readonly isProxyAdded: boolean;
    readonly asProxyAdded: ITuple<[AccountId20, AccountId20, MoonriverRuntimeProxyType, u32]>;
    readonly type: 'ProxyExecuted' | 'AnonymousCreated' | 'Announced' | 'ProxyAdded';
  }

  /** @name MoonriverRuntimeProxyType (47) */
  ...
  /** @name PalletAssetManagerEvent (123) */
  export interface PalletAssetManagerEvent extends Enum {
    readonly isAssetRegistered: boolean;
    readonly asAssetRegistered: ITuple<[u128, MoonriverRuntimeAssetType, MoonriverRuntimeAssetRegistrarMetadata]>;
  ...
  /** @name MoonriverRuntimeAssetType (124) */
  ...
  /** @name MoonriverRuntimeAssetRegistrarMetadata (125) */
  ...
  export interface OrmlXtokensModuleEvent extends Enum {
    readonly isTransferred: boolean;
    readonly asTransferred: ITuple<[AccountId20, MoonriverRuntimeCurrencyId, u128, XcmV1MultiLocation]>;
    readonly isTransferredWithFee: boolean;
    readonly asTransferredWithFee: ITuple<[AccountId20, MoonriverRuntimeCurrencyId, u128, u128, XcmV1MultiLocation]>;
  ...
  /** @name MoonriverRuntimeCurrencyId (127) */
  ...
  /** @name XcmTransactorRemoteTransactInfo (129) */
  ...
  /** @name PolkadotPrimitivesV1PersistedValidationData (149) */
  ...
  /** @name PolkadotPrimitivesV1UpgradeRestriction (152) */
  ...
  /** @name PolkadotPrimitivesV1AbridgedHrmpChannel (157) */
  ...
  /** @name PolkadotPrimitivesV1AbridgedHostConfiguration (158) */
  ...
  /** @name FrameSupportWeightsWeightToFeeCoefficient (190) */
  ...
  /** @name ParachainStakingNominator2 (193) */
  ...
  /** @name ParachainStakingDelegator (199) */
  ...
  /** @name ParachainStakingPendingDelegationRequests (200) */
  ...
  /** @name ParachainStakingCollatorCandidate (204) */
  ...
  /** @name ParachainStakingCandidateBondLessRequest (206) */
  export interface ParachainStakingCandidateBondLessRequest extends Struct {
    readonly amount: u128;
    readonly whenExecutable: u32;
  }

  /** @name ParachainStakingCollatorStatus (207) */
  ...
  /** @name ParachainStakingCollator2 (208) */
  ...
  /** @name ParachainStakingExitQ (209) */
  ...
  /** @name PalletDemocracyConviction (284) */
  ...
  /** @name PalletCrowdloanRewardsCall (289) */
  ...
  /** @name SpCoreEd25519Signature (291) */
  ...
  /** @name PalletAssetsDestroyWitness (327) */
  ...
  /** @name MoonriverRuntimeTransactors (332) */
  ...
  /** @name PalletMaintenanceModeError (343) */
  ...
  /** @name FpRpcTransactionStatus (359) */
  ...
  /** @name EthbloomBloom (362) */
  export interface EthbloomBloom extends U8aFixed {}

  /** @name EthereumReceipt (364) */
  ...
  /** @name PalletSchedulerScheduledV2 (375) */
  ...
  /** @name MoonriverRuntimeOriginCaller (376) */
  ...
  /** @name PalletTreasuryProposal (407) */
  ...
  /** @name PalletCrowdloanRewardsError (415) */
  ...
  /** @name CumulusPalletXcmpQueueInboundStatus (418) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundStatus (425) */
  ...
  /** @name CumulusPalletXcmpQueueError (428) */
  ...
  /** @name PalletAssetsAssetBalance (448) */
  ...
  /** @name PalletAssetsApproval (450) */
  export interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (451) */
  ...
  /** @name PalletAssetManagerError (454) */
  ...
  /** @name AccountEthereumSignature (458) */
  ...
  /** @name MoonriverRuntimeRuntime (469) */
