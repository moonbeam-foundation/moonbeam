		...
		Executor: NativeExecutionDispatch + 'static,
{
	...
	fn run(&mut self, context: &TestContext<RuntimeApi, Executor>) -> Result<Vec<TestResults>, String>
	{
		...
		*/
		...
		let storage_bloater_bytecode = hex::decode(storage_bloater_hex)
			.expect("storage_bloater_hex is valid hex; qed");
		...
		results.push(TestResults::new("storage bloat contract creation", now.elapsed()));
