	...
	P: TransactionPool<Block=Block> + 'static,
{
	...
	// We currently don't want to support signing in the node. We prefer users to use external tools to sign transactions.
	// So just pass in an empty vector of signers.
	let signers = Vec::new();
	io.extend_with(
