...
use sc_client_api::{
	Backend, BadBlocks, BlockImportOperation, ExecutorProvider, ForkBlocks, NewBlockState,
};
...
{
	let backend = backend::new_lazy_loading_backend(&lazy_loading_config)?;
	...
	let _ = helpers::produce_first_block(backend.clone(), last_block, state_overrides)?;
	...
	Net: NetworkBackend<Block, Hash>,
{
	...
	log::info!("Forked Chain Service Ready");
