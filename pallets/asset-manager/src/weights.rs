...
// 
// --output
// pallets/asset-manager/src/weights.rs
...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_275_459, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 613
			.saturating_add(Weight::from_parts(11_044, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_844_217, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 650
			.saturating_add(Weight::from_parts(11_568, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
