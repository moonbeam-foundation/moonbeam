...
//! DATE: 2021-09-17, STEPS: `32`, REPEAT: 64, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn set_parachain_bond_reserve_percent() -> Weight {
		(21_299_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn set_total_selected() -> Weight {
		(20_630_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn set_collator_commission() -> Weight {
		(20_445_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	fn set_blocks_per_round() -> Weight {
	...
	fn go_online() -> Weight {
		(37_237_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(7 as Weight))
			.saturating_add(T::DbWeight::get().writes(4 as Weight))
	}
	fn candidate_bond_more() -> Weight {
		(60_957_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(8 as Weight))
			.saturating_add(T::DbWeight::get().writes(6 as Weight))
	}
	fn candidate_bond_less() -> Weight {
	...
	fn nominate(x: u32, y: u32) -> Weight {
		(86_279_000 as Weight)
			...
			.saturating_add((662_000 as Weight).saturating_mul(x as Weight))
			// Standard Error: 3_000
			.saturating_add((716_000 as Weight).saturating_mul(y as Weight))
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().writes(7 as Weight))
	}
	fn leave_nominators(x: u32) -> Weight {
		(39_624_000 as Weight)
	...
	fn nominator_bond_more() -> Weight {
		(71_358_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().writes(7 as Weight))
	}
	fn nominator_bond_less() -> Weight {
		(71_183_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(9 as Weight))
			.saturating_add(T::DbWeight::get().writes(7 as Weight))
	}
	fn active_on_initialize(x: u32, y: u32) -> Weight {
		(0 as Weight)
			...
			.saturating_add((134_913_000 as Weight).saturating_mul(x as Weight))
			// Standard Error: 7_000
			.saturating_add((876_000 as Weight).saturating_mul(y as Weight))
			...
			.saturating_add(T::DbWeight::get().writes(90 as Weight))
			.saturating_add(T::DbWeight::get().writes((4 as Weight).saturating_mul(x as Weight)))
	}
	fn passive_on_initialize() -> Weight {
		(5_386_000 as Weight).saturating_add(T::DbWeight::get().reads(1 as Weight))
	}
}
...
impl WeightInfo for () {
	...
	fn active_on_initialize(x: u32, y: u32) -> Weight {
		(0 as Weight)
			...
			.saturating_add(RocksDbWeight::get().writes(90 as Weight))
			.saturating_add(RocksDbWeight::get().writes((4 as Weight).saturating_mul(x as Weight)))
	}
	fn passive_on_initialize() -> Weight {
		(5_386_000 as Weight).saturating_add(RocksDbWeight::get().reads(1 as Weight))
	}
}
