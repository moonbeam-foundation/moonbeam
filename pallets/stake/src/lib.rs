...
impl<T: Config> pallet_authorship::EventHandler<T::AccountId, T::BlockNumber> for Module<T>
{
	...
	fn note_uncle(_author: T::AccountId, _age: T::BlockNumber) {
		// This staking pallet does not currently suppor tuncles.
		// Actually there is no reason this pallet couldn't support uncles. It's really the author
		// If we keep this inherent-based approach long-term maybe we could add an uncle-inherent.
		unimplemented!()
	}
}
