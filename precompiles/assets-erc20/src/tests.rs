	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(49346756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					ForeignAssetId(0u128),
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(69846756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					ForeignAssetId(0u128),
					SELECTOR_LOG_TRANSFER,
					CryptoAlith,
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(19945000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(19747000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(15833000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(15704000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(17546000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(16317000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(32454748) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(32160000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
