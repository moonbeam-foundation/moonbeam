	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(50484756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					ForeignAssetId(0u128),
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(109743756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					ForeignAssetId(0u128),
					SELECTOR_LOG_TRANSFER,
					CryptoAlith,
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(29408756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					LocalAssetId(0u128),
					SELECTOR_LOG_TRANSFER,
					Zero,
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(35403756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					LocalAssetId(0u128),
					SELECTOR_LOG_TRANSFER,
					CryptoAlith,
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(19585000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(20079000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(15594000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(15862000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(17656000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(16439000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(29151657) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
	...
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			precompiles()
				...
				.expect_cost(28289000) // 1 weight => 1 gas in mock
				.expect_no_logs()
				.execute_returns(true);
