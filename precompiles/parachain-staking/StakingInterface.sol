...
interface ParachainStaking {
    ...
    /// Selector: b10d6643
    /// @param candidate The number of candidates in the CandidatePool
    ...
    /// @param delegatorDelegationCount The number of active delegations to be revoked by delegator leaving
