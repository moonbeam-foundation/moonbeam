			...
			impl moonbeam_rpc_primitives_debug::DebugRuntimeApi<Block> for Runtime {
				...
				> {
					#[cfg(feature = "evm-tracing")]
					{
						...
						EthereumXcmTracingStatus::wrap(EthereumXcmTracingStatus::Transaction(traced_transaction.hash()), || {
							...
							for ext in extrinsics.into_iter() {
								...
								if let Some(EthereumXcmTracingStatus::TransactionExited) = EthereumXcmTracingStatus::state() {
									return Ok(());
								}
							}

							if let Some(EthereumXcmTracingStatus::Transaction(_)) = EthereumXcmTracingStatus::state() {
				...
				> {
					#[cfg(feature = "evm-tracing")]
					{
						...
						EthereumXcmTracingStatus::wrap(EthereumXcmTracingStatus::Block, || {
