...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset() -> Weight {
		...
		Weight::from_parts(29_998_000, 3639)
	...
	fn set_asset_units_per_second(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_216_573, 4000)
			// Standard Error: 3_469
			.saturating_add(Weight::from_parts(830_784, 0).saturating_mul(x.into()))
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_034_525, 4309)
			// Standard Error: 4_784
			.saturating_add(Weight::from_parts(884_826, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn remove_supported_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_985_231, 1678)
			// Standard Error: 4_081
			.saturating_add(Weight::from_parts(700_538, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_489_403, 3955)
			// Standard Error: 3_713
			.saturating_add(Weight::from_parts(731_210, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 10).saturating_mul(x.into()))
	}
