...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn register_foreign_asset() -> Weight {
		...
		Weight::from_parts(29_698_000, 3639)
	...
	fn set_asset_units_per_second(x: u32, ) -> Weight {
		...
		Weight::from_parts(18_663_130, 4000)
			// Standard Error: 3_609
			.saturating_add(Weight::from_parts(785_472, 0).saturating_mul(x.into()))
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(30_012_675, 4309)
			// Standard Error: 5_125
			.saturating_add(Weight::from_parts(875_860, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn remove_supported_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(13_857_141, 1678)
			// Standard Error: 3_460
			.saturating_add(Weight::from_parts(678_404, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(21_018_396, 3955)
			// Standard Error: 4_001
			.saturating_add(Weight::from_parts(699_119, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
			.saturating_add(Weight::from_parts(0, 10).saturating_mul(x.into()))
	}
