...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 110_722_000 picoseconds.
		Weight::from_parts(12_958_237, 66133)
			// Standard Error: 46_850
			.saturating_add(Weight::from_parts(56_211_908, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(15_343_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(63_559_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(18_163_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `934`
		//  Estimated: `6172`
		// Minimum execution time: 123_302_000 picoseconds.
		Weight::from_parts(125_223_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(76_990_000, 6306)
			// Standard Error: 10_369
			.saturating_add(Weight::from_parts(57_225_395, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
