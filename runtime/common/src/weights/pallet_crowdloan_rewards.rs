...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 128_593_000 picoseconds.
		Weight::from_parts(26_484_438, 66242)
			// Standard Error: 33_958
			.saturating_add(Weight::from_parts(58_041_582, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(14_891_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(66_251_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(17_683_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(125_823_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 76_316_000 picoseconds.
		Weight::from_parts(77_028_000, 6306)
			// Standard Error: 10_579
			.saturating_add(Weight::from_parts(57_150_227, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
