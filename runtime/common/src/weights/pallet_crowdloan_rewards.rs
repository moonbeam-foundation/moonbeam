...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66247 + x * (3052 ±5)`
		// Minimum execution time: 113_529_000 picoseconds.
		Weight::from_parts(302_222_040, 66247)
			// Standard Error: 45_007
			.saturating_add(Weight::from_parts(51_410_353, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(15_567_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(62_983_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(18_082_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(123_949_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 76_366_000 picoseconds.
		Weight::from_parts(77_048_000, 6306)
			// Standard Error: 10_101
			.saturating_add(Weight::from_parts(57_341_217, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
