...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66248 + x * (3052 ±5)`
		// Minimum execution time: 117_036_000 picoseconds.
		Weight::from_parts(97_540_789, 66248)
			// Standard Error: 30_331
			.saturating_add(Weight::from_parts(54_969_544, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(15_266_000, 3581)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `1100`
		//  Estimated: `6172`
		// Minimum execution time: 63_304_000 picoseconds.
		Weight::from_parts(64_383_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(18_048_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `934`
		//  Estimated: `6172`
		// Minimum execution time: 123_206_000 picoseconds.
		Weight::from_parts(125_012_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 76_916_000 picoseconds.
		Weight::from_parts(77_598_000, 6306)
			// Standard Error: 10_354
			.saturating_add(Weight::from_parts(57_354_028, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
