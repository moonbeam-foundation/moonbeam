...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66066 + x * (3161 ±0)`
		// Minimum execution time: 124_987_000 picoseconds.
		Weight::from_parts(31_044_219, 0)
			.saturating_add(Weight::from_parts(0, 66066))
			// Standard Error: 30_444
			.saturating_add(Weight::from_parts(53_708_564, 0).saturating_mul(x.into()))
	...
	fn claim() -> Weight {
		...
		//  Measured:  `968`
		//  Estimated: `6172`
		// Minimum execution time: 58_153_000 picoseconds.
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(72_401_000, 0)
			...
			.saturating_add(Weight::from_parts(53_288_692, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
