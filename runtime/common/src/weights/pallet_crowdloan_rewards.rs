...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 110_884_000 picoseconds.
		Weight::from_parts(147_336_064, 66133)
			// Standard Error: 40_142
			.saturating_add(Weight::from_parts(54_050_188, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(15_735_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(63_760_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(18_219_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(124_403_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 76_926_000 picoseconds.
		Weight::from_parts(77_278_000, 6306)
			// Standard Error: 11_622
			.saturating_add(Weight::from_parts(57_377_263, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
