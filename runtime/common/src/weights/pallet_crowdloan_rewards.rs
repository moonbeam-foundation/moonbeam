...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Measured:  `75971 + x * (659 ±0)`
		//  Estimated: `66133 + x * (3161 ±5)`
		// Minimum execution time: 118_893_000 picoseconds.
		Weight::from_parts(84_456_652, 66133)
			// Standard Error: 30_727
			.saturating_add(Weight::from_parts(54_668_038, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(15_387_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(63_015_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(17_789_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `934`
		//  Estimated: `6172`
		// Minimum execution time: 121_885_000 picoseconds.
		Weight::from_parts(124_004_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 76_398_000 picoseconds.
		Weight::from_parts(77_416_000, 6306)
			// Standard Error: 10_809
			.saturating_add(Weight::from_parts(57_420_141, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
