...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		//  Measured:  `4185 + a * (11 ±0) + l * (84 ±0)`
		//  Estimated: `37731 + a * (2228 ±19) + l * (2536 ±1)`
		// Minimum execution time: 46_259_000 picoseconds.
		Weight::from_parts(47_241_000, 37731)
			// Standard Error: 2_537_198
			.saturating_add(Weight::from_parts(41_756_364, 0).saturating_mul(a.into()))
			// Standard Error: 253_449
			.saturating_add(Weight::from_parts(26_788_347, 0).saturating_mul(l.into()))
