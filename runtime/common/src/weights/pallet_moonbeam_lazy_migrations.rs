...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		//  Estimated: `37723 + a * (2228 ±74) + l * (2536 ±7)`
		// Minimum execution time: 46_869_000 picoseconds.
		Weight::from_parts(47_389_000, 37723)
			// Standard Error: 2_622_036
			.saturating_add(Weight::from_parts(42_895_656, 0).saturating_mul(a.into()))
			// Standard Error: 261_924
			.saturating_add(Weight::from_parts(27_525_420, 0).saturating_mul(l.into()))
