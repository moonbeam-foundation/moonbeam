...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(47_755_000, 37723)
			// Standard Error: 2_582_851
			.saturating_add(Weight::from_parts(42_961_979, 0).saturating_mul(a.into()))
			// Standard Error: 258_009
			.saturating_add(Weight::from_parts(27_276_989, 0).saturating_mul(l.into()))
