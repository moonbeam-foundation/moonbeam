...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(49_165_000, 37759)
			// Standard Error: 2_583_524
			.saturating_add(Weight::from_parts(41_638_192, 0).saturating_mul(a.into()))
			// Standard Error: 258_077
			.saturating_add(Weight::from_parts(27_201_472, 0).saturating_mul(l.into()))
