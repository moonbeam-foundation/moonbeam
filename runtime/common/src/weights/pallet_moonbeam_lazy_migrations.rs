...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(48_216_000, 37723)
			// Standard Error: 2_618_883
			.saturating_add(Weight::from_parts(43_179_147, 0).saturating_mul(a.into()))
			// Standard Error: 261_609
			.saturating_add(Weight::from_parts(27_572_402, 0).saturating_mul(l.into()))
