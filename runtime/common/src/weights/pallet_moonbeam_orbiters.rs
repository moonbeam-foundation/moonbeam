...
impl<T: frame_system::Config> pallet_moonbeam_orbiters::WeightInfo for WeightInfo<T> {
	...
	fn orbiter_unregister(n: u32, ) -> Weight {
		...
		Weight::from_parts(22_220_030, 0)
			.saturating_add(Weight::from_parts(0, 4502))
			// Standard Error: 2_874
			.saturating_add(Weight::from_parts(2_216_492, 0).saturating_mul(n.into()))
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		Weight::from_parts(3_977_538, 0)
			.saturating_add(Weight::from_parts(0, 1586))
			// Standard Error: 992
			.saturating_add(Weight::from_parts(747_316, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
