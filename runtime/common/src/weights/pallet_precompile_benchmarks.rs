...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 77_184_000 picoseconds.
		Weight::from_parts(77_852_000, 0)
			// Standard Error: 2_432
			.saturating_add(Weight::from_parts(671_880, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(4_958_000, 1606)
