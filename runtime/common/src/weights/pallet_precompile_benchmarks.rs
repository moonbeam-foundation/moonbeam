...
// --steps=50
// --repeat=20
// --pallet=pallet-precompile-benchmarks
// --extrinsic=*
...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 74_137_000 picoseconds.
		Weight::from_parts(74_734_000, 0)
			// Standard Error: 2_375
			.saturating_add(Weight::from_parts(650_879, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(4_735_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 817_000_000 picoseconds.
		Weight::from_parts(828_000_000, 0)
	}
}
