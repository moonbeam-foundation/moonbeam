...
impl<T: frame_system::Config> pallet_randomness::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `719`
		//  Estimated: `4184`
		// Minimum execution time: 1_317_920_000 picoseconds.
		Weight::from_parts(1_347_086_000, 0)
	...
	fn request_randomness() -> Weight {
		...
		Weight::from_parts(49_123_000, 0)
	...
	fn prepare_fulfillment(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_146_485, 0)
			.saturating_add(Weight::from_parts(0, 3877))
			// Standard Error: 375
			.saturating_add(Weight::from_parts(249_059, 0).saturating_mul(x.into()))
	...
	fn execute_request_expiration() -> Weight {
		...
		Weight::from_parts(49_432_000, 0)
			.saturating_add(Weight::from_parts(0, 6172))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(4))
	}
