...
use frame_support::{
	...
	traits::{
		...
		Currency as CurrencyT, EnsureOneOf, EqualPrivilegeOnly, Everything, FindAuthor, Imbalance,
		InstanceFilter, Nothing, OffchainWorker, OnFinalize, OnIdle, OnInitialize,
