...
parameter_types! {
	pub const BasicDeposit: Balance = 1 * currency::MILLIUNIT;
	pub const FieldDeposit: Balance = 1 * currency::MILLIUNIT;
	pub const SubAccountDeposit: Balance = 1 * currency::MILLIUNIT;
