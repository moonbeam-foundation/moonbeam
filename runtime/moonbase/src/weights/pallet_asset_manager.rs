...
// 
// --output
// runtime/moonbase/src/weights/pallet_asset_manager.rs
...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_822_672, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 684
			.saturating_add(Weight::from_parts(8_330, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_340_379, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 642
			.saturating_add(Weight::from_parts(11_372, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
