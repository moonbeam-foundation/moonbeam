...
impl<T: frame_system::Config> pallet_author_inherent::WeightInfo for WeightInfo<T> {
	...
	/// Storage: UNKNOWN KEY `0x417574686f72536c6f7446696c7465723a497346616b65417574686f72` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x417574686f72536c6f7446696c7465723a497346616b65417574686f72` (r:1 w:0)
	...
	fn kick_off_authorship_validation() -> Weight {
		...
		Weight::from_parts(20_827_000, 3803)
