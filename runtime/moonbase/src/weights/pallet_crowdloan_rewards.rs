...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(68_599_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_409_000, 6375)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `931`
		//  Estimated: `6172`
		// Minimum execution time: 112_764_000 picoseconds.
		Weight::from_parts(115_266_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_407_000, 6344)
			// Standard Error: 6_635
			.saturating_add(Weight::from_parts(38_654_683, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
