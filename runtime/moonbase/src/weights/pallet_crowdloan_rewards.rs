...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66242 + x * (3052 ±5)`
		// Minimum execution time: 107_588_000 picoseconds.
		Weight::from_parts(268_790_374, 66242)
			// Standard Error: 54_669
			.saturating_add(Weight::from_parts(53_061_502, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(14_811_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(61_192_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(17_963_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `934`
		//  Estimated: `6172`
		// Minimum execution time: 103_718_000 picoseconds.
		Weight::from_parts(105_787_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(59_237_000, 6306)
			// Standard Error: 9_142
			.saturating_add(Weight::from_parts(38_931_299, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
