...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Measured:  `3804 + x * (641 ±0)`
		//  Estimated: `26363 + x * (3116 ±0)`
		// Minimum execution time: 172_000_000 picoseconds.
		Weight::from_parts(172_000_000, 26363)
			// Standard Error: 8_382_202
			.saturating_add(Weight::from_parts(103_429_269, 0).saturating_mul(x.into()))
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(94_000_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(28_000_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(156_000_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `364 + x * (32 ±0)`
		//  Estimated: `6305 + x * (32 ±0)`
		// Minimum execution time: 77_000_000 picoseconds.
		Weight::from_parts(77_000_000, 6305)
			// Standard Error: 408_902
			.saturating_add(Weight::from_parts(55_787_021, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
