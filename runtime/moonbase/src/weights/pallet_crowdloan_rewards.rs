...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(69_698_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_284_000, 6375)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `931`
		//  Estimated: `6172`
		// Minimum execution time: 113_605_000 picoseconds.
		Weight::from_parts(116_338_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(29_070_426, 6344)
			// Standard Error: 6_672
			.saturating_add(Weight::from_parts(38_301_765, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
