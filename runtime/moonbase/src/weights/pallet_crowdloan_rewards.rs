...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 136_696_000 picoseconds.
		Weight::from_parts(102_379_229, 66246)
			// Standard Error: 42_066
			.saturating_add(Weight::from_parts(60_597_051, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(18_237_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(71_887_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_791_000, 6337)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `868`
		//  Estimated: `6172`
		// Minimum execution time: 113_176_000 picoseconds.
		Weight::from_parts(116_065_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_553_000, 6306)
			// Standard Error: 9_285
			.saturating_add(Weight::from_parts(38_669_487, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
