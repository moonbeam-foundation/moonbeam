...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(68_990_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_861_000, 6375)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(117_197_000, 6172)
	...
	fn complete_unclaimed_rewards() -> Weight {
		...
		Weight::from_parts(65_692_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_497_000, 6344)
			// Standard Error: 6_988
			.saturating_add(Weight::from_parts(38_554_441, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
