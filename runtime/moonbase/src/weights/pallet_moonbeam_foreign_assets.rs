...
impl<T: frame_system::Config> pallet_moonbeam_foreign_assets::WeightInfo for WeightInfo<T> {
	...
	fn create_foreign_asset() -> Weight {
		...
		Weight::from_parts(2_234_000_000, 3283277)
	...
	fn change_xcm_location() -> Weight {
		...
		Weight::from_parts(21_000_000, 8401)
	...
	fn freeze_foreign_asset() -> Weight {
		...
		//  Measured:  `3294569`
		//  Estimated: `3300509`
		// Minimum execution time: 1_733_000_000 picoseconds.
		Weight::from_parts(2_034_000_000, 3300509)
	...
	fn unfreeze_foreign_asset() -> Weight {
		...
		//  Measured:  `3295628`
		//  Estimated: `3301568`
		// Minimum execution time: 1_715_000_000 picoseconds.
		Weight::from_parts(1_842_000_000, 3301568)
			.saturating_add(T::DbWeight::get().reads(15_u64))
			.saturating_add(T::DbWeight::get().writes(5_u64))
	}
}
