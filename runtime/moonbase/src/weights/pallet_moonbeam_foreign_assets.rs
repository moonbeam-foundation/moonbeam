...
impl<T: frame_system::Config> pallet_moonbeam_foreign_assets::WeightInfo for WeightInfo<T> {
	...
	fn create_foreign_asset() -> Weight {
		...
		//  Measured:  `19209`
		//  Estimated: `30099`
		// Minimum execution time: 684_243_000 picoseconds.
		Weight::from_parts(706_808_000, 30099)
	...
	fn change_xcm_location() -> Weight {
		...
		Weight::from_parts(53_007_000, 8068)
	...
	fn freeze_foreign_asset() -> Weight {
		...
		//  Measured:  `28572`
		//  Estimated: `34512`
		// Minimum execution time: 270_114_000 picoseconds.
		Weight::from_parts(275_892_000, 34512)
	...
	fn unfreeze_foreign_asset() -> Weight {
		...
		Weight::from_parts(267_421_000, 22833)
			.saturating_add(T::DbWeight::get().reads(16_u64))
			.saturating_add(T::DbWeight::get().writes(6_u64))
	}
	/// Storage: `EvmForeignAssets::AssetsById` (r:1 w:0)
