...
impl<T: frame_system::Config> pallet_moonbeam_foreign_assets::WeightInfo for WeightInfo<T> {
	...
	fn create_foreign_asset() -> Weight {
		...
		//  Measured:  `19387`
		//  Estimated: `30277`
		// Minimum execution time: 856_000_000 picoseconds.
		Weight::from_parts(856_000_000, 30277)
	...
	fn change_xcm_location() -> Weight {
		...
		Weight::from_parts(62_000_000, 8068)
	...
	fn freeze_foreign_asset() -> Weight {
		...
		Weight::from_parts(342_000_000, 34617)
	...
	fn unfreeze_foreign_asset() -> Weight {
		...
		Weight::from_parts(391_000_000, 22938)
			.saturating_add(T::DbWeight::get().reads(17_u64))
			.saturating_add(T::DbWeight::get().writes(6_u64))
	}
}
