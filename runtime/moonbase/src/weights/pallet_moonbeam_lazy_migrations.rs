...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn approve_assets_to_migrate(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_682_000, 990)
			// Standard Error: 5_927
			.saturating_add(Weight::from_parts(4_483_014, 0).saturating_mul(n.into()))
	...
	fn start_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `2085`
		//  Estimated: `30300`
		// Minimum execution time: 714_784_000 picoseconds.
		Weight::from_parts(740_785_000, 30300)
	...
	fn migrate_foreign_asset_balances(n: u32, ) -> Weight {
		...
		// Minimum execution time: 447_582_000 picoseconds.
		Weight::from_parts(456_234_000, 33208)
			// Standard Error: 55_097
			.saturating_add(Weight::from_parts(171_465_641, 0).saturating_mul(n.into()))
	...
	fn migrate_foreign_asset_approvals(n: u32, ) -> Weight {
		...
		// Minimum execution time: 225_642_000 picoseconds.
		Weight::from_parts(229_231_000, 19002)
			// Standard Error: 51_475
			.saturating_add(Weight::from_parts(146_119_396, 0).saturating_mul(n.into()))
	...
	fn finish_foreign_assets_migration() -> Weight {
		...
		Weight::from_parts(76_367_000, 3639)
