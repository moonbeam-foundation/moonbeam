...
// --output=./runtime/moonbase/src/weights/pallet_moonbeam_lazy_migrations.rs
...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn approve_assets_to_migrate(n: u32, ) -> Weight {
		...
		Weight::from_parts(3_067_744, 990)
			// Standard Error: 4_418
			.saturating_add(Weight::from_parts(4_254_419, 0).saturating_mul(n.into()))
	...
	fn start_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `2085`
		//  Estimated: `30300`
		// Minimum execution time: 721_868_000 picoseconds.
		Weight::from_parts(728_164_000, 30300)
	...
	fn migrate_foreign_asset_balances(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `24607 + n * (215 ±0)`
		//  Estimated: `33179 + n * (2691 ±0)`
		// Minimum execution time: 431_433_000 picoseconds.
		Weight::from_parts(438_379_000, 33179)
			// Standard Error: 8_575_117
			.saturating_add(Weight::from_parts(870_965_895, 0).saturating_mul(n.into()))
	...
	fn migrate_foreign_asset_approvals(n: u32, ) -> Weight {
		...
		// Minimum execution time: 227_196_000 picoseconds.
		Weight::from_parts(229_745_000, 32698)
			// Standard Error: 24_773_733
			.saturating_add(Weight::from_parts(2_272_118_466, 0).saturating_mul(n.into()))
	...
	fn finish_foreign_assets_migration() -> Weight {
		...
		Weight::from_parts(53_201_000, 3639)
