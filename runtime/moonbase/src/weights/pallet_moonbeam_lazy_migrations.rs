...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn approve_assets_to_migrate(n: u32, ) -> Weight {
		...
		Weight::from_parts(1_669_185, 990)
			// Standard Error: 8_470
			.saturating_add(Weight::from_parts(4_509_066, 0).saturating_mul(n.into()))
	...
	fn start_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `2085`
		//  Estimated: `30300`
		// Minimum execution time: 728_909_000 picoseconds.
		Weight::from_parts(747_760_000, 30300)
	...
	fn migrate_foreign_asset_balances(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `24636 + n * (215 ±0)`
		//  Estimated: `33208 + n * (2691 ±0)`
		// Minimum execution time: 458_134_000 picoseconds.
		Weight::from_parts(463_941_000, 33208)
			// Standard Error: 62_378
			.saturating_add(Weight::from_parts(172_099_937, 0).saturating_mul(n.into()))
	...
	fn migrate_foreign_asset_approvals(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `14567 + n * (150 ±0)`
		//  Estimated: `19002 + n * (2627 ±0)`
		// Minimum execution time: 226_320_000 picoseconds.
		Weight::from_parts(228_020_000, 19002)
			// Standard Error: 40_192
			.saturating_add(Weight::from_parts(144_745_054, 0).saturating_mul(n.into()))
	...
	fn finish_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `863`
		//  Estimated: `3639`
		// Minimum execution time: 57_905_000 picoseconds.
		Weight::from_parts(62_368_000, 3639)
