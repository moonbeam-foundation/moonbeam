...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(49_964_000, 37759)
			// Standard Error: 2_602_653
			.saturating_add(Weight::from_parts(43_455_730, 0).saturating_mul(a.into()))
			// Standard Error: 259_988
			.saturating_add(Weight::from_parts(27_244_479, 0).saturating_mul(l.into()))
