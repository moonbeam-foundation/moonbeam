...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(26_000_000, 37759)
			// Standard Error: 1_970_882
			.saturating_add(Weight::from_parts(29_607_556, 0).saturating_mul(a.into()))
			// Standard Error: 196_878
			.saturating_add(Weight::from_parts(19_628_562, 0).saturating_mul(l.into()))
