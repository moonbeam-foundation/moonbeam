...
impl<T: frame_system::Config> pallet_moonbeam_orbiters::WeightInfo for WeightInfo<T> {
	...
	fn collator_add_orbiter() -> Weight {
		...
		Weight::from_parts(21_000_000, 4502)
	...
	fn orbiter_register() -> Weight {
		...
		Weight::from_parts(32_000_000, 4502)
	...
	fn orbiter_unregister(n: u32, ) -> Weight {
		...
		Weight::from_parts(35_000_000, 4502)
			// Standard Error: 34_641
			.saturating_add(Weight::from_parts(3_700_000, 0).saturating_mul(n.into()))
	...
	fn add_collator() -> Weight {
		...
		Weight::from_parts(15_000_000, 3547)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn remove_collator() -> Weight {
		...
		Weight::from_parts(24_000_000, 3831)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_000_000, 254782)
			// Standard Error: 0
			.saturating_add(Weight::from_parts(960_000, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
