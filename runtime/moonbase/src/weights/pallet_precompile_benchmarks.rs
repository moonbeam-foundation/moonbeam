...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 68_776_000 picoseconds.
		Weight::from_parts(71_025_000, 0)
			// Standard Error: 2_858
			.saturating_add(Weight::from_parts(475_602, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_627_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_586_301_000 picoseconds.
		Weight::from_parts(1_599_121_000, 0)
