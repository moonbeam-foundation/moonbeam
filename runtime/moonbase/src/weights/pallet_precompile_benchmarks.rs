...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 73_035_000 picoseconds.
		Weight::from_parts(73_395_000, 0)
			// Standard Error: 2_360
			.saturating_add(Weight::from_parts(646_133, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(4_355_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_575_691_000 picoseconds.
		Weight::from_parts(1_586_063_000, 0)
