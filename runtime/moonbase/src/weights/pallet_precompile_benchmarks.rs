...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		Weight::from_parts(74_925_000, 0)
			// Standard Error: 3_464
			.saturating_add(Weight::from_parts(516_117, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_592_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_595_283_000 picoseconds.
		Weight::from_parts(1_605_361_000, 0)
