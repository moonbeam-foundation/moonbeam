...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 76_368_000 picoseconds.
		Weight::from_parts(76_977_000, 0)
			// Standard Error: 2_405
			.saturating_add(Weight::from_parts(685_857, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(6_174_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_588_343_000 picoseconds.
		Weight::from_parts(1_603_042_000, 0)
