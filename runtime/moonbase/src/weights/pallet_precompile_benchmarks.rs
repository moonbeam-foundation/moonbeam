...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 74_297_000 picoseconds.
		Weight::from_parts(75_227_000, 0)
			// Standard Error: 3_715
			.saturating_add(Weight::from_parts(577_891, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_613_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_593_477_000 picoseconds.
		Weight::from_parts(1_606_311_000, 0)
