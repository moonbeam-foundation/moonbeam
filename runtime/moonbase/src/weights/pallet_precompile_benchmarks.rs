...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 74_013_000 picoseconds.
		Weight::from_parts(75_566_000, 0)
			// Standard Error: 2_380
			.saturating_add(Weight::from_parts(704_750, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(6_246_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_590_679_000 picoseconds.
		Weight::from_parts(1_599_900_000, 0)
