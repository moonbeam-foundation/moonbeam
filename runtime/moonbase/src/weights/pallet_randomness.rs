...
impl<T: frame_system::Config> pallet_randomness::WeightInfo for WeightInfo<T> {
	...
	fn set_babe_randomness_results() -> Weight {
		...
		Weight::from_parts(16_156_000, 3762)
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `719`
		//  Estimated: `4184`
		// Minimum execution time: 527_212_000 picoseconds.
		Weight::from_parts(540_574_000, 4184)
	...
	fn request_randomness() -> Weight {
		...
		//  Measured:  `549`
		//  Estimated: `6172`
		// Minimum execution time: 60_006_000 picoseconds.
		Weight::from_parts(60_967_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn prepare_fulfillment(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_015_996, 3877)
			// Standard Error: 434
			.saturating_add(Weight::from_parts(265_360, 0).saturating_mul(x.into()))
	...
	fn finish_fulfillment() -> Weight {
		...
		Weight::from_parts(58_308_000, 6172)
	...
	fn increase_fee() -> Weight {
		...
		//  Measured:  `825`
		//  Estimated: `6172`
		// Minimum execution time: 54_318_000 picoseconds.
		Weight::from_parts(55_641_000, 6172)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Randomness::Requests` (r:1 w:1)
	...
	fn execute_request_expiration() -> Weight {
		...
		Weight::from_parts(60_238_000, 6172)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}
