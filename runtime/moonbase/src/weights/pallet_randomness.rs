...
impl<T: frame_system::Config> pallet_randomness::WeightInfo for WeightInfo<T> {
	...
	fn on_initialize() -> Weight {
		...
		Weight::from_parts(533_000_000, 4184)
	...
	fn prepare_fulfillment(x: u32, ) -> Weight {
		...
		Weight::from_parts(10_731_193, 3877)
			// Standard Error: 1_884
			.saturating_add(Weight::from_parts(323_221, 0).saturating_mul(x.into()))
	...
	fn finish_fulfillment() -> Weight {
		...
		Weight::from_parts(59_000_000, 6172)
