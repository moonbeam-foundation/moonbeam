...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_982_000, 1527)
			// Standard Error: 1_115
			.saturating_add(Weight::from_parts(3_433_950, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(7_131_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(1_285_312, 1527)
			// Standard Error: 2_456
			.saturating_add(Weight::from_parts(3_677_474, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_942_000, 1527)
			// Standard Error: 1_178
			.saturating_add(Weight::from_parts(3_426_570, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(11_640_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
