...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_671_360, 1527)
			// Standard Error: 2_059
			.saturating_add(Weight::from_parts(3_380_505, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(7_033_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(8_982_948, 1527)
			// Standard Error: 1_684
			.saturating_add(Weight::from_parts(3_613_045, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(8_424_025, 1527)
			// Standard Error: 2_059
			.saturating_add(Weight::from_parts(3_364_208, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(11_400_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
