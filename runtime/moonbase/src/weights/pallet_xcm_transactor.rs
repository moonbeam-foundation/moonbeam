...
impl<T: frame_system::Config> pallet_xcm_transactor::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(11_365_000, 3579)
	...
	fn transact_through_derivative() -> Weight {
		...
		Weight::from_parts(42_305_000, 3958)
	...
	fn transact_through_sovereign() -> Weight {
		...
		Weight::from_parts(36_247_000, 3892)
	...
	fn transact_through_signed() -> Weight {
		...
		//  Measured:  `471`
		//  Estimated: `3936`
		// Minimum execution time: 53_696_000 picoseconds.
		Weight::from_parts(54_807_000, 3936)
			.saturating_add(T::DbWeight::get().reads(9_u64))
	...
	fn hrmp_manage() -> Weight {
		...
		Weight::from_parts(58_963_000, 3940)
