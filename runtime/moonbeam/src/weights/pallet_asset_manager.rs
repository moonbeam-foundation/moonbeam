...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(8_522_963, 3909)
			// Standard Error: 744
			.saturating_add(Weight::from_parts(10_208, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_422_015, 3909)
			// Standard Error: 568
			.saturating_add(Weight::from_parts(8_611, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
