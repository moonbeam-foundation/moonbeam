...
// 
// --output
// runtime/moonbeam/src/weights/pallet_asset_manager.rs
...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_151_595, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 693
			.saturating_add(Weight::from_parts(9_542, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_491_732, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 982
			.saturating_add(Weight::from_parts(18_344, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
