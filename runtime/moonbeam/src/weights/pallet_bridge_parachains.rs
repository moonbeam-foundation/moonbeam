...
impl<T: frame_system::Config> pallet_bridge_parachains::WeightInfo for WeightInfo<T> {
	...
	fn submit_parachain_heads_with_n_parachains(p: u32, ) -> Weight {
		...
		Weight::from_parts(40_862_997, 2543)
			// Standard Error: 119_300
			.saturating_add(Weight::from_parts(126_251, 0).saturating_mul(p.into()))
	...
	fn submit_parachain_heads_with_1kb_proof() -> Weight {
		...
		Weight::from_parts(42_123_000, 2543)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	/// Storage: `BridgeKusamaParachains::PalletOperatingMode` (r:1 w:0)
	...
	fn submit_parachain_heads_with_16kb_proof() -> Weight {
		...
		Weight::from_parts(67_660_000, 2543)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}
