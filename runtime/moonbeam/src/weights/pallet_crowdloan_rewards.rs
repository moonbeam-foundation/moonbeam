...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66134 + x * (3052 ±0)`
		// Minimum execution time: 115_519_000 picoseconds.
		Weight::from_parts(117_714_000, 66134)
			// Standard Error: 48_032
			.saturating_add(Weight::from_parts(54_689_521, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(17_183_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(60_686_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(17_591_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(105_800_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(58_518_000, 6273)
			// Standard Error: 9_239
			.saturating_add(Weight::from_parts(38_993_254, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
