...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(72_813_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_411_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 128_850_000 picoseconds.
		Weight::from_parts(131_148_000, 6172)
	...
	fn complete_unclaimed_rewards() -> Weight {
		...
		Weight::from_parts(68_873_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(75_460_000, 6273)
			// Standard Error: 8_245
			.saturating_add(Weight::from_parts(51_364_831, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
