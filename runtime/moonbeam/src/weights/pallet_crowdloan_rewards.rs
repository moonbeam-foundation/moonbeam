...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66134 + x * (3052 ±5)`
		// Minimum execution time: 51_000_000 picoseconds.
		Weight::from_parts(127_227_427, 66134)
			// Standard Error: 22_647
			.saturating_add(Weight::from_parts(29_372_020, 0).saturating_mul(x.into()))
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(9_000_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(61_000_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(36_000_000, 6273)
			// Standard Error: 19_000
			.saturating_add(Weight::from_parts(27_455_528, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
