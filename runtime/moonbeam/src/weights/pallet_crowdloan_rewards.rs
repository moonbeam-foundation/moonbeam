...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		Weight::from_parts(331_131_630, 66137)
			// Standard Error: 40_226
			.saturating_add(Weight::from_parts(56_866_580, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(18_759_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(66_924_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_057_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 108_715_000 picoseconds.
		Weight::from_parts(110_660_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_734_000, 6273)
			// Standard Error: 8_857
			.saturating_add(Weight::from_parts(39_005_376, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
