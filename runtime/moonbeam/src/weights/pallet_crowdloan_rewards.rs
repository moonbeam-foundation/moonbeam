...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Measured:  `76147 + x * (550 ±0)`
		//  Estimated: `66129 + x * (3052 ±5)`
		// Minimum execution time: 118_141_000 picoseconds.
		Weight::from_parts(363_664_240, 66129)
			// Standard Error: 60_495
			.saturating_add(Weight::from_parts(55_091_198, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(19_103_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(68_734_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_159_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 114_032_000 picoseconds.
		Weight::from_parts(116_472_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(67_014_000, 6273)
			// Standard Error: 7_380
			.saturating_add(Weight::from_parts(45_206_288, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
