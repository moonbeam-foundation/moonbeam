...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		//  Measured:  `868`
		//  Estimated: `6172`
		// Minimum execution time: 70_635_000 picoseconds.
		Weight::from_parts(72_051_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_682_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(118_305_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(63_591_000, 6273)
			// Standard Error: 6_401
			.saturating_add(Weight::from_parts(38_632_987, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
