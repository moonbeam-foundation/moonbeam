...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 113_211_000 picoseconds.
		Weight::from_parts(184_778_976, 66137)
			// Standard Error: 22_598
			.saturating_add(Weight::from_parts(55_652_414, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(21_233_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(70_012_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_999_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 113_078_000 picoseconds.
		Weight::from_parts(116_787_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(65_132_000, 6273)
			// Standard Error: 9_846
			.saturating_add(Weight::from_parts(41_606_763, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
