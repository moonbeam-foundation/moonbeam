...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(68_580_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_155_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(116_106_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 65_952_000 picoseconds.
		Weight::from_parts(66_596_000, 6273)
			// Standard Error: 7_069
			.saturating_add(Weight::from_parts(45_185_836, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
