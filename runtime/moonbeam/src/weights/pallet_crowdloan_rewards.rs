...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(74_091_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_299_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 116_913_000 picoseconds.
		Weight::from_parts(119_442_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(63_464_000, 6273)
			// Standard Error: 6_479
			.saturating_add(Weight::from_parts(38_827_834, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
