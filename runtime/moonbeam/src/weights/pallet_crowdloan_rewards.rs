...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		//  Measured:  `868`
		//  Estimated: `6172`
		// Minimum execution time: 71_049_000 picoseconds.
		Weight::from_parts(72_510_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_509_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(124_279_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(25_411_675, 6273)
			// Standard Error: 8_374
			.saturating_add(Weight::from_parts(46_736_578, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
