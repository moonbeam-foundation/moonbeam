...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for WeightInfo<T> {
	...
	fn exec_migration_completed() -> Weight {
		...
		Weight::from_parts(4_000_000, 3561)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_skipped_historic() -> Weight {
		...
		Weight::from_parts(7_000_000, 3731)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	/// Storage: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	/// Proof: UNKNOWN KEY `0x583359fe0e84d953a9dd84e8addb08a5` (r:1 w:0)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(20_000_000, 3731)
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		//  Estimated: `4188 + n * (2730 ±6)`
		// Minimum execution time: 9_000_000 picoseconds.
		Weight::from_parts(8_666_666, 4188)
			// Standard Error: 4_510
			.saturating_add(Weight::from_parts(1_046_875, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `6 + n * (38 ±0)`
		//  Estimated: `279 + n * (39 ±0)`
		// Minimum execution time: 2_000_000 picoseconds.
		Weight::from_parts(6_166_666, 279)
			// Standard Error: 7_047
			.saturating_add(Weight::from_parts(481_933, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
