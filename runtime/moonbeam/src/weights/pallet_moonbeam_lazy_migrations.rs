...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(29_000_000, 37717)
			// Standard Error: 2_097_508
			.saturating_add(Weight::from_parts(33_718_192, 0).saturating_mul(a.into()))
			// Standard Error: 209_527
			.saturating_add(Weight::from_parts(20_551_152, 0).saturating_mul(l.into()))
