...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn approve_assets_to_migrate(n: u32, ) -> Weight {
		...
		Weight::from_parts(8_989_000, 990)
			// Standard Error: 5_835
			.saturating_add(Weight::from_parts(4_548_360, 0).saturating_mul(n.into()))
	...
	fn start_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `1854`
		//  Estimated: `30069`
		// Minimum execution time: 732_958_000 picoseconds.
		Weight::from_parts(758_582_000, 30069)
	...
	fn migrate_foreign_asset_balances(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `24020 + n * (215 ±0)`
		//  Estimated: `32619 + n * (2690 ±0)`
		// Minimum execution time: 438_654_000 picoseconds.
		Weight::from_parts(450_282_000, 32619)
			// Standard Error: 48_701
			.saturating_add(Weight::from_parts(172_547_057, 0).saturating_mul(n.into()))
	...
	fn migrate_foreign_asset_approvals(n: u32, ) -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `14369 + n * (150 ±0)`
		//  Estimated: `18804 + n * (2627 ±0)`
		// Minimum execution time: 237_823_000 picoseconds.
		Weight::from_parts(240_635_000, 18804)
			// Standard Error: 49_122
			.saturating_add(Weight::from_parts(146_293_752, 0).saturating_mul(n.into()))
	...
	fn finish_foreign_assets_migration() -> Weight {
		...
		Weight::from_parts(74_318_000, 3639)
