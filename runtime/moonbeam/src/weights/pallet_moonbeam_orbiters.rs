...
impl<T: frame_system::Config> pallet_moonbeam_orbiters::WeightInfo for WeightInfo<T> {
	...
	fn orbiter_leave_collator_pool() -> Weight {
		...
		Weight::from_parts(10_000_000, 3831)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn orbiter_unregister(n: u32, ) -> Weight {
		...
		Weight::from_parts(29_166_666, 4502)
			// Standard Error: 109_696
			.saturating_add(Weight::from_parts(2_450_000, 0).saturating_mul(n.into()))
	...
	fn remove_collator() -> Weight {
		...
		//  Estimated: `3831`
		// Minimum execution time: 16_000_000 picoseconds.
		Weight::from_parts(16_000_000, 3831)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn on_initialize(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_166_666, 254782)
