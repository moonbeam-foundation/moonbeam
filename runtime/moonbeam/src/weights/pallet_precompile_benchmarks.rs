...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 77_198_000 picoseconds.
		Weight::from_parts(77_760_000, 0)
			// Standard Error: 3_430
			.saturating_add(Weight::from_parts(546_496, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_507_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_750_577_000 picoseconds.
		Weight::from_parts(1_762_945_000, 0)
