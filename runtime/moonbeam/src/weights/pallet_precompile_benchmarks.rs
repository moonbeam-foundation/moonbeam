...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		Weight::from_parts(76_858_000, 0)
			// Standard Error: 3_369
			.saturating_add(Weight::from_parts(532_693, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_506_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_725_995_000 picoseconds.
		Weight::from_parts(1_736_886_000, 0)
