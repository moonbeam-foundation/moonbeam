...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 71_500_000 picoseconds.
		Weight::from_parts(71_914_000, 0)
			// Standard Error: 2_275
			.saturating_add(Weight::from_parts(627_893, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(6_009_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_569_859_000 picoseconds.
		Weight::from_parts(1_582_996_000, 0)
