...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 80_149_000 picoseconds.
		Weight::from_parts(82_357_000, 0)
			// Standard Error: 2_408
			.saturating_add(Weight::from_parts(705_898, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_860_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_596_114_000 picoseconds.
		Weight::from_parts(1_610_959_000, 0)
