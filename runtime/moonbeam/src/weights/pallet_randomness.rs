...
impl<T: frame_system::Config> pallet_randomness::WeightInfo for WeightInfo<T> {
	...
	fn set_babe_randomness_results() -> Weight {
		...
		Weight::from_parts(16_241_000, 3728)
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `686`
		//  Estimated: `4151`
		// Minimum execution time: 634_129_000 picoseconds.
		Weight::from_parts(645_783_000, 4151)
	...
	fn request_randomness() -> Weight {
		...
		//  Measured:  `483`
		//  Estimated: `6172`
		// Minimum execution time: 64_816_000 picoseconds.
		Weight::from_parts(66_064_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn prepare_fulfillment(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_931_996, 3877)
			// Standard Error: 419
			.saturating_add(Weight::from_parts(300_567, 0).saturating_mul(x.into()))
	...
	fn finish_fulfillment() -> Weight {
		...
		Weight::from_parts(60_673_000, 6172)
	...
	fn increase_fee() -> Weight {
		...
		Weight::from_parts(57_776_000, 6172)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Randomness::Requests` (r:1 w:1)
	...
	fn execute_request_expiration() -> Weight {
		...
		Weight::from_parts(62_632_000, 6172)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}
