...
impl<T: frame_system::Config> pallet_randomness::WeightInfo for WeightInfo<T> {
	...
	fn set_babe_randomness_results() -> Weight {
		...
		Weight::from_parts(16_198_000, 3728)
	...
	fn on_initialize() -> Weight {
		...
		//  Measured:  `686`
		//  Estimated: `4151`
		// Minimum execution time: 642_398_000 picoseconds.
		Weight::from_parts(654_158_000, 4151)
	...
	fn prepare_fulfillment(x: u32, ) -> Weight {
		...
		Weight::from_parts(12_033_831, 3877)
			// Standard Error: 449
			.saturating_add(Weight::from_parts(301_761, 0).saturating_mul(x.into()))
	...
	fn finish_fulfillment() -> Weight {
		...
		//  Measured:  `673`
		//  Estimated: `6172`
		// Minimum execution time: 59_894_000 picoseconds.
		Weight::from_parts(60_665_000, 6172)
	...
	fn increase_fee() -> Weight {
		...
		Weight::from_parts(57_489_000, 6172)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Randomness::Requests` (r:1 w:1)
	...
	fn execute_request_expiration() -> Weight {
		...
		//  Measured:  `802`
		//  Estimated: `6172`
		// Minimum execution time: 61_268_000 picoseconds.
		Weight::from_parts(62_605_000, 6172)
			.saturating_add(T::DbWeight::get().reads(4_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}
