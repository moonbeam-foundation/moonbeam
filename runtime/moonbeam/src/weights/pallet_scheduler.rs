...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(3_827_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(7_143_724, 42428)
			// Standard Error: 1_582
			.saturating_add(Weight::from_parts(357_563, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_953_000, 3644)
			// Standard Error: 259
			.saturating_add(Weight::from_parts(22_887, 0).saturating_mul(s.into()))
	...
	fn execute_dispatch_signed() -> Weight {
		...
		Weight::from_parts(5_135_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_029_624, 42428)
			// Standard Error: 1_612
			.saturating_add(Weight::from_parts(402_256, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_257_066, 42428)
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_032_683, 42428)
			// Standard Error: 3_052
			.saturating_add(Weight::from_parts(440_736, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_029_008, 42428)
			// Standard Error: 1_464
			.saturating_add(Weight::from_parts(632_609, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(10_468_010, 42428)
			// Standard Error: 473
			.saturating_add(Weight::from_parts(33_410, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(27_858_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		Weight::from_parts(38_458_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:0)
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(26_313_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(37_286_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
