...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(6_025_102, 1527)
			// Standard Error: 1_815
			.saturating_add(Weight::from_parts(3_647_579, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(7_599_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_195_136, 1527)
			// Standard Error: 1_717
			.saturating_add(Weight::from_parts(3_898_972, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_763_105, 1527)
			// Standard Error: 2_003
			.saturating_add(Weight::from_parts(3_607_733, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn if_else() -> Weight {
		...
		Weight::from_parts(12_350_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
