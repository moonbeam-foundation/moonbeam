...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_021_000, 1527)
			// Standard Error: 19_089
			.saturating_add(Weight::from_parts(5_729_093, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(7_424_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_976_000, 1527)
			// Standard Error: 19_478
			.saturating_add(Weight::from_parts(5_915_844, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_027_000, 1527)
			// Standard Error: 19_222
			.saturating_add(Weight::from_parts(5_729_916, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
