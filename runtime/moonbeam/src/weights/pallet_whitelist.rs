...
impl<T: frame_system::Config> pallet_whitelist::WeightInfo for WeightInfo<T> {
	...
	fn remove_whitelisted_call() -> Weight {
		...
		Weight::from_parts(20_362_000, 3544)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Whitelist::WhitelistedCall` (r:1 w:1)
	...
	fn dispatch_whitelisted_call(n: u32, ) -> Weight {
		...
		Weight::from_parts(34_182_000, 3753)
			// Standard Error: 13
			.saturating_add(Weight::from_parts(1_677, 0).saturating_mul(n.into()))
	...
	fn dispatch_whitelisted_call_with_preimage(n: u32, ) -> Weight {
		...
		Weight::from_parts(24_693_714, 3544)
			// Standard Error: 4
