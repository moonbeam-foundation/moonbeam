...
impl<T: frame_system::Config> pallet_xcm_transactor::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(10_716_000, 3541)
	...
	fn transact_through_derivative() -> Weight {
		...
		Weight::from_parts(41_954_000, 3920)
	...
	fn transact_through_sovereign() -> Weight {
		...
		Weight::from_parts(36_696_000, 3858)
	...
	fn transact_through_signed() -> Weight {
		...
		//  Measured:  `437`
		//  Estimated: `3902`
		// Minimum execution time: 53_306_000 picoseconds.
		Weight::from_parts(54_796_000, 3902)
			.saturating_add(T::DbWeight::get().reads(9_u64))
	...
	fn hrmp_manage() -> Weight {
		...
		Weight::from_parts(57_764_000, 3902)
