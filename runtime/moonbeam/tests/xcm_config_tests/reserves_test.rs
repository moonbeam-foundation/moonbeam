...
//!
//! Moonbeam's Reserves configuration allows:
...
fn reserves_accepts_dot_from_asset_hub() {
	ExtBuilder::default().build().execute_with(|| {
		...
		type RelayFromAssetHub =
			xcm_builder::Case<moonbeam_runtime::xcm_config::RelayChainNativeAssetFromAssetHub>;
