...
//! in different assets. Moonbeam uses a custom trader that:
//! - Accepts the native token (GLMR) at standard rates
//! - Accepts registered foreign assets at configured relative prices

use crate::xcm_common::*;
use frame_support::traits::PalletInfoAccess;
use moonbeam_runtime::{currency::GLMR, Balances, Runtime};
