...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_087_930, 3909)
			// Standard Error: 614
			.saturating_add(Weight::from_parts(11_150, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_998_609, 3909)
			// Standard Error: 720
			.saturating_add(Weight::from_parts(8_792, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
