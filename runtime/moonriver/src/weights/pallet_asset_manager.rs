...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for WeightInfo<T> {
	...
	fn change_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(9_274_035, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 724
			.saturating_add(Weight::from_parts(6_419, 0).saturating_mul(x.into()))
	...
	fn remove_existing_asset_type(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_630_111, 0)
			.saturating_add(Weight::from_parts(0, 3815))
			// Standard Error: 664
			.saturating_add(Weight::from_parts(9_301, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(1))
