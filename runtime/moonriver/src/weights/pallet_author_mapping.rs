...
impl<T: frame_system::Config> pallet_author_mapping::WeightInfo for WeightInfo<T> {
	...
	fn add_association() -> Weight {
		...
		//  Measured:  `343`
		//  Estimated: `3808`
		// Minimum execution time: 30_915_000 picoseconds.
		Weight::from_parts(31_847_000, 3808)
	...
	fn update_association() -> Weight {
		...
		Weight::from_parts(19_656_000, 6232)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `AuthorMapping::MappingWithDeposit` (r:1 w:1)
	...
	fn clear_association() -> Weight {
		...
		Weight::from_parts(33_655_000, 3885)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	fn remove_keys() -> Weight {
		...
		Weight::from_parts(38_018_000, 3979)
	...
	fn set_keys() -> Weight {
		...
		Weight::from_parts(37_036_000, 3864)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}
