...
impl<T: frame_system::Config> pallet_bridge_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn submit_finality_proof(p: u32, _v: u32, ) -> Weight {
		...
		//  Measured:  `438 + p * (60 ±0)`
		//  Estimated: `51735`
		// Minimum execution time: 320_603_000 picoseconds.
		Weight::from_parts(446_255_051, 51735)
			// Standard Error: 240_584
			.saturating_add(Weight::from_parts(42_590_462, 0).saturating_mul(p.into()))
	...
	fn force_set_pallet_state() -> Weight {
		...
		//  Measured:  `452`
		//  Estimated: `51735`
		// Minimum execution time: 126_512_000 picoseconds.
		Weight::from_parts(133_290_000, 51735)
