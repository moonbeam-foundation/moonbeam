...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(69_319_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_869_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 111_978_000 picoseconds.
		Weight::from_parts(113_374_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(60_926_000, 6273)
			// Standard Error: 6_023
			.saturating_add(Weight::from_parts(38_394_404, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
