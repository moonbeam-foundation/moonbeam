...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `26300 + x * (3116 ±145)`
		// Minimum execution time: 89_000_000 picoseconds.
		Weight::from_parts(70_338_038, 26300)
			// Standard Error: 152_317
			.saturating_add(Weight::from_parts(40_647_118, 0).saturating_mul(x.into()))
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(50_000_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(20_479_478, 6272)
			// Standard Error: 41_003
			.saturating_add(Weight::from_parts(29_438_830, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
