...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 130_105_000 picoseconds.
		Weight::from_parts(187_711_746, 66116)
			// Standard Error: 29_143
			.saturating_add(Weight::from_parts(59_372_942, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(21_838_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(73_052_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_190_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 113_527_000 picoseconds.
		Weight::from_parts(116_067_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		// Minimum execution time: 61_842_000 picoseconds.
		Weight::from_parts(62_765_000, 6273)
			// Standard Error: 8_941
			.saturating_add(Weight::from_parts(38_916_573, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
