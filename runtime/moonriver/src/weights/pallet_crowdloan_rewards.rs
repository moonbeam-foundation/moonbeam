...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66116 + x * (3052 ±0)`
		// Minimum execution time: 132_050_000 picoseconds.
		Weight::from_parts(129_209_771, 66116)
			// Standard Error: 43_118
			.saturating_add(Weight::from_parts(60_137_480, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(21_565_000, 3581)
	...
	fn claim() -> Weight {
		...
		//  Measured:  `902`
		//  Estimated: `6172`
		// Minimum execution time: 69_557_000 picoseconds.
		Weight::from_parts(71_341_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_200_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 113_763_000 picoseconds.
		Weight::from_parts(116_746_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_830_000, 6273)
			// Standard Error: 8_499
			.saturating_add(Weight::from_parts(38_665_242, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
