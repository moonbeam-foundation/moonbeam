...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		//  Estimated: `66113 + x * (3052 ±5)`
		// Minimum execution time: 108_803_000 picoseconds.
		Weight::from_parts(126_015_490, 66113)
			// Standard Error: 24_222
			.saturating_add(Weight::from_parts(53_976_352, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(17_423_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(60_533_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(17_380_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `802`
		//  Estimated: `6172`
		// Minimum execution time: 107_637_000 picoseconds.
		Weight::from_parts(108_797_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_772_000, 6273)
			// Standard Error: 9_588
			.saturating_add(Weight::from_parts(42_386_210, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
