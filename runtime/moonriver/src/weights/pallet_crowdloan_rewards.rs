...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		// Minimum execution time: 131_136_000 picoseconds.
		Weight::from_parts(270_444_621, 66116)
			// Standard Error: 41_100
			.saturating_add(Weight::from_parts(58_021_096, 0).saturating_mul(x.into()))
	...
	fn complete_initialization() -> Weight {
		...
		Weight::from_parts(19_038_000, 3581)
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(67_541_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_303_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 110_434_000 picoseconds.
		Weight::from_parts(112_911_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(62_638_000, 6273)
			// Standard Error: 38_692
			.saturating_add(Weight::from_parts(43_348_456, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
