...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		//  Measured:  `868`
		//  Estimated: `6172`
		// Minimum execution time: 66_443_000 picoseconds.
		Weight::from_parts(67_870_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(20_272_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		//  Measured:  `736`
		//  Estimated: `6172`
		// Minimum execution time: 110_535_000 picoseconds.
		Weight::from_parts(113_049_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(61_393_000, 6273)
			// Standard Error: 5_534
			.saturating_add(Weight::from_parts(38_833_748, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
