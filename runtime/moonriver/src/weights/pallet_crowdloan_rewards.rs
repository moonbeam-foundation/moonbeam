...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(68_402_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		Weight::from_parts(21_046_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(112_346_000, 6172)
	...
	fn complete_unclaimed_rewards() -> Weight {
		...
		Weight::from_parts(64_812_000, 6172)
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(6_195_699, 6273)
			// Standard Error: 6_745
			.saturating_add(Weight::from_parts(39_139_687, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
