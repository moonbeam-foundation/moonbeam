...
impl<T: frame_system::Config> pallet_crowdloan_rewards::WeightInfo for WeightInfo<T> {
	...
	fn initialize_reward_vec(x: u32, ) -> Weight {
		...
		Weight::from_parts(155_511_369, 66113)
			// Standard Error: 30_838
			.saturating_add(Weight::from_parts(31_482_371, 0).saturating_mul(x.into()))
	...
	fn claim() -> Weight {
		...
		Weight::from_parts(34_000_000, 6172)
	...
	fn update_reward_address() -> Weight {
		...
		//  Estimated: `6304`
		// Minimum execution time: 9_000_000 picoseconds.
		Weight::from_parts(10_000_000, 6304)
	...
	fn associate_native_identity() -> Weight {
		...
		Weight::from_parts(64_000_000, 6172)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	fn change_association_with_relay_keys(x: u32, ) -> Weight {
		...
		Weight::from_parts(39_000_000, 6273)
			// Standard Error: 8_851
			.saturating_add(Weight::from_parts(29_329_080, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
