...
impl<T: frame_system::Config> pallet_identity::WeightInfo for WeightInfo<T> {
	...
	fn add_registrar(r: u32, ) -> Weight {
		...
		Weight::from_parts(9_684_990, 2386)
			// Standard Error: 1_420
			.saturating_add(Weight::from_parts(111_941, 0).saturating_mul(r.into()))
	...
	fn set_identity(r: u32, ) -> Weight {
		...
		//  Measured:  `6965 + r * (5 ±0)`
		//  Estimated: `10991`
		// Minimum execution time: 118_575_000 picoseconds.
		Weight::from_parts(120_074_315, 10991)
			// Standard Error: 9_501
			.saturating_add(Weight::from_parts(236_399, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_subs_new(s: u32, ) -> Weight {
		...
		Weight::from_parts(26_261_035, 10991)
			// Standard Error: 6_918
			.saturating_add(Weight::from_parts(3_636_905, 0).saturating_mul(s.into()))
	...
	fn set_subs_old(p: u32, ) -> Weight {
		...
		Weight::from_parts(28_346_670, 10991)
			// Standard Error: 4_204
			.saturating_add(Weight::from_parts(1_341_323, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	...
	fn clear_identity(r: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(62_350_408, 10991)
			// Standard Error: 16_793
			.saturating_add(Weight::from_parts(182_533, 0).saturating_mul(r.into()))
			// Standard Error: 3_276
			.saturating_add(Weight::from_parts(1_318_739, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn request_judgement(r: u32, ) -> Weight {
		...
		//  Estimated: `10991`
		// Minimum execution time: 86_870_000 picoseconds.
		Weight::from_parts(88_367_571, 10991)
			// Standard Error: 6_142
			.saturating_add(Weight::from_parts(201_748, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::IdentityOf` (r:1 w:1)
	...
	fn cancel_request(r: u32, ) -> Weight {
		...
		//  Measured:  `6986`
		//  Estimated: `10991`
		// Minimum execution time: 81_197_000 picoseconds.
		Weight::from_parts(82_783_405, 10991)
			// Standard Error: 10_263
			.saturating_add(Weight::from_parts(178_995, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:1)
	...
	fn set_fee(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_847_583, 2386)
	...
	fn set_account_id(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_978_568, 2386)
			// Standard Error: 1_131
			.saturating_add(Weight::from_parts(75_920, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:1)
	...
	fn set_fields(r: u32, ) -> Weight {
		...
		Weight::from_parts(6_971_440, 2386)
			// Standard Error: 1_109
			.saturating_add(Weight::from_parts(68_028, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::Registrars` (r:1 w:0)
	...
	fn provide_judgement(r: u32, ) -> Weight {
		...
		Weight::from_parts(108_764_220, 10991)
			// Standard Error: 4_567
			.saturating_add(Weight::from_parts(134_715, 0).saturating_mul(r.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::SubsOf` (r:1 w:1)
	...
	fn kill_identity(r: u32, s: u32, ) -> Weight {
		...
		Weight::from_parts(78_817_901, 10991)
			// Standard Error: 17_942
			.saturating_add(Weight::from_parts(169_849, 0).saturating_mul(r.into()))
			// Standard Error: 3_500
			.saturating_add(Weight::from_parts(1_308_906, 0).saturating_mul(s.into()))
	...
	fn add_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(37_007_089, 10991)
			// Standard Error: 1_816
			.saturating_add(Weight::from_parts(91_791, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Identity::IdentityOf` (r:1 w:0)
	...
	fn rename_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(22_190_364, 10991)
			// Standard Error: 979
			.saturating_add(Weight::from_parts(63_441, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::IdentityOf` (r:1 w:0)
	...
	fn remove_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(39_209_431, 10991)
			// Standard Error: 1_342
			.saturating_add(Weight::from_parts(96_314, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Identity::SuperOf` (r:1 w:1)
	...
	fn quit_sub(s: u32, ) -> Weight {
		...
		Weight::from_parts(27_540_989, 5511)
			// Standard Error: 787
			.saturating_add(Weight::from_parts(79_574, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn remove_username_authority() -> Weight {
		...
		Weight::from_parts(10_268_000, 3505)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::AuthorityOf` (r:1 w:1)
	...
	fn set_username_for(_p: u32, ) -> Weight {
		...
		//  Measured:  `364`
		//  Estimated: `3581`
		// Minimum execution time: 69_096_000 picoseconds.
		Weight::from_parts(89_955_663, 3581)
	...
	fn accept_username() -> Weight {
		...
		Weight::from_parts(20_925_000, 3555)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Identity::PendingUsernames` (r:1 w:1)
	...
	fn remove_expired_approval(_p: u32, ) -> Weight {
		...
		Weight::from_parts(41_454_983, 3581)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_primary_username() -> Weight {
		...
		Weight::from_parts(13_421_000, 3551)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::UsernameInfoOf` (r:1 w:0)
	...
	fn unbind_username() -> Weight {
		...
		Weight::from_parts(18_375_000, 3551)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Identity::UnbindingUsernames` (r:1 w:1)
	...
	fn remove_username() -> Weight {
		...
		Weight::from_parts(23_494_000, 3551)
	...
	fn kill_username(_p: u32, ) -> Weight {
		...
		Weight::from_parts(55_578_081, 3581)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	...
	fn migration_v2_authority_step() -> Weight {
		...
		Weight::from_parts(8_892_000, 6074)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_username_step() -> Weight {
		...
		Weight::from_parts(8_890_000, 6087)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_identity_step() -> Weight {
		...
		//  Measured:  `7050`
		//  Estimated: `20992`
		// Minimum execution time: 64_567_000 picoseconds.
		Weight::from_parts(65_415_000, 20992)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn migration_v2_pending_username_step() -> Weight {
		...
		Weight::from_parts(8_073_000, 6120)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_cleanup_authority_step() -> Weight {
		...
		Weight::from_parts(11_804_000, 6020)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn migration_v2_cleanup_username_step() -> Weight {
		...
		Weight::from_parts(10_781_000, 6112)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
