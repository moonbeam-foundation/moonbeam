...
impl<T: frame_system::Config> pallet_migrations::WeightInfo for WeightInfo<T> {
	...
	fn progress_mbms_none() -> Weight {
		...
		Weight::from_parts(1_000_000, 67035)
	...
	fn exec_migration_fail() -> Weight {
		...
		Weight::from_parts(22_000_000, 3731)
	...
	fn force_onboard_mbms() -> Weight {
		...
		Weight::from_parts(4_000_000, 67035)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	}
	...
	fn clear_historic(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_000_000, 4188)
			// Standard Error: 27_063
			.saturating_add(Weight::from_parts(1_070_312, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn reset_pallet_migration(n: u32, ) -> Weight {
		...
		// Minimum execution time: 2_000_000 picoseconds.
		Weight::from_parts(166_666, 279)
			// Standard Error: 3_101
			.saturating_add(Weight::from_parts(521_972, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(n.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
