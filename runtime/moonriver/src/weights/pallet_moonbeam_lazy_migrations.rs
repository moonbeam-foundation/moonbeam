...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn approve_assets_to_migrate(n: u32, ) -> Weight {
		...
		Weight::from_parts(2_093_846, 990)
			// Standard Error: 5_382
			.saturating_add(Weight::from_parts(4_439_962, 0).saturating_mul(n.into()))
	...
	fn start_foreign_assets_migration() -> Weight {
		...
		//  Measured:  `1788`
		//  Estimated: `30003`
		// Minimum execution time: 734_251_000 picoseconds.
		Weight::from_parts(742_948_000, 30003)
	...
	fn migrate_foreign_asset_balances(n: u32, ) -> Weight {
		...
		// Minimum execution time: 438_017_000 picoseconds.
		Weight::from_parts(442_821_000, 32471)
			// Standard Error: 49_067
			.saturating_add(Weight::from_parts(166_767_646, 0).saturating_mul(n.into()))
	...
	fn migrate_foreign_asset_approvals(n: u32, ) -> Weight {
		...
		// Minimum execution time: 233_103_000 picoseconds.
		Weight::from_parts(234_024_000, 18755)
			// Standard Error: 57_712
			.saturating_add(Weight::from_parts(141_570_861, 0).saturating_mul(n.into()))
	...
	fn finish_foreign_assets_migration() -> Weight {
		...
		Weight::from_parts(66_261_000, 3639)
