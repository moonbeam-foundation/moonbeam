...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		//  Measured:  `4424 + a * (5 ±0) + l * (84 ±0)`
		//  Estimated: `37695 + a * (2224 ±19) + l * (2536 ±1)`
		// Minimum execution time: 50_313_000 picoseconds.
		Weight::from_parts(50_889_000, 37695)
			// Standard Error: 2_571_628
			.saturating_add(Weight::from_parts(42_274_657, 0).saturating_mul(a.into()))
			// Standard Error: 256_888
			.saturating_add(Weight::from_parts(27_055_580, 0).saturating_mul(l.into()))
			...
			.saturating_add(Weight::from_parts(0, 2224).saturating_mul(a.into()))
