...
impl<T: frame_system::Config> pallet_moonbeam_lazy_migrations::WeightInfo for WeightInfo<T> {
	...
	fn clear_suicided_storage(a: u32, l: u32, ) -> Weight {
		...
		Weight::from_parts(29_000_000, 37695)
			// Standard Error: 2_090_808
			.saturating_add(Weight::from_parts(31_295_957, 0).saturating_mul(a.into()))
			// Standard Error: 208_858
			.saturating_add(Weight::from_parts(20_957_494, 0).saturating_mul(l.into()))
