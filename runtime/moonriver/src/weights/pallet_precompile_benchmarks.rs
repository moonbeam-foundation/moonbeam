...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 73_103_000 picoseconds.
		Weight::from_parts(73_526_000, 0)
			// Standard Error: 2_335
			.saturating_add(Weight::from_parts(653_675, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(6_014_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_581_388_000 picoseconds.
		Weight::from_parts(1_594_013_000, 0)
