...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		Weight::from_parts(71_947_000, 0)
			// Standard Error: 2_298
			.saturating_add(Weight::from_parts(631_379, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_968_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_567_823_000 picoseconds.
		Weight::from_parts(1_573_967_000, 0)
