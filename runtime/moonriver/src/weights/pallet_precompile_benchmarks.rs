...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 72_262_000 picoseconds.
		Weight::from_parts(72_991_000, 0)
			// Standard Error: 3_196
			.saturating_add(Weight::from_parts(507_854, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_533_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_587_183_000 picoseconds.
		Weight::from_parts(1_599_457_000, 0)
