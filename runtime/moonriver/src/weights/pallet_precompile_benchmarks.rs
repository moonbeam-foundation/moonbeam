...
impl<T: frame_system::Config> pallet_precompile_benchmarks::WeightInfo for WeightInfo<T> {
	...
	fn verify_entry(x: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 75_380_000 picoseconds.
		Weight::from_parts(75_859_000, 0)
			// Standard Error: 3_705
			.saturating_add(Weight::from_parts(572_814, 0).saturating_mul(x.into()))
	}
	...
	fn latest_relay_block() -> Weight {
		...
		Weight::from_parts(5_455_000, 1606)
	...
	fn p256_verify() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_596_678_000 picoseconds.
		Weight::from_parts(1_609_636_000, 0)
