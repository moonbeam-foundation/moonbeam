...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for WeightInfo<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		//  Measured:  `42`
		//  Estimated: `3556`
		// Minimum execution time: 55_201_000 picoseconds.
		Weight::from_parts(55_677_000, 3556)
			// Standard Error: 4
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_407_000, 3544)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(2_447, 0).saturating_mul(s.into()))
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_808_000, 3544)
			// Standard Error: 4
			.saturating_add(Weight::from_parts(2_451, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unnote_preimage() -> Weight {
		...
		Weight::from_parts(57_915_000, 3556)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unnote_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(23_927_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_preimage() -> Weight {
		...
		Weight::from_parts(20_311_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn request_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(14_468_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(16_038_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_requested_preimage() -> Weight {
		...
		Weight::from_parts(11_949_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_parts(21_347_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(11_623_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_parts(11_494_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn ensure_updated(n: u32, ) -> Weight {
		...
		Weight::from_parts(67_106_000, 990)
			// Standard Error: 34_921
			.saturating_add(Weight::from_parts(62_492_673, 0).saturating_mul(n.into()))
