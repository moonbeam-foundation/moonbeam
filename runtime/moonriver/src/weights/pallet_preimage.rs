...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for WeightInfo<T> {
	...
	fn note_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(50_024_000, 3556)
			// Standard Error: 166
			.saturating_add(Weight::from_parts(16_915, 0).saturating_mul(s.into()))
	...
	fn note_requested_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_396_000, 3544)
			// Standard Error: 166
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_561_000, 3544)
			// Standard Error: 166
			.saturating_add(Weight::from_parts(16_916, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unnote_preimage() -> Weight {
		...
		Weight::from_parts(76_193_000, 3556)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unnote_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(37_333_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_preimage() -> Weight {
		...
		//  Measured:  `176`
		//  Estimated: `3544`
		// Minimum execution time: 30_493_000 picoseconds.
		Weight::from_parts(34_073_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn request_no_deposit_preimage() -> Weight {
		...
		Weight::from_parts(25_102_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(25_723_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn request_requested_preimage() -> Weight {
		...
		Weight::from_parts(14_787_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_parts(33_585_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_parts(14_098_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Preimage::StatusFor` (r:1 w:0)
	...
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_parts(13_204_000, 3544)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn ensure_updated(n: u32, ) -> Weight {
		...
		Weight::from_parts(59_244_000, 990)
			// Standard Error: 70_053
			.saturating_add(Weight::from_parts(59_189_949, 0).saturating_mul(n.into()))
