...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(3_878_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(7_121_758, 42428)
			// Standard Error: 1_661
			.saturating_add(Weight::from_parts(347_279, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_761_000, 3644)
			// Standard Error: 3
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_951_133, 42428)
			// Standard Error: 1_610
			.saturating_add(Weight::from_parts(394_283, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_238_267, 42428)
			// Standard Error: 1_041
			.saturating_add(Weight::from_parts(581_706, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(18_834_357, 42428)
			// Standard Error: 2_845
			.saturating_add(Weight::from_parts(435_345, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(20_009_729, 42428)
			// Standard Error: 1_511
			.saturating_add(Weight::from_parts(624_579, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(10_443_479, 42428)
			// Standard Error: 437
			.saturating_add(Weight::from_parts(30_238, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(27_074_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		Weight::from_parts(37_344_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:0)
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(26_233_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(37_255_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
