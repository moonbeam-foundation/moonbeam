...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(6_225_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(6_995_231, 42428)
			// Standard Error: 1_764
			.saturating_add(Weight::from_parts(391_768, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_427_000, 3644)
			// Standard Error: 6
	...
	fn execute_dispatch_signed() -> Weight {
		...
		Weight::from_parts(5_545_000, 1565)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_579_879, 42428)
			// Standard Error: 1_593
			.saturating_add(Weight::from_parts(428_406, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(15_909_716, 42428)
			// Standard Error: 1_207
			.saturating_add(Weight::from_parts(644_157, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(18_606_116, 42428)
			// Standard Error: 2_955
			.saturating_add(Weight::from_parts(471_672, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(19_629_405, 42428)
			// Standard Error: 1_846
			.saturating_add(Weight::from_parts(678_558, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(10_173_018, 42428)
			// Standard Error: 476
			.saturating_add(Weight::from_parts(28_184, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(28_071_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn set_retry_named() -> Weight {
		...
		//  Measured:  `9606`
		//  Estimated: `42428`
		// Minimum execution time: 36_254_000 picoseconds.
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(26_697_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(36_155_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
