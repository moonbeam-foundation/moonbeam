...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agendas_base() -> Weight {
		...
		Weight::from_parts(2_829_000, 1489)
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(5_923_530, 42428)
			// Standard Error: 1_386
			.saturating_add(Weight::from_parts(351_623, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn service_task_fetched(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_128_000, 3644)
			// Standard Error: 3
	...
	fn execute_dispatch_signed() -> Weight {
		...
		Weight::from_parts(4_189_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_049_516, 42428)
			// Standard Error: 1_380
			.saturating_add(Weight::from_parts(390_694, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_157_022, 42428)
			// Standard Error: 938
			.saturating_add(Weight::from_parts(579_346, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_167_275, 42428)
			// Standard Error: 2_215
			.saturating_add(Weight::from_parts(417_724, 0).saturating_mul(s.into()))
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(17_272_398, 42428)
			// Standard Error: 1_375
			.saturating_add(Weight::from_parts(604_903, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn schedule_retry(s: u32, ) -> Weight {
		...
		Weight::from_parts(8_978_084, 42428)
			// Standard Error: 390
			.saturating_add(Weight::from_parts(19_856, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
	...
	fn set_retry() -> Weight {
		...
		Weight::from_parts(24_547_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn cancel_retry() -> Weight {
		...
		Weight::from_parts(23_456_000, 42428)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:0)
	...
	fn cancel_retry_named() -> Weight {
		...
		Weight::from_parts(31_382_000, 42428)
			.saturating_add(T::DbWeight::get().reads(2_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
