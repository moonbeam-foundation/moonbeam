...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_042_000, 1527)
			// Standard Error: 19_075
			.saturating_add(Weight::from_parts(5_678_249, 0).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_parts(7_539_000, 1527)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `MaintenanceMode::MaintenanceMode` (r:1 w:0)
	/// Proof: `MaintenanceMode::MaintenanceMode` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_991_000, 1527)
			...
			.saturating_add(Weight::from_parts(5_879_358, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_956_000, 1527)
			// Standard Error: 19_134
			.saturating_add(Weight::from_parts(5_711_215, 0).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
}
