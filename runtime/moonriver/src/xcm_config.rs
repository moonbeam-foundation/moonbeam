...
parameter_types! {
	...
	pub RelayChainOrigin: RuntimeOrigin = cumulus_pallet_xcm::Origin::Relay.into();// The universal location within the global consensus system
...
parameter_types! {
	...
	pub UnitWeightCost: Weight = Weight::from_parts(200_000_000u64, 64 * 1024);
