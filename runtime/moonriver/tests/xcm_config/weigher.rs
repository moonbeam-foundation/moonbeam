...
//! they contain. Moonriver uses WeightInfoBounds with custom XcmWeight implementation.

use crate::xcm_common::*;
use moonriver_runtime::{xcm_config::XcmWeigher, RuntimeCall};
...
fn message_queue_heap_size_sufficient_for_xcm() {
	ExtBuilder::default().build().execute_with(|| {
		...
		use moonriver_runtime::xcm_config::MessageQueueHeapSize;
