...
use crate::network::{ASSET_HUB_PARA_ID, MOONRIVER_PARA_ID, SIBLING_PARA_ID};
...
pub fn relay_genesis() -> Storage {
	...
	let moonriver_sovereign: AccountId32 =
		polkadot_parachain::primitives::Id::from(MOONRIVER_PARA_ID).into_account_truncating();
	...
	for para_id in [ASSET_HUB_PARA_ID, MOONRIVER_PARA_ID, SIBLING_PARA_ID] {
