...
ALPHANET_STAKERS=($(jq '.genesis.runtime.stake.stakers[] | .[0]' ${ALPHANET_PARACHAIN_SPEC_TEMPLATE}))
...
STAGENET_STAKERS=($(jq '.genesis.runtime.stake.stakers[] | .[0]' ${STAGENET_PARACHAIN_SPEC_TEMPLATE}))
