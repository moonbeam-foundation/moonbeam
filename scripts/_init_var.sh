...
ALPHANET_PARACHAIN_EMBEDDED_SPEC=${ALPHANET_PARACHAIN_EMBEDDED_SPEC:-"$ALPHANET_SPEC_FOLDER/parachain-embedded-specs-v6.json"}
...
ALPHANET_ROCOCO_EMBEDDED_SPEC=${ALPHANET_ROCOCO_EMBEDDED_SPEC:-"$ALPHANET_SPEC_FOLDER/rococo-embedded-specs-v6.json"}
...
ALPHANET_STAKERS=($(jq -r '.genesis.runtime.stake.stakers[] | .[0]' ${ALPHANET_PARACHAIN_SPEC_TEMPLATE}))
...
STAGENET_PARACHAIN_EMBEDDED_SPEC=${STAGENET_PARACHAIN_EMBEDDED_SPEC:-"$STAGENET_SPEC_FOLDER/parachain-embedded-specs-v6.json"}
...
STAGENET_ROCOCO_EMBEDDED_SPEC=${STAGENET_ROCOCO_EMBEDDED_SPEC:-"$STAGENET_SPEC_FOLDER/rococo-embedded-specs-v6.json"}
...
STAGENET_STAKERS=($(jq -r '.genesis.runtime.stake.stakers[] | .[0]' ${STAGENET_PARACHAIN_SPEC_TEMPLATE}))
