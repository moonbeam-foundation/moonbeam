...
import type { GenericContext } from "moonwall";
import {
...
export const RUNTIME_CONSTANTS = {
  ...
  MOONBEAM: {
    ...
    MAX_FEE_MULTIPLIER: 100_000_000_000_000_000_000_000n,
    WEIGHT_FEE: new RuntimeConstant({
      4303: (500_000n * KILOWEI * MOONBEAM_CONSTANTS.SUPPLY_FACTOR) / 4n,
    ...
    MAX_BASE_FEE: new RuntimeConstant({
      4303: 31_250_000_000_000_000_000n,
