  ...
  testCases: ({ context, it, log }) => {
    ...
    it({
      ...
      test: async function () {
        ...
        // Call every address and ensure it only local asset addresses get revertedß
        for (let {address, local} of addresses) {
          ...
          const receipt = await context
            ...
            if (local) {
              ...
              expect(revertReason).to.equal("disabled precompile");
            } else {
