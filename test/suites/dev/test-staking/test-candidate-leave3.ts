...
//   beforeAll("should join candidates, schedule leave, and jump to earlier round", async () => {
//     await expectOk(
//       context.createBlock([
...
//   beforeAll("should join candidates, schedule leave, and jump to exact round", async () => {
//     await expectOk(
//       context.createBlock([
//         context.polkadotJs().tx.sudo
//           .sudo(context.polkadotJs().tx.parachainStaking.setBlocksPerRound(10))
...
//   beforeAll("should join candidates, schedule leave, and jump to after round", async () => {
//     await expectOk(
//       context.createBlock([
//         context.polkadotJs().tx.sudo
//           .sudo(context.polkadotJs().tx.parachainStaking.setBlocksPerRound(10))
