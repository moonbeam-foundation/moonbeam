...
import { registerForeignAsset, XcmFragment, weightMessage } from "../../../helpers/xcm.js";
...
describeSuite({
  ...
  testCases: ({ context, it, log }) => {
    ...
    await expectOk(
      context.createBlock(context.polkadotJs().tx.balances.transfer(sovereignAddress, 1n * GLMR))
    );
