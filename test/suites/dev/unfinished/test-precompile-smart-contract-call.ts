...
import { beforeAll, beforeEach, describeSuite } from "@moonwall/cli";
...
describeSuite({
  id: "D2557",
  title: "Smart Contract Precompile Call - AddProxy",
  ...
  testCases: ({ context, it, log }) => {
    ...
    beforeEach(async function () {
      ...
      const { contractAddress } = await context.deployContract!(
