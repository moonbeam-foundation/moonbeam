...
describeSmokeSuite(
  `Ethereum CurrentBlock and CurrentReceipts should never be 0x00 (${suiteNumber})`,
  (context) => {
    it(`should have non default field values (${suiteNumber}C100)`, async function () {
