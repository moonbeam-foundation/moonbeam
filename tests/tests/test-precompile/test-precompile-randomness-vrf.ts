...
describeDevMoonbeam("Precompile Randomness - request babe randomness current block", (context) => {
  it("should succeed with Returned", async function () {
    const { result } = await context.createBlock(
      createTransaction(context, {
        ...ALITH_TRANSACTION_TEMPLATE,
...
describeDevMoonbeam("Precompile Randomness - request babe randomness one epoch ago", (context) => {
  it("should succeed with Returned", async function () {
    const { result } = await context.createBlock(
      createTransaction(context, {
        ...ALITH_TRANSACTION_TEMPLATE,
...
describeDevMoonbeam("Precompile Randomness - request babe randomness two epoch ago", (context) => {
  it("should succeed with Returned", async function () {
    const { result } = await context.createBlock(
      createTransaction(context, {
        ...ALITH_TRANSACTION_TEMPLATE,
