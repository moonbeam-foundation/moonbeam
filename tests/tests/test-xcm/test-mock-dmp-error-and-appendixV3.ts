...
import { TEN_MINS, THIRTY_MINS } from "../../util/constants";

// Twelve decimal places in the moonbase relay chain's token
const RELAY_TOKEN = 1_000_000_000_000n;
const palletId = "0x6D6f646c617373746d6E67720000000000000000";

describeDevMoonbeam("Mock XCMv3 - downward transfer with non-triggered error handler", (context) => {
  let assetId: string;
...
describeDevMoonbeam("Mock XCMv3 - downward transfer with triggered error handler", (context) => {
  let assetId: string;
