...
describeDevMoonbeamAllRuntimes(
  "Mock XCM - receive horizontal transact with two Descends",
  (context) => {
    let transferredBalance;
    let sendingAddress;
    let random: KeyringPair;
...
describeDevMoonbeamAllRuntimes(
  "Mock XCM - receive horizontal transact without withdraw",
  (context) => {
    let transferredBalance;
    let sendingAddress;
    let random: KeyringPair;
...
describeDevMoonbeamAllRuntimes(
  "Mock XCM - receive horizontal transact without buy execution",
  (context) => {
    let transferredBalance;
    let sendingAddress;
    let random: KeyringPair;
