...
export async function deployContractByName(web3: Web3, name: string): Promise<Contract> {
  const contractCompiled = await getCompiled(name);
  return deployContractManualSeal(web3, contractCompiled.byteCode, contractCompiled.contract.abi);
}
