...
/**
 * Action for the bot for the pattern "!faucet send <h160_addr>", that sends
 * funds to the indicated account.
 *
 ...
 * @param discordUserReceivers Map with the timestamp of the last received
 *   request of a user
...
/**
 * Action for the bot for the pattern "!balance <h160_addr>", that checks the
 * balance of the indicated account.
 *
 * @param web3Api Instance of the web3 API connected to the chain endpoint
 * @param msg Received discord message object
 * @param messageContent Content of the message
...
/**
 * Checks the balance of the bot is over a certain threshold, alerting if that's
 * the case on Slack
 *
 * @param web3Api Instance of the web3 API connected to the chain endpoint
 ...
 * @param pendingQueue Queue of tasks
 * @param discordUserReceivers Map with the timestamp of the last received
 *   request of a discord user
 * @param addressReceivers Map with the timestamp of the last received request
 *   of an address
 */
 ...
 * resolves them with a series of different worker addresses to avoid a nonce conflict.
 *
 * @param web3Api Instance of the web3 API connected to the chain endpoint
 * @param workers Array of worker accounts that will be used to sign the transfer txs
 * @param pendingQueue Queue of tasks
