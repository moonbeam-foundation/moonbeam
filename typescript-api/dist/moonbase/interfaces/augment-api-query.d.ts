...
declare module "@polkadot/api-base/types/storage" {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        evmForeignAssets: {
             ...
             */
            assetsById: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<StagingXcmV4Location>>, [
                u128
            ]> & QueryableStorageEntry<ApiType, [u128]>;
            /**
            ...
            assetsByLocation: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<ITuple<[u128, PalletMoonbeamForeignAssetsAssetStatus]>>>, [
        ...
        parameters: {
            ...
            parameters: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeRuntimeParamsRuntimeParametersKey | {
                RuntimeConfig: any;
            } | string | Uint8Array) => Observable<Option<MoonbaseRuntimeRuntimeParamsRuntimeParametersValue>>, [
        ...
        xcmWeightTrader: {
            ...
            supportedAssets: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<ITuple<[bool, u128]>>>, [
                StagingXcmV4Location
            ]> & QueryableStorageEntry<ApiType, [StagingXcmV4Location]>;
            /** Generic query */
            [key: string]: QueryableStorageEntry<ApiType>;
