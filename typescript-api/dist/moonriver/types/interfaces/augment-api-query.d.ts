    ...
    interface AugmentedQueries<ApiType extends ApiTypes> {
        assetManager: {
            ...
            assetTypeId: AugmentedQuery<ApiType, (arg: MoonriverRuntimeXcmConfigAssetType | {
                Xcm: any;
            } | string | Uint8Array) => Observable<Option<u128>>, [MoonriverRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonriverRuntimeXcmConfigAssetType]>;
            /**
             * Generic query
             **/
        ...
        evmForeignAssets: {
             ...
             * the corresponding asset in which tokens should me minted.
             **/
            assetsByLocation: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<ITuple<[u128, PalletMoonbeamForeignAssetsAssetStatus]>>>, [StagingXcmV4Location]> & QueryableStorageEntry<ApiType, [StagingXcmV4Location]>;
            /**
        ...
        parameters: {
             ...
             * Stored parameters.
             **/
            parameters: AugmentedQuery<ApiType, (arg: MoonriverRuntimeRuntimeParamsRuntimeParametersKey | {
                RuntimeConfig: any;
            } | {
                PalletRandomness: any;
            } | string | Uint8Array) => Observable<Option<MoonriverRuntimeRuntimeParamsRuntimeParametersValue>>, [MoonriverRuntimeRuntimeParamsRuntimeParametersKey]> & QueryableStorageEntry<ApiType, [MoonriverRuntimeRuntimeParamsRuntimeParametersKey]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        polkadotXcm: {
            ...
            remoteLockedFungibles: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array, arg3: XcmVersionedAssetId | {
                ...
                V4: any;
            } | string | Uint8Array) => Observable<Option<PalletXcmRemoteLockedFungibleRecord>>, [u32, AccountId20, XcmVersionedAssetId]> & QueryableStorageEntry<ApiType, [u32, AccountId20, XcmVersionedAssetId]>;
            /**
        ...
        randomness: {
            ...
            randomnessResults: AugmentedQuery<ApiType, (arg: PalletRandomnessRequestType | {
                ...
                Local: any;
            } | string | Uint8Array) => Observable<Option<PalletRandomnessRandomnessResult>>, [PalletRandomnessRequestType]> & QueryableStorageEntry<ApiType, [PalletRandomnessRequestType]>;
            /**
             * Relay epoch
             **/
        ...
        xcmTransactor: {
            ...
            destinationAssetFeePerSecond: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<u128>>, [StagingXcmV4Location]> & QueryableStorageEntry<ApiType, [StagingXcmV4Location]>;
            /**
            ...
            transactInfoWithWeightLimit: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<PalletXcmTransactorRemoteTransactInfoWithMaxWeight>>, [StagingXcmV4Location]> & QueryableStorageEntry<ApiType, [StagingXcmV4Location]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
        ...
        xcmWeightTrader: {
             ...
             **/
            supportedAssets: AugmentedQuery<ApiType, (arg: StagingXcmV4Location | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array) => Observable<Option<ITuple<[bool, u128]>>>, [StagingXcmV4Location]> & QueryableStorageEntry<ApiType, [StagingXcmV4Location]>;
            /**
             * Generic query
             **/
            [key: string]: QueryableStorageEntry<ApiType>;
