...
declare module '@polkadot/types/lookup' {
    ...
    interface PalletMoonbeamLazyMigrationsError extends Enum {
        ...
        readonly type: 'LimitCannotBeZero' | 'ContractMetadataAlreadySet' | 'ContractNotExist' | 'KeyTooLong' | 'SymbolTooLong' | 'NameTooLong' | 'AssetTypeNotFound' | 'AssetNotFound' | 'LocationNotFound' | 'MigrationNotFinished' | 'NoMigrationInProgress' | 'MintFailed' | 'ApprovalFailed';
    }
