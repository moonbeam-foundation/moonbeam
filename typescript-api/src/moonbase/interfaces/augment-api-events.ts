...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      ForeignAssetTypeChanged: AugmentedEvent<ApiType, [assetId: u128, newAssetType: MoonbaseRuntimeXcmConfigAssetType], { assetId: u128, newAssetType: MoonbaseRuntimeXcmConfigAssetType }>;
      /**
       * Removed all information related to an assetId and destroyed asset
       **/
       ...
       **/
      UnitsPerSecondChanged: AugmentedEvent<ApiType, [assetType: MoonbaseRuntimeXcmConfigAssetType, unitsPerSecond: u128], { assetType: MoonbaseRuntimeXcmConfigAssetType, unitsPerSecond: u128 }>;
      /**
       * Generic event
       **/
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId20, who: AccountId20, proxyType: MoonbaseRuntimeProxyType, disambiguationIndex: u16], { anonymous: AccountId20, who: AccountId20, proxyType: MoonbaseRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
