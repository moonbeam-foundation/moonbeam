...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetTypeUnitsPerSecond: AugmentedQuery<ApiType, (arg: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonbaseRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonbaseRuntimeXcmConfigAssetType]>;
      /**
      ...
      supportedFeePaymentAssets: AugmentedQuery<ApiType, () => Observable<Vec<MoonbaseRuntimeXcmConfigAssetType>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
