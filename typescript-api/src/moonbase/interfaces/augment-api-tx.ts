...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportScheduleMaybeHashed, MoonbaseRuntimeAssetConfigAssetRegistrarMetadata, MoonbaseRuntimeOriginCaller, MoonbaseRuntimeProxyType, MoonbaseRuntimeXcmConfigAssetType, MoonbaseRuntimeXcmConfigCurrencyId, MoonbaseRuntimeXcmConfigTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletXcmTransactorCurrencyPayment, PalletXcmTransactorTransactWeights, SpRuntimeMultiSignature, XcmPrimitivesEthereumXcmEthereumXcmTransaction, XcmV0OriginKind, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
       ...
       * data
       **/
      destroyForeignAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, destroyAssetWitness: PalletAssetsDestroyWitness | { accounts?: any; sufficients?: any; approvals?: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, PalletAssetsDestroyWitness, u32]>;
      /**
       ...
       * to be counter here
       **/
      destroyLocalAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, destroyAssetWitness: PalletAssetsDestroyWitness | { accounts?: any; sufficients?: any; approvals?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128, PalletAssetsDestroyWitness]>;
      /**
       ...
       **/
      registerLocalAsset: AugmentedSubmittable<(creator: AccountId20 | string | Uint8Array, owner: AccountId20 | string | Uint8Array, isSufficient: bool | boolean | Uint8Array, minBalance: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, bool, u128]>;
      /**
      ...
      removeSupportedAsset: AugmentedSubmittable<(assetType: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeXcmConfigAssetType, u32]>;
      /**
       * Change the amount of units we are charging per execution second
       * for a given ForeignAssetType
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonbaseRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeXcmConfigAssetType, u128, u32]>;
      /**
       * Generic tx
       **/
    ...
    proxy: {
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      killAnonymous: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: MoonbaseRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, MoonbaseRuntimeProxyType, u16, Compact<u32>, Compact<u32>]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbaseRuntimeProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbaseRuntimeProxyType>, Call]>;
      /**
    ...
    treasury: {
       ...
       * beneficiary.
       **/
      spend: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array, beneficiary: AccountId20 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId20]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonbaseRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { CouncilCollective: any } | { TechCommitteeCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | { EthereumXcm: any } | { TreasuryCouncilCollective: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    xcmTransactor: {
       ...
       **/
      removeFeePerSecond: AugmentedSubmittable<(assetLocation: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation]>;
      /**
       * Remove the transact info of a location
       **/
      removeTransactInfo: AugmentedSubmittable<(location: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation]>;
      /**
       * Set the fee per second of an asset on its reserve chain
       **/
      setFeePerSecond: AugmentedSubmittable<(assetLocation: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, feePerSecond: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, u128]>;
      /**
       * Change the transact info of a location
       **/
      setTransactInfo: AugmentedSubmittable<(location: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, transactExtraWeight: u64 | AnyNumber | Uint8Array, maxWeight: u64 | AnyNumber | Uint8Array, transactExtraWeightSigned: Option<u64> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, u64, u64, Option<u64>]>;
      /**
       ...
       **/
      transactThroughDerivative: AugmentedSubmittable<(dest: MoonbaseRuntimeXcmConfigTransactors | 'Relay' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, innerCall: Bytes | string | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeXcmConfigTransactors, u16, PalletXcmTransactorCurrencyPayment, Bytes, PalletXcmTransactorTransactWeights]>;
      /**
       ...
       **/
      transactThroughSigned: AugmentedSubmittable<(dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, call: Bytes | string | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, PalletXcmTransactorCurrencyPayment, Bytes, PalletXcmTransactorTransactWeights]>;
      /**
       ...
       **/
      transactThroughSovereign: AugmentedSubmittable<(dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, feePayer: AccountId20 | string | Uint8Array, fee: PalletXcmTransactorCurrencyPayment | { currency?: any; feeAmount?: any } | string | Uint8Array, call: Bytes | string | Uint8Array, originKind: XcmV0OriginKind | 'Native' | 'SovereignAccount' | 'Superuser' | 'Xcm' | number | Uint8Array, weightInfo: PalletXcmTransactorTransactWeights | { transactRequiredWeightAtMost?: any; overallWeight?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [XcmVersionedMultiLocation, AccountId20, PalletXcmTransactorCurrencyPayment, Bytes, XcmV0OriginKind, PalletXcmTransactorTransactWeights]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transfer: AugmentedSubmittable<(currencyId: MoonbaseRuntimeXcmConfigCurrencyId | { SelfReserve: any } | { ForeignAsset: any } | { LocalAssetReserve: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeXcmConfigCurrencyId, u128, XcmVersionedMultiLocation, u64]>;
      /**
       * Transfer `MultiAsset`.
       * 
       * `dest_weight` is the weight for XCM execution on the dest chain, and
       ...
       * messages correctly.
       **/
      transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[MoonbaseRuntimeXcmConfigCurrencyId, u128]>> | ([MoonbaseRuntimeXcmConfigCurrencyId | { SelfReserve: any } | { ForeignAsset: any } | { LocalAssetReserve: any } | string | Uint8Array, u128 | AnyNumber | Uint8Array])[], feeItem: u32 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[MoonbaseRuntimeXcmConfigCurrencyId, u128]>>, u32, XcmVersionedMultiLocation, u64]>;
      /**
