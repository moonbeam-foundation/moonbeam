...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    parameters: {
       ...
       **/
      setParameter: AugmentedSubmittable<(keyValue: MoonbaseRuntimeRuntimeParamsRuntimeParameters | { RuntimeConfig: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbaseRuntimeRuntimeParamsRuntimeParameters]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
