...
export default {
  ...
  /**
   * Lookup52: pallet_parachain_staking::delegation_requests::CancelledScheduledRequest<Balance>
   **/
  ...
  /**
   * Lookup199: frame_support::traits::schedule::MaybeHashed<moonbase_runtime::Call, primitive_types::H256>
   **/
  ...
  /**
   * Lookup300: pallet_xcm_transactor::pallet::CurrencyPayment<moonbase_runtime::xcm_config::CurrencyId>
   **/
  ...
  /**
   * Lookup301: pallet_xcm_transactor::pallet::Currency<moonbase_runtime::xcm_config::CurrencyId>
   **/
  ...
  /**
   * Lookup317: frame_support::dispatch::RawOrigin<account::AccountId20>
   **/
  ...
  /**
   * Lookup350: polkadot_core_primitives::OutboundHrmpMessage<polkadot_parachain::primitives::Id>
   **/
  ...
  /**
   * Lookup365: ethereum::block::Block<ethereum::transaction::TransactionV2>
   **/
  EthereumBlock: {
  ...
  /**
   * Lookup373: pallet_parachain_staking::types::ParachainBondConfig<account::AccountId20>
   **/
  ...
  /**
   * Lookup376: pallet_parachain_staking::set::OrderedSet<pallet_parachain_staking::types::Bond<account::AccountId20, Balance>>
   **/
  ...
  /**
   * Lookup386: pallet_parachain_staking::delegation_requests::ScheduledRequest<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup387: pallet_parachain_staking::types::Delegations<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup389: pallet_parachain_staking::types::CollatorSnapshot<account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup395: pallet_scheduler::ScheduledV3<frame_support::traits::schedule::MaybeHashed<moonbase_runtime::Call, primitive_types::H256>, BlockNumber, moonbase_runtime::OriginCaller, account::AccountId20>
   **/
  ...
  /**
   * Lookup400: pallet_democracy::PreimageStatus<account::AccountId20, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup401: pallet_democracy::types::ReferendumInfo<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup402: pallet_democracy::types::ReferendumStatus<BlockNumber, primitive_types::H256, Balance>
   **/
  ...
  /**
   * Lookup430: pallet_proxy::ProxyDefinition<account::AccountId20, moonbase_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup434: pallet_proxy::Announcement<account::AccountId20, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup480: pallet_assets::types::AssetDetails<Balance, account::AccountId20, DepositBalance>
   **/
  ...
  /**
   * Lookup486: pallet_assets::types::AssetMetadata<DepositBalance, sp_runtime::bounded::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup495: pallet_moonbeam_orbiters::types::CollatorPoolInfo<account::AccountId20>
   **/
  ...
  /**
   * Lookup497: pallet_moonbeam_orbiters::types::CurrentOrbiter<account::AccountId20>
   **/
  ...
  /**
   * Lookup500: pallet_randomness::types::Request<Balance, pallet_randomness::types::RequestInfo<T>>
   **/
