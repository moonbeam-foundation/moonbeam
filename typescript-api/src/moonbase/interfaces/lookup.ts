...
export default {
  ...
  /**
   * Lookup173: frame_support::traits::preimages::Bounded<moonbase_runtime::RuntimeCall,
  ...
  /** Lookup182: frame_support::dispatch::RawOrigin[account::AccountId20](account::AccountId20) */
