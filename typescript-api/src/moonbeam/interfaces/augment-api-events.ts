...
import type { BpHeaderChainHeaderFinalityInfo, BpMessagesDeliveredMessages, BpMessagesReceivedMessages, CumulusPrimitivesCoreAggregateMessageOrigin, EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchPostDispatchInfo, FrameSupportMessagesProcessMessageError, FrameSupportPreimagesBounded, FrameSupportTokensFungibleUnionOfNativeOrWithId, FrameSupportTokensMiscBalanceStatus, FrameSystemDispatchEventInfo, MoonbeamRuntimeProxyType, MoonbeamRuntimeRuntimeParamsRuntimeParametersKey, MoonbeamRuntimeRuntimeParamsRuntimeParametersValue, NimbusPrimitivesNimbusCryptoPublic, PalletConvictionVotingTally, PalletConvictionVotingVoteAccountVote, PalletMultisigTimepoint, PalletParachainStakingDelegationRequestsCancelledScheduledRequest, PalletParachainStakingDelegatorAdded, PalletParachainStakingInflationDistributionConfig, PalletProxyDepositKind, PalletXcmTransactorHrmpOperation, PalletXcmTransactorRemoteTransactInfoWithMaxWeight, SessionKeysPrimitivesVrfVrfCryptoPublic, SpRuntimeDispatchError, SpRuntimeDispatchErrorWithPostInfo, SpWeightsWeightV2Weight, StagingXcmV5AssetAssets, StagingXcmV5Junctions, StagingXcmV5Location, StagingXcmV5Response, StagingXcmV5TraitsOutcome, StagingXcmV5Xcm, XcmV3TraitsSendError, XcmV5TraitsError, XcmVersionedAssets, XcmVersionedLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    bridgeKusamaMessages: {
       ...
       **/
      MessageAccepted: AugmentedEvent<ApiType, [laneId: H256, nonce: u64], { laneId: H256, nonce: u64 }>;
      /**
       * Messages in the inclusive range have been delivered to the bridged chain.
       **/
      MessagesDelivered: AugmentedEvent<ApiType, [laneId: H256, messages: BpMessagesDeliveredMessages], { laneId: H256, messages: BpMessagesDeliveredMessages }>;
      /**
    ...
    bridgeXcmOverMoonriver: {
       ...
       **/
      BridgeOpened: AugmentedEvent<ApiType, [bridgeId: H256, bridgeDeposit: u128, localEndpoint: StagingXcmV5Junctions, remoteEndpoint: StagingXcmV5Junctions, laneId: H256], { bridgeId: H256, bridgeDeposit: u128, localEndpoint: StagingXcmV5Junctions, remoteEndpoint: StagingXcmV5Junctions, laneId: H256 }>;
      /**
       * Bridge has been closed and pruned from the runtime storage. It now may be reopened
       * again by any participant.
       **/
      BridgePruned: AugmentedEvent<ApiType, [bridgeId: H256, laneId: H256, bridgeDeposit: u128, prunedMessages: u64], { bridgeId: H256, laneId: H256, bridgeDeposit: u128, prunedMessages: u64 }>;
      /**
       * Bridge is going to be closed, but not yet fully pruned from the runtime storage.
       **/
      ClosingBridge: AugmentedEvent<ApiType, [bridgeId: H256, laneId: H256, prunedMessages: u64, enqueuedMessages: u64], { bridgeId: H256, laneId: H256, prunedMessages: u64, enqueuedMessages: u64 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    convictionVoting: {
       ...
       **/
      VoteUnlocked: AugmentedEvent<ApiType, [who: AccountId20, class_: u16], { who: AccountId20, class: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    multisig: {
       ...
       **/
      DepositPoked: AugmentedEvent<ApiType, [who: AccountId20, callHash: U8aFixed, oldDeposit: u128, newDeposit: u128], { who: AccountId20, callHash: U8aFixed, oldDeposit: u128, newDeposit: u128 }>;
      /**
    ...
    proxy: {
       ...
       **/
      DepositPoked: AugmentedEvent<ApiType, [who: AccountId20, kind: PalletProxyDepositKind, oldDeposit: u128, newDeposit: u128], { who: AccountId20, kind: PalletProxyDepositKind, oldDeposit: u128, newDeposit: u128 }>;
      /**
       * A proxy was added.
       **/
