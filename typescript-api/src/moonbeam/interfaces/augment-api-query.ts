...
import type { BpHeaderChainStoredHeaderData, BpMessagesInboundLaneData, BpMessagesMessageKey, BpMessagesMessagesOperatingMode, BpMessagesOutboundLaneData, BpParachainsParaInfo, BpRuntimeBasicOperatingMode, BpXcmBridgeHubBridge, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, CumulusPalletParachainSystemUnincludedSegmentAncestor, CumulusPalletParachainSystemUnincludedSegmentSegmentTracker, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, CumulusPrimitivesCoreAggregateMessageOrigin, EthereumBlock, EthereumReceiptReceiptV4, EthereumTransactionTransactionV3, FpRpcTransactionStatus, FrameSupportDispatchPerDispatchClassWeight, FrameSupportTokensMiscIdAmount, FrameSystemAccountInfo, FrameSystemCodeUpgradeAuthorization, FrameSystemEventRecord, FrameSystemLastRuntimeUpgradeInfo, FrameSystemPhase, MoonbeamRuntimeRuntimeHoldReason, MoonbeamRuntimeRuntimeParamsRuntimeParametersKey, MoonbeamRuntimeRuntimeParamsRuntimeParametersValue, NimbusPrimitivesNimbusCryptoPublic, PalletAuthorMappingRegistrationInfo, PalletBalancesAccountData, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletBridgeGrandpaStorageTypesStoredAuthoritySet, PalletCollectiveVotes, PalletConvictionVotingVoteVoting, PalletCrowdloanRewardsRewardInfo, PalletEmergencyParaXcmXcmMode, PalletEvmCodeMetadata, PalletIdentityAuthorityProperties, PalletIdentityProvider, PalletIdentityRegistrarInfo, PalletIdentityRegistration, PalletIdentityUsernameInformation, PalletMessageQueueBookState, PalletMessageQueuePage, PalletMigrationsMigrationCursor, PalletMoonbeamForeignAssetsAssetDepositDetails, PalletMoonbeamForeignAssetsAssetStatus, PalletMoonbeamOrbitersCollatorPoolInfo, PalletMultisigMultisig, PalletParachainStakingAutoCompoundAutoCompoundConfig, PalletParachainStakingBond, PalletParachainStakingCandidateMetadata, PalletParachainStakingCollatorSnapshot, PalletParachainStakingDelayedPayout, PalletParachainStakingDelegationRequestsScheduledRequest, PalletParachainStakingDelegations, PalletParachainStakingDelegator, PalletParachainStakingInflationDistributionAccount, PalletParachainStakingInflationInflationInfo, PalletParachainStakingRoundInfo, PalletPreimageOldRequestStatus, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletRandomnessRandomnessResult, PalletRandomnessRequestState, PalletRandomnessRequestType, PalletReferendaReferendumInfo, PalletSchedulerRetryConfig, PalletSchedulerScheduled, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletTreasurySpendStatus, PalletXcmAuthorizedAliasesEntry, PalletXcmQueryStatus, PalletXcmRemoteLockedFungibleRecord, PalletXcmTransactorRelayIndicesRelayChainIndices, PalletXcmTransactorRemoteTransactInfoWithMaxWeight, PalletXcmVersionMigrationStage, PolkadotCorePrimitivesOutboundHrmpMessage, PolkadotPrimitivesV8AbridgedHostConfiguration, PolkadotPrimitivesV8PersistedValidationData, PolkadotPrimitivesV8UpgradeGoAhead, PolkadotPrimitivesV8UpgradeRestriction, SpRuntimeDigest, SpTrieStorageProof, SpWeightsWeightV2Weight, StagingXcmV5Instruction, StagingXcmV5Location, XcmVersionedAssetId, XcmVersionedLocation } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    bridgeKusamaGrandpa: {
       ...
       **/
      freeHeadersRemaining: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      palletOwner: AugmentedQuery<ApiType, () => Observable<Option<AccountId20>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    bridgeKusamaMessages: {
       ...
       **/
      inboundLanes: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<BpMessagesInboundLaneData>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Map of lane id => outbound lane data.
       **/
      outboundLanes: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<BpMessagesOutboundLaneData>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
    ...
    bridgeXcmOverMoonriver: {
       ...
       **/
      bridges: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<BpXcmBridgeHubBridge>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * All registered `lane_id` and `bridge_id` mappings.
       **/
      laneToBridge: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<H256>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    evmForeignAssets: {
       ...
       **/
      assetsById: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<StagingXcmV5Location>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Reverse mapping of AssetsById. Mapping from a foreign asset to an asset id.
       * This is mostly used when receiving a multilocation XCM message to retrieve
       * the corresponding asset in which tokens should me minted.
       **/
      assetsByLocation: AugmentedQuery<ApiType, (arg: StagingXcmV5Location | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<ITuple<[u128, PalletMoonbeamForeignAssetsAssetStatus]>>>, [StagingXcmV5Location]> & QueryableStorageEntry<ApiType, [StagingXcmV5Location]>;
      /**
       * Mapping from an asset id to its creation details
       **/
      assetsCreationDetails: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletMoonbeamForeignAssetsAssetDepositDetails>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Counter for the related counted storage map
       **/
    ...
    identity: {
       ...
       **/
      pendingUsernames: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Option<ITuple<[AccountId20, u32, PalletIdentityProvider]>>>, [Bytes]> & QueryableStorageEntry<ApiType, [Bytes]>;
      /**
       ...
       **/
      usernameOf: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<Bytes>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    openTechCommitteeCollective: {
       ...
       **/
      costOf: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<ITuple<[AccountId20, Null]>>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      /**
    ...
    parachainStaking: {
       ...
       **/
      wasInactive: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<Option<Null>>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xcmTransactor: {
       ...
       * from weight to fee
       **/
      destinationAssetFeePerSecond: AugmentedQuery<ApiType, (arg: StagingXcmV5Location | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<u128>>, [StagingXcmV5Location]> & QueryableStorageEntry<ApiType, [StagingXcmV5Location]>;
      /**
       ...
       **/
      transactInfoWithWeightLimit: AugmentedQuery<ApiType, (arg: StagingXcmV5Location | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<PalletXcmTransactorRemoteTransactInfoWithMaxWeight>>, [StagingXcmV5Location]> & QueryableStorageEntry<ApiType, [StagingXcmV5Location]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    xcmWeightTrader: {
       ...
       **/
      supportedAssets: AugmentedQuery<ApiType, (arg: StagingXcmV5Location | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<ITuple<[bool, u128]>>>, [StagingXcmV5Location]> & QueryableStorageEntry<ApiType, [StagingXcmV5Location]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
