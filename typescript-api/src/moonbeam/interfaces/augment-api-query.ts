...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetTypeUnitsPerSecond: AugmentedQuery<ApiType, (arg: MoonbeamRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonbeamRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonbeamRuntimeXcmConfigAssetType]>;
      /**
      ...
      supportedFeePaymentAssets: AugmentedQuery<ApiType, () => Observable<Vec<MoonbeamRuntimeXcmConfigAssetType>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
