...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportScheduleMaybeHashed, MoonbeamRuntimeAssetConfigAssetRegistrarMetadata, MoonbeamRuntimeOriginCaller, MoonbeamRuntimeProxyType, MoonbeamRuntimeXcmConfigAssetType, MoonbeamRuntimeXcmConfigCurrencyId, MoonbeamRuntimeXcmConfigTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletXcmTransactorCurrencyPayment, PalletXcmTransactorTransactWeights, SpRuntimeMultiSignature, XcmV0OriginKind, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
      ...
      removeSupportedAsset: AugmentedSubmittable<(assetType: MoonbeamRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeXcmConfigAssetType, u32]>;
      /**
       * Change the amount of units we are charging per execution second
       * for a given ForeignAssetType
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonbeamRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeXcmConfigAssetType, u128, u32]>;
      /**
       * Generic tx
       **/
    ...
    proxy: {
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonbeamRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
       ...
       * # </weight>
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonbeamRuntimeProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<MoonbeamRuntimeProxyType>, Call]>;
      /**
    ...
    utility: {
       ...
       * # </weight>
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: MoonbeamRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | { CouncilCollective: any } | { TechCommitteeCollective: any } | { TreasuryCouncilCollective: any } | { CumulusXcm: any } | { PolkadotXcm: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeOriginCaller, Call]>;
      /**
       * Send a batch of dispatch calls.
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transfer: AugmentedSubmittable<(currencyId: MoonbeamRuntimeXcmConfigCurrencyId | { SelfReserve: any } | { ForeignAsset: any } | { LocalAssetReserve: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonbeamRuntimeXcmConfigCurrencyId, u128, XcmVersionedMultiLocation, u64]>;
      /**
       * Transfer `MultiAsset`.
       * 
       * `dest_weight` is the weight for XCM execution on the dest chain, and
