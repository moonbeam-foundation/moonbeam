...
export default {
  ...
  /**
   * Lookup353:
   * pallet_xcm_transactor::pallet::CurrencyPayment<moonbeam_runtime::xcm_config::CurrencyId>
   */
  ...
  /**
   * Lookup354:
   * pallet_xcm_transactor::pallet::Currency<moonbeam_runtime::xcm_config::CurrencyId>
   */
