...
export default {
  ...
  /**
   * Lookup460: pallet_crowdloan_rewards::pallet::RewardInfo<T>
   */
  ...
  /**
   * Lookup462: pallet_crowdloan_rewards::pallet::Error<T>
   */
  ...
  /**
   * Lookup494: pallet_xcm::pallet::Error<T>
   */
  PalletXcmError: {
    _enum: [
      "Unreachable",
  ...
  /**
   * Lookup495: pallet_assets::types::AssetDetails<Balance,
