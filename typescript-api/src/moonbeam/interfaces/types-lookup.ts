...
declare module "@polkadot/types/lookup" {
  ...
  /** @name MoonbeamRuntimeXcmConfigAssetType (298) */
  ...
  /** @name MoonbeamRuntimeAssetConfigAssetRegistrarMetadata (299) */
  ...
  /** @name MoonbeamRuntimeXcmConfigCurrencyId (301) */
  ...
  /** @name MoonbeamRuntimeXcmConfigTransactors (306) */
  ...
  /** @name MoonbeamRuntimeRuntimeHoldReason (398) */
  ...
  /** @name MoonbeamRuntimeRuntime (648) */
