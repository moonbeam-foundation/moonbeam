...
declare module '@polkadot/types/lookup' {
  ...
  /** @name MoonbeamRuntimeXcmConfigAssetType (372) */
  ...
  /** @name MoonbeamRuntimeAssetConfigAssetRegistrarMetadata (373) */
  ...
  /** @name MoonbeamRuntimeRuntimeHoldReason (486) */
  ...
  /** @name MoonbeamRuntimeRuntime (705) */
