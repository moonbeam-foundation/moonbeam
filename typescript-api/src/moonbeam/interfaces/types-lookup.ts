...
declare module "@polkadot/types/lookup" {
  ...
  /** @name MoonbeamRuntimeXcmConfigTransactors (376) */
  ...
  /** @name MoonbeamRuntimeXcmConfigCurrencyId (378) */
  ...
  /** @name MoonbeamRuntimeRuntimeHoldReason (532) */
  ...
  /** @name MoonbeamRuntimeRuntime (754) */
  ...
  /** @name MoonbeamRuntimeBridgeRejectObsoleteHeadersAndMessages (808) */
