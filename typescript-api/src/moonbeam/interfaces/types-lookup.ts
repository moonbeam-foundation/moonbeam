...
declare module "@polkadot/types/lookup" {
  ...
  /** @name XcmV3JunctionNetworkId (96) */
  ...
  /** @name XcmV3MultiassetFungibility (107) */
  ...
  /** @name XcmV3MultiassetAssetInstance (108) */
  ...
  /** @name MoonbeamRuntimeXcmConfigAssetType (143) */
  ...
  /** @name MoonbeamRuntimeAssetConfigAssetRegistrarMetadata (144) */
  ...
  /** @name OrmlXtokensModuleEvent (145) */
  ...
  /** @name PolkadotParachainPrimitivesHrmpChannelId (151) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHrmpChannel (181) */
  ...
  /** @name PolkadotPrimitivesV2AbridgedHostConfiguration (183) */
  ...
  /** @name PalletRootTestingCall (201) */
  ...
  /** @name PalletParachainStakingParachainBondConfig (213) */
  interface PalletParachainStakingParachainBondConfig extends Struct {
    readonly account: AccountId20;
    readonly percent: Percent;
  }

  /** @name PalletParachainStakingRoundInfo (214) */
  ...
  /** @name PalletParachainStakingDelegator (215) */
  ...
  /** @name PalletParachainStakingCandidateMetadata (220) */
  ...
  /** @name PalletParachainStakingCapacityStatus (221) */
  ...
  /** @name PalletParachainStakingCandidateBondLessRequest (223) */
  interface PalletParachainStakingCandidateBondLessRequest extends Struct {
    readonly amount: u128;
    readonly whenExecutable: u32;
  }

  /** @name PalletParachainStakingCollatorStatus (224) */
  ...
  /** @name PalletParachainStakingDelegationRequestsScheduledRequest (226) */
  ...
  /** @name PalletParachainStakingAutoCompoundAutoCompoundConfig (228) */
  ...
  /** @name PalletParachainStakingCollatorSnapshot (232) */
  ...
  /** @name PalletParachainStakingBondWithAutoCompound (234) */
  ...
  /** @name PalletParachainStakingDelayedPayout (235) */
  ...
  /** @name PalletParachainStakingInflationInflationInfo (236) */
  ...
  /** @name PalletParachainStakingCall (239) */
  ...
  /** @name PalletParachainStakingError (240) */
  ...
  /** @name PalletAuthorInherentError (242) */
  ...
  /** @name PalletAuthorSlotFilterCall (243) */
  ...
  /** @name PalletAuthorMappingRegistrationInfo (244) */
  ...
  /** @name PalletAuthorMappingCall (245) */
  ...
  /** @name PalletAuthorMappingError (246) */
  ...
  /** @name PalletMoonbeamOrbitersCollatorPoolInfo (247) */
  ...
  /** @name PalletMoonbeamOrbitersError (251) */
  ...
  /** @name PalletMaintenanceModeCall (257) */
  ...
  /** @name PalletCrowdloanRewardsCall (329) */
  ...
  /** @name XcmV2MultiassetMultiAssetFilter (350) */
  ...
  /** @name XcmV2MultiassetWildMultiAsset (351) */
  ...
  /** @name XcmV2MultiassetWildFungibility (352) */
  ...
  /** @name PalletAssetManagerCall (363) */
  ...
  /** @name OrmlXtokensModuleCall (364) */
  ...
  /** @name MoonbeamRuntimeXcmConfigCurrencyId (365) */
  ...
  /** @name XcmVersionedMultiAsset (366) */
  ...
  /** @name PalletXcmTransactorCall (369) */
  ...
  /** @name MoonbeamRuntimeXcmConfigTransactors (370) */
  interface MoonbeamRuntimeXcmConfigTransactors extends Enum {
    readonly isRelay: boolean;
    readonly type: "Relay";
  }

  /** @name PalletXcmTransactorCurrencyPayment (371) */
  ...
  /** @name PalletXcmTransactorCurrency (372) */
  ...
  /** @name PalletXcmTransactorTransactWeights (374) */
  ...
  /** @name MoonbeamRuntimeOriginCaller (377) */
  ...
  /** @name PalletEthereumRawOrigin (379) */
  ...
  /** @name PalletMaintenanceModeError (396) */
  ...
  /** @name PalletIdentityRegistration (397) */
  ...
  /** @name PalletMigrationsError (408) */
  ...
  /** @name FpRpcTransactionStatus (413) */
  ...
  /** @name PalletDemocracyReferendumInfo (437) */
  ...
  /** @name PalletDemocracyReferendumStatus (438) */
  ...
  /** @name PalletDemocracyVoteVoting (440) */
  ...
  /** @name PalletDemocracyDelegations (444) */
  interface PalletDemocracyDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletDemocracyVotePriorLock (445) */
  interface PalletDemocracyVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletDemocracyError (448) */
  ...
  /** @name PalletCollectiveVotes (456) */
  ...
  /** @name PalletCollectiveError (457) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (467) */
  ...
  /** @name PalletCrowdloanRewardsError (469) */
  ...
  /** @name CumulusPalletXcmpQueueInboundChannelDetails (471) */
  ...
  /** @name CumulusPalletXcmpQueueInboundState (472) */
  ...
  /** @name PolkadotParachainPrimitivesXcmpMessageFormat (475) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (478) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (479) */
  ...
  /** @name CumulusPalletXcmpQueueQueueConfigData (481) */
  ...
  /** @name CumulusPalletXcmpQueueError (483) */
  ...
  /** @name PalletXcmVersionMigrationStage (500) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (504) */
  ...
  /** @name PalletAssetsAssetDetails (509) */
  ...
  /** @name PalletAssetsAssetStatus (510) */
  ...
  /** @name PalletAssetManagerAssetInfo (519) */
  interface PalletAssetManagerAssetInfo extends Struct {
    readonly creator: AccountId20;
    readonly deposit: u128;
  }

  /** @name PalletAssetManagerError (521) */
  ...
  /** @name PalletXcmTransactorError (523) */
  ...
  /** @name PalletRandomnessRequestInfo (527) */
  ...
  /** @name PalletRandomnessRequestType (528) */
  ...
  /** @name AccountEthereumSignature (532) */
  ...
  /** @name MoonbeamRuntimeRuntime (544) */
