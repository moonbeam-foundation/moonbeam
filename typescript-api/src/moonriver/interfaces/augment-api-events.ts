...
declare module '@polkadot/api-base/types/events' {
  export interface AugmentedEvents<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      ForeignAssetTypeChanged: AugmentedEvent<ApiType, [assetId: u128, newAssetType: MoonriverRuntimeXcmConfigAssetType], { assetId: u128, newAssetType: MoonriverRuntimeXcmConfigAssetType }>;
      /**
       * Removed all information related to an assetId and destroyed asset
       **/
       ...
       **/
      LocalAssetRegistered: AugmentedEvent<ApiType, [assetId: u128, creator: AccountId20, owner: AccountId20], { assetId: u128, creator: AccountId20, owner: AccountId20 }>;
      /**
       ...
       **/
      UnitsPerSecondChanged: AugmentedEvent<ApiType, [assetType: MoonriverRuntimeXcmConfigAssetType, unitsPerSecond: u128], { assetType: MoonriverRuntimeXcmConfigAssetType, unitsPerSecond: u128 }>;
      /**
       * Generic event
       **/
    ...
    assets: {
       ...
       **/
      Issued: AugmentedEvent<ApiType, [assetId: u128, owner: AccountId20, totalSupply: u128], { assetId: u128, owner: AccountId20, totalSupply: u128 }>;
      /**
    ...
    balances: {
       ...
       **/
      BalanceSet: AugmentedEvent<ApiType, [who: AccountId20, free: u128, reserved: u128], { who: AccountId20, free: u128, reserved: u128 }>;
      /**
    ...
    democracy: {
       ...
       **/
      Delegated: AugmentedEvent<ApiType, [who: AccountId20, target: AccountId20], { who: AccountId20, target: AccountId20 }>;
      /**
       ...
       **/
      PreimageNoted: AugmentedEvent<ApiType, [proposalHash: H256, who: AccountId20, deposit: u128], { proposalHash: H256, who: AccountId20, deposit: u128 }>;
      /**
       * A registered preimage was removed and the deposit collected by the reaper.
       **/
      PreimageReaped: AugmentedEvent<ApiType, [proposalHash: H256, provider: AccountId20, deposit: u128, reaper: AccountId20], { proposalHash: H256, provider: AccountId20, deposit: u128, reaper: AccountId20 }>;
      /**
       * A proposal preimage was removed and used (the deposit was returned).
       **/
      PreimageUsed: AugmentedEvent<ApiType, [proposalHash: H256, provider: AccountId20, deposit: u128], { proposalHash: H256, provider: AccountId20, deposit: u128 }>;
      /**
       ...
       **/
      Seconded: AugmentedEvent<ApiType, [seconder: AccountId20, propIndex: u32], { seconder: AccountId20, propIndex: u32 }>;
      /**
       ...
       **/
      Tabled: AugmentedEvent<ApiType, [proposalIndex: u32, deposit: u128, depositors: Vec<AccountId20>], { proposalIndex: u32, deposit: u128, depositors: Vec<AccountId20> }>;
      /**
       ...
       **/
      Vetoed: AugmentedEvent<ApiType, [who: AccountId20, proposalHash: H256, until: u32], { who: AccountId20, proposalHash: H256, until: u32 }>;
      /**
       * An account has voted in a referendum
       **/
      Voted: AugmentedEvent<ApiType, [voter: AccountId20, refIndex: u32, vote: PalletDemocracyVoteAccountVote], { voter: AccountId20, refIndex: u32, vote: PalletDemocracyVoteAccountVote }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    migrations: {
       ...
       * Migration completed
       **/
      MigrationCompleted: AugmentedEvent<ApiType, [migrationName: Bytes, consumedWeight: u64], { migrationName: Bytes, consumedWeight: u64 }>;
      /**
       * Migration started
       **/
    ...
    parachainStaking: {
       ...
       **/
      Delegation: AugmentedEvent<ApiType, [delegator: AccountId20, lockedAmount: u128, candidate: AccountId20, delegatorPosition: PalletParachainStakingDelegatorAdded], { delegator: AccountId20, lockedAmount: u128, candidate: AccountId20, delegatorPosition: PalletParachainStakingDelegatorAdded }>;
       ...
       **/
      ParachainBondAccountSet: AugmentedEvent<ApiType, [old: AccountId20, new_: AccountId20], { old: AccountId20, new_: AccountId20 }>;
      /**
       ...
       **/
      ReservedForParachainBond: AugmentedEvent<ApiType, [account: AccountId20, value: u128], { account: AccountId20, value: u128 }>;
      /**
    ...
    proxy: {
       ...
       **/
      AnonymousCreated: AugmentedEvent<ApiType, [anonymous: AccountId20, who: AccountId20, proxyType: MoonriverRuntimeProxyType, disambiguationIndex: u16], { anonymous: AccountId20, who: AccountId20, proxyType: MoonriverRuntimeProxyType, disambiguationIndex: u16 }>;
      /**
       * A proxy was added.
       **/
    ...
    xcmTransactor: {
       ...
       **/
      DestFeePerSecondChanged: AugmentedEvent<ApiType, [location: XcmV1MultiLocation, feePerSecond: u128], { location: XcmV1MultiLocation, feePerSecond: u128 }>;
      /**
       * Remove dest fee per second
       **/
      DestFeePerSecondRemoved: AugmentedEvent<ApiType, [location: XcmV1MultiLocation], { location: XcmV1MultiLocation }>;
      /**
       ...
       **/
      TransactedDerivative: AugmentedEvent<ApiType, [accountId: AccountId20, dest: XcmV1MultiLocation, call: Bytes, index: u16], { accountId: AccountId20, dest: XcmV1MultiLocation, call: Bytes, index: u16 }>;
      /**
       * Transacted the call through a signed account in a destination chain.
       **/
      TransactedSigned: AugmentedEvent<ApiType, [feePayer: AccountId20, dest: XcmV1MultiLocation, call: Bytes], { feePayer: AccountId20, dest: XcmV1MultiLocation, call: Bytes }>;
      /**
       * Transacted the call through the sovereign account in a destination chain.
       **/
      TransactedSovereign: AugmentedEvent<ApiType, [feePayer: AccountId20, dest: XcmV1MultiLocation, call: Bytes], { feePayer: AccountId20, dest: XcmV1MultiLocation, call: Bytes }>;
      /**
       * Transact failed
       **/
      TransactFailed: AugmentedEvent<ApiType, [error: XcmV2TraitsError], { error: XcmV2TraitsError }>;
      /**
       * Changed the transact info of a location
       **/
      TransactInfoChanged: AugmentedEvent<ApiType, [location: XcmV1MultiLocation, remoteInfo: PalletXcmTransactorRemoteTransactInfoWithMaxWeight], { location: XcmV1MultiLocation, remoteInfo: PalletXcmTransactorRemoteTransactInfoWithMaxWeight }>;
      /**
       * Removed the transact info of a location
       **/
      TransactInfoRemoved: AugmentedEvent<ApiType, [location: XcmV1MultiLocation], { location: XcmV1MultiLocation }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    xTokens: {
       ...
       **/
      TransferredMultiAssets: AugmentedEvent<ApiType, [sender: AccountId20, assets: XcmV1MultiassetMultiAssets, fee: XcmV1MultiAsset, dest: XcmV1MultiLocation], { sender: AccountId20, assets: XcmV1MultiassetMultiAssets, fee: XcmV1MultiAsset, dest: XcmV1MultiLocation }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
