...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    assetManager: {
       ...
       **/
      assetTypeUnitsPerSecond: AugmentedQuery<ApiType, (arg: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array) => Observable<Option<u128>>, [MoonriverRuntimeXcmConfigAssetType]> & QueryableStorageEntry<ApiType, [MoonriverRuntimeXcmConfigAssetType]>;
      /**
       ...
       * the deposit amount
       **/
      localAssetDeposit: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletAssetManagerAssetInfo>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      supportedFeePaymentAssets: AugmentedQuery<ApiType, () => Observable<Vec<MoonriverRuntimeXcmConfigAssetType>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    authorMapping: {
       ...
       **/
      nimbusLookup: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<U8aFixed>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parachainStaking: {
       ...
       **/
      atStake: AugmentedQuery<ApiType, (arg1: u32 | AnyNumber | Uint8Array, arg2: AccountId20 | string | Uint8Array) => Observable<PalletParachainStakingCollatorSnapshot>, [u32, AccountId20]> & QueryableStorageEntry<ApiType, [u32, AccountId20]>;
      /**
    ...
    xcmTransactor: {
       ...
       * from weight to fee
       **/
      destinationAssetFeePerSecond: AugmentedQuery<ApiType, (arg: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<u128>>, [XcmV1MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV1MultiLocation]>;
      /**
       ...
       **/
      transactInfoWithWeightLimit: AugmentedQuery<ApiType, (arg: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array) => Observable<Option<PalletXcmTransactorRemoteTransactInfoWithMaxWeight>>, [XcmV1MultiLocation]> & QueryableStorageEntry<ApiType, [XcmV1MultiLocation]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
