...
import type { CumulusPrimitivesParachainInherentParachainInherentData, EthereumTransactionTransactionV2, FrameSupportScheduleMaybeHashed, MoonriverRuntimeAssetConfigAssetRegistrarMetadata, MoonriverRuntimeOriginCaller, MoonriverRuntimeProxyType, MoonriverRuntimeXcmConfigAssetType, MoonriverRuntimeXcmConfigCurrencyId, MoonriverRuntimeXcmConfigTransactors, NimbusPrimitivesNimbusCryptoPublic, PalletAssetsDestroyWitness, PalletDemocracyConviction, PalletDemocracyVoteAccountVote, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletXcmTransactorCurrencyPayment, PalletXcmTransactorTransactWeights, SpRuntimeMultiSignature, XcmV0OriginKind, XcmV1MultiLocation, XcmV2WeightLimit, XcmVersionedMultiAsset, XcmVersionedMultiAssets, XcmVersionedMultiLocation, XcmVersionedXcm } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assetManager: {
      ...
      removeSupportedAsset: AugmentedSubmittable<(assetType: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeXcmConfigAssetType, u32]>;
      /**
       * Change the amount of units we are charging per execution second
       * for a given ForeignAssetType
       **/
      setAssetUnitsPerSecond: AugmentedSubmittable<(assetType: MoonriverRuntimeXcmConfigAssetType | { Xcm: any } | string | Uint8Array, unitsPerSecond: u128 | AnyNumber | Uint8Array, numAssetsWeightHint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeXcmConfigAssetType, u128, u32]>;
      /**
       * Generic tx
       **/
    ...
    proxy: {
       ...
       **/
      anonymous: AugmentedSubmittable<(proxyType: MoonriverRuntimeProxyType | 'Any' | 'NonTransfer' | 'Governance' | 'Staking' | 'CancelProxy' | 'Balances' | 'AuthorMapping' | 'IdentityJudgement' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeProxyType, u32, u16]>;
      /**
       ...
       * # </weight>
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<MoonriverRuntimeProxyType> | null | object | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<MoonriverRuntimeProxyType>, Call]>;
      /**
    ...
    xTokens: {
       ...
       * messages correctly.
       **/
      transfer: AugmentedSubmittable<(currencyId: MoonriverRuntimeXcmConfigCurrencyId | { SelfReserve: any } | { ForeignAsset: any } | { LocalAssetReserve: any } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [MoonriverRuntimeXcmConfigCurrencyId, u128, XcmVersionedMultiLocation, u64]>;
      /**
       * Transfer `MultiAsset`.
       * 
       * `dest_weight` is the weight for XCM execution on the dest chain, and
       ...
       * messages correctly.
       **/
      transferMulticurrencies: AugmentedSubmittable<(currencies: Vec<ITuple<[MoonriverRuntimeXcmConfigCurrencyId, u128]>> | ([MoonriverRuntimeXcmConfigCurrencyId | { SelfReserve: any } | { ForeignAsset: any } | { LocalAssetReserve: any } | string | Uint8Array, u128 | AnyNumber | Uint8Array])[], feeItem: u32 | AnyNumber | Uint8Array, dest: XcmVersionedMultiLocation | { V0: any } | { V1: any } | string | Uint8Array, destWeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<ITuple<[MoonriverRuntimeXcmConfigCurrencyId, u128]>>, u32, XcmVersionedMultiLocation, u64]>;
      /**
