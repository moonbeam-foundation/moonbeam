...
declare module '@polkadot/types/lookup' {
  ...
  /** @name MoonriverRuntimeProxyType (51) */
  ...
  /** @name MoonriverRuntimeXcmConfigCurrencyId (347) */
  ...
  /** @name MoonriverRuntimeXcmConfigTransactors (352) */
  ...
  /** @name MoonriverRuntimeOriginCaller (359) */
  export interface MoonriverRuntimeOriginCaller extends Enum {
    ...
    readonly type: 'System' | 'Void' | 'Ethereum' | 'CouncilCollective' | 'TechCommitteeCollective' | 'TreasuryCouncilCollective' | 'CumulusXcm' | 'PolkadotXcm';
  }
  ...
  /** @name MoonriverRuntimeRuntime (507) */
