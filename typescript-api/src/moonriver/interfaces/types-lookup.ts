...
declare module "@polkadot/types/lookup" {
  ...
  /** @name MoonriverRuntimeXcmConfigAssetType (374) */
  ...
  /** @name MoonriverRuntimeAssetConfigAssetRegistrarMetadata (375) */
  ...
  /** @name MoonriverRuntimeRuntimeHoldReason (533) */
  ...
  /** @name MoonriverRuntimeRuntime (750) */
  ...
  /** @name MoonriverRuntimeBridgeRejectObsoleteHeadersAndMessages (803) */
