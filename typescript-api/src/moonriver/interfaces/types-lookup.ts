...
declare module "@polkadot/types/lookup" {
  ...
  interface PalletBalancesEvent extends Enum {
    ...
    readonly asHeld: {
      readonly reason: MoonriverRuntimeRuntimeHoldReason;
      readonly who: AccountId20;
      readonly amount: u128;
    } & Struct;
  ...
  /** @name MoonriverRuntimeRuntimeHoldReason (38) */
  ...
  /** @name PalletXcmBridgeHubHoldReason (40) */
  ...
  /** @name PalletParachainStakingEvent (43) */
  ...
  /** @name PalletParachainStakingDelegationRequestsCancelledScheduledRequest (44) */
  ...
  /** @name PalletParachainStakingDelegationRequestsDelegationAction (45) */
  ...
  /** @name PalletParachainStakingDelegatorAdded (46) */
  ...
  /** @name PalletParachainStakingInflationDistributionConfig (48) */
  ...
  /** @name PalletParachainStakingInflationDistributionAccount (50) */
  interface PalletParachainStakingInflationDistributionAccount extends Struct {
    readonly account: AccountId20;
    readonly percent: Percent;
  }

  /** @name PalletAuthorSlotFilterEvent (52) */
  ...
  /** @name PalletAuthorMappingEvent (54) */
  ...
  /** @name MoonriverRuntimeProxyType (63) */
  ...
  /** @name PalletProxyDepositKind (65) */
  ...
  /** @name PalletMaintenanceModeEvent (66) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsRuntimeParametersKey (72) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsRuntimeConfigParametersKey (73) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsRuntimeConfigFeesTreasuryProportion (74) */
  type MoonriverRuntimeRuntimeParamsDynamicParamsRuntimeConfigFeesTreasuryProportion = Null;

  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersKey (75) */
  interface MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersKey extends Enum {
    readonly isDeposit: boolean;
    readonly type: "Deposit";
  }

  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessDeposit (76) */
  type MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessDeposit = Null;

  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsXcmConfigParametersKey (77) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsXcmConfigForeignAssetCreationDeposit (78) */
  type MoonriverRuntimeRuntimeParamsDynamicParamsXcmConfigForeignAssetCreationDeposit = Null;

  /** @name MoonriverRuntimeRuntimeParamsRuntimeParametersValue (80) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsRuntimeConfigParametersValue (81) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessParametersValue (82) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsXcmConfigParametersValue (84) */
  ...
  /** @name EvmCoreErrorExitRevert (96) */
  interface EvmCoreErrorExitRevert extends Enum {
    readonly isReverted: boolean;
    readonly type: "Reverted";
  }

  /** @name EvmCoreErrorExitFatal (97) */
  ...
  /** @name PalletConvictionVotingEvent (101) */
  ...
  /** @name PalletConvictionVotingVoteAccountVote (102) */
  ...
  /** @name FrameSupportPreimagesBounded (105) */
  ...
  /** @name CumulusPalletParachainSystemCall (111) */
  ...
  /** @name CumulusPalletParachainSystemParachainInherentBasicParachainInherentData (112) */
  ...
  /** @name PolkadotPrimitivesV9PersistedValidationData (113) */
  ...
  /** @name PalletRootTestingCall (136) */
  ...
  /** @name PalletParachainStakingCall (141) */
  ...
  /** @name PalletAuthorSlotFilterCall (145) */
  ...
  /** @name PalletAuthorMappingCall (146) */
  ...
  /** @name PalletMoonbeamOrbitersCall (147) */
  ...
  /** @name MoonriverRuntimeOriginCaller (150) */
  ...
  /** @name FrameSupportDispatchRawOrigin (151) */
  ...
  /** @name PalletEthereumRawOrigin (152) */
  ...
  /** @name MoonriverRuntimeGovernanceOriginsCustomOriginsOrigin (153) */
  ...
  /** @name StagingXcmV5JunctionNetworkId (163) */
  ...
  /** @name PalletEthereumXcmRawOrigin (173) */
  ...
  /** @name PalletMaintenanceModeCall (176) */
  ...
  /** @name AccountEthereumSignature (218) */
  ...
  /** @name PalletMoonbeamLazyMigrationsCall (222) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsRuntimeParameters (224) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsRuntimeConfigParameters (225) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsPalletRandomnessParameters (227) */
  ...
  /** @name MoonriverRuntimeRuntimeParamsDynamicParamsXcmConfigParameters (229) */
  ...
  /** @name EthereumTransactionEip7702AuthorizationListItem (238) */
  ...
  /** @name EthereumTransactionEip2930MalleableTransactionSignature (239) */
  ...
  /** @name EthereumTransactionTransactionV3 (241) */
  ...
  /** @name EthereumTransactionLegacyLegacyTransaction (242) */
  ...
  /** @name EthereumTransactionLegacyTransactionAction (243) */
  ...
  /** @name EthereumTransactionLegacyTransactionSignature (244) */
  ...
  /** @name EthereumTransactionEip2930Eip2930Transaction (246) */
  ...
  /** @name EthereumTransactionEip2930AccessListItem (248) */
  interface EthereumTransactionEip2930AccessListItem extends Struct {
    readonly address: H160;
    readonly storageKeys: Vec<H256>;
  }

  /** @name EthereumTransactionEip2930TransactionSignature (249) */
  ...
  /** @name EthereumTransactionEip1559Eip1559Transaction (250) */
  ...
  /** @name EthereumTransactionEip7702Eip7702Transaction (251) */
  ...
  /** @name PalletConvictionVotingCall (255) */
  ...
  /** @name FrameSupportTokensFungibleUnionOfNativeOrWithId (265) */
  ...
  /** @name StagingXcmV3MultiLocation (274) */
  interface StagingXcmV3MultiLocation extends Struct {
    readonly parents: u8;
    readonly interior: XcmV3Junctions;
  }

  /** @name XcmV3Junctions (275) */
  ...
  /** @name XcmV3JunctionNetworkId (278) */
  ...
  /** @name StagingXcmV4JunctionNetworkId (284) */
  ...
  /** @name XcmV3MultiassetMultiAssets (296) */
  interface XcmV3MultiassetMultiAssets extends Vec<XcmV3MultiAsset> {}

  /** @name XcmV3MultiAsset (298) */
  interface XcmV3MultiAsset extends Struct {
    readonly id: XcmV3MultiassetAssetId;
    readonly fun: XcmV3MultiassetFungibility;
  }

  /** @name XcmV3MultiassetAssetId (299) */
  ...
  /** @name XcmV3MultiassetFungibility (300) */
  ...
  /** @name XcmV3MultiassetAssetInstance (301) */
  ...
  /** @name StagingXcmV4AssetAssetInstance (328) */
  ...
  /** @name StagingXcmV4PalletInfo (331) */
  ...
  /** @name StagingXcmV4QueryResponseInfo (335) */
  ...
  /** @name StagingXcmV4AssetAssetFilter (336) */
  ...
  /** @name StagingXcmV4AssetWildAsset (337) */
  ...
  /** @name StagingXcmV4AssetWildFungibility (338) */
  ...
  /** @name StagingXcmV5AssetAssetInstance (347) */
  ...
  /** @name StagingXcmV5PalletInfo (353) */
  ...
  /** @name StagingXcmV5QueryResponseInfo (358) */
  ...
  /** @name StagingXcmV5AssetAssetFilter (359) */
  ...
  /** @name StagingXcmV5AssetWildAsset (360) */
  ...
  /** @name StagingXcmV5AssetWildFungibility (361) */
  ...
  /** @name StagingXcmV5AssetAssetTransferFilter (363) */
  ...
  /** @name PalletXcmTransactorCall (385) */
  ...
  /** @name MoonriverRuntimeXcmConfigTransactors (386) */
  ...
  /** @name PalletXcmTransactorCurrencyPayment (387) */
  ...
  /** @name MoonriverRuntimeXcmConfigCurrencyId (388) */
  ...
  /** @name PalletXcmTransactorCurrency (389) */
  ...
  /** @name PalletXcmTransactorTransactWeights (390) */
  ...
  /** @name PalletXcmTransactorHrmpOperation (392) */
  ...
  /** @name PalletXcmTransactorHrmpInitParams (393) */
  ...
  /** @name PolkadotParachainPrimitivesPrimitivesHrmpChannelId (394) */
  interface PolkadotParachainPrimitivesPrimitivesHrmpChannelId extends Struct {
    readonly sender: u32;
    readonly recipient: u32;
  }

  /** @name PalletEthereumXcmCall (395) */
  ...
  /** @name XcmPrimitivesEthereumXcmEthereumXcmTransaction (396) */
  ...
  /** @name XcmPrimitivesEthereumXcmEthereumXcmTransactionV1 (397) */
  ...
  /** @name XcmPrimitivesEthereumXcmEthereumXcmFee (398) */
  ...
  /** @name XcmPrimitivesEthereumXcmManualEthereumXcmFee (399) */
  ...
  /** @name XcmPrimitivesEthereumXcmEthereumXcmTransactionV2 (402) */
  ...
  /** @name XcmPrimitivesEthereumXcmEthereumXcmTransactionV3 (403) */
  ...
  /** @name PalletMessageQueueCall (406) */
  ...
  /** @name CumulusPrimitivesCoreAggregateMessageOrigin (407) */
  ...
  /** @name PalletMoonbeamForeignAssetsCall (408) */
  ...
  /** @name PalletXcmWeightTraderCall (410) */
  ...
  /** @name PalletEmergencyParaXcmCall (411) */
  ...
  /** @name PalletMigrationsMigrationCursor (414) */
  ...
  /** @name PalletMigrationsActiveCursor (415) */
  ...
  /** @name PalletMigrationsHistoricCleanupSelector (417) */
  ...
  /** @name PalletBridgeGrandpaCall (421) */
  ...
  /** @name BpHeaderChainJustificationGrandpaJustification (422) */
  ...
  /** @name FinalityGrandpaCommit (423) */
  ...
  /** @name SpConsensusGrandpaAppSignature (424) */
  interface SpConsensusGrandpaAppSignature extends U8aFixed {}

  /** @name SpConsensusGrandpaAppPublic (425) */
  interface SpConsensusGrandpaAppPublic extends U8aFixed {}

  /** @name FinalityGrandpaSignedPrecommit (427) */
  ...
  /** @name FinalityGrandpaPrecommit (428) */
  interface FinalityGrandpaPrecommit extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name BpHeaderChainInitializationData (429) */
  ...
  /** @name BpRuntimeBasicOperatingMode (432) */
  ...
  /** @name PalletBridgeParachainsCall (433) */
  ...
  /** @name BpMessagesMessagesOperatingMode (440) */
  ...
  /** @name BpMessagesTargetChainFromBridgedChainMessagesProof (441) */
  ...
  /** @name BpMessagesSourceChainFromBridgedChainMessagesDeliveryProof (443) */
  ...
  /** @name BpMessagesUnrewardedRelayersState (444) */
  ...
  /** @name PalletXcmBridgeHubCall (445) */
  ...
  /** @name XcmVersionedInteriorLocation (446) */
  ...
  /** @name PalletCrowdloanRewardsEvent (457) */
  ...
  /** @name StagingXcmV5TraitsOutcome (460) */
  ...
  /** @name PalletXcmTransactorEvent (464) */
  ...
  /** @name PalletXcmTransactorRemoteTransactInfoWithMaxWeight (465) */
  ...
  /** @name PalletEthereumXcmEvent (466) */
  ...
  /** @name PalletErc20XcmBridgeEvent (467) */
  interface PalletErc20XcmBridgeEvent extends Enum {
    readonly isTeleportableErc20Added: boolean;
    readonly asTeleportableErc20Added: {
      readonly contract: H160;
    } & Struct;
    readonly isTeleportableErc20Activated: boolean;
    readonly asTeleportableErc20Activated: {
      readonly contract: H160;
    } & Struct;
    readonly isTeleportableErc20Removed: boolean;
    readonly asTeleportableErc20Removed: {
      readonly contract: H160;
    } & Struct;
    readonly isTeleportableErc20Purged: boolean;
    readonly asTeleportableErc20Purged: {
      readonly contract: H160;
    } & Struct;
    readonly isTeleportableErc20ForceRemoved: boolean;
    readonly asTeleportableErc20ForceRemoved: {
      readonly contract: H160;
      readonly statusBefore: PalletErc20XcmBridgeTeleportableErc20Status;
      readonly lockedSupply: U256;
    } & Struct;
    readonly type:
  ...
  /** @name PalletErc20XcmBridgeTeleportableErc20Status (468) */
  interface PalletErc20XcmBridgeTeleportableErc20Status extends Enum {
    readonly isRegistered: boolean;
    readonly isActive: boolean;
    readonly isDeregistered: boolean;
    readonly type: "Registered" | "Active" | "Deregistered";
  }
  ...
  /** @name PalletMoonbeamForeignAssetsEvent (471) */
  ...
  /** @name PalletXcmWeightTraderEvent (472) */
  ...
  /** @name PalletEmergencyParaXcmEvent (473) */
  ...
  /** @name PalletMigrationsEvent (474) */
  ...
  /** @name PalletRandomnessEvent (475) */
  ...
  /** @name PalletBridgeGrandpaEvent (476) */
  ...
  /** @name BpHeaderChainHeaderFinalityInfo (477) */
  ...
  /** @name PalletBridgeMessagesEvent (481) */
  ...
  /** @name BpMessagesReceptionResult (486) */
  ...
  /** @name BpRuntimeMessagesMessageDispatchResult (487) */
  ...
  /** @name BpMessagesDeliveredMessages (488) */
  interface BpMessagesDeliveredMessages extends Struct {
    readonly begin: u64;
    readonly end: u64;
  }

  /** @name PalletXcmBridgeHubEvent (489) */
  ...
  /** @name FrameSystemLastRuntimeUpgradeInfo (493) */
  ...
  /** @name CumulusPalletParachainSystemBlockWeightBlockWeightMode (506) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentAncestor (509) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentUsedBandwidth (510) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate (512) */
  interface CumulusPalletParachainSystemUnincludedSegmentHrmpChannelUpdate extends Struct {
    readonly msgCount: u32;
    readonly totalBytes: u32;
  }

  /** @name PolkadotPrimitivesV9UpgradeGoAhead (516) */
  ...
  /** @name CumulusPalletParachainSystemUnincludedSegmentSegmentTracker (517) */
  ...
  /** @name PolkadotPrimitivesV9UpgradeRestriction (519) */
  interface PolkadotPrimitivesV9UpgradeRestriction extends Enum {
    readonly isPresent: boolean;
    readonly type: "Present";
  }

  /** @name CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot (520) */
  ...
  /** @name CumulusPalletParachainSystemRelayStateSnapshotRelayDispatchQueueRemainingCapacity (521) */
  ...
  /** @name PolkadotPrimitivesV9AbridgedHrmpChannel (524) */
  ...
  /** @name PolkadotPrimitivesV9AbridgedHostConfiguration (525) */
  ...
  /** @name PolkadotPrimitivesV9AsyncBackingAsyncBackingParams (526) */
  interface PolkadotPrimitivesV9AsyncBackingAsyncBackingParams extends Struct {
    readonly maxCandidateDepth: u32;
    readonly allowedAncestryLen: u32;
  }

  /** @name CumulusPalletParachainSystemParachainInherentInboundMessageId (531) */
  interface CumulusPalletParachainSystemParachainInherentInboundMessageId extends Struct {
    readonly sentAt: u32;
    readonly reverseIdx: u32;
  }

  /** @name PolkadotCorePrimitivesOutboundHrmpMessage (533) */
  interface PolkadotCorePrimitivesOutboundHrmpMessage extends Struct {
    readonly recipient: u32;
    readonly data: Bytes;
  }

  /** @name CumulusPalletParachainSystemPoVMessages (535) */
  ...
  /** @name CumulusPalletParachainSystemError (536) */
  ...
  /** @name FrameSupportTokensMiscIdAmountRuntimeHoldReason (545) */
  interface FrameSupportTokensMiscIdAmountRuntimeHoldReason extends Struct {
    readonly id: MoonriverRuntimeRuntimeHoldReason;
    readonly amount: u128;
  }

  /** @name FrameSupportTokensMiscIdAmountRuntimeFreezeReason (548) */
  interface FrameSupportTokensMiscIdAmountRuntimeFreezeReason extends Struct {
    readonly id: MoonriverRuntimeRuntimeFreezeReason;
    readonly amount: u128;
  }

  /** @name MoonriverRuntimeRuntimeFreezeReason (549) */
  interface MoonriverRuntimeRuntimeFreezeReason extends Enum {
  ...
  /** @name PalletParachainStakingFreezeReason (550) */
  ...
  /** @name PalletTransactionPaymentReleases (553) */
  ...
  /** @name FrameSupportStorageNoDrop (554) */
  interface FrameSupportStorageNoDrop extends FrameSupportTokensFungibleImbalance {}

  /** @name FrameSupportTokensFungibleImbalance (555) */
  interface FrameSupportTokensFungibleImbalance extends Struct {
    readonly amount: u128;
  }

  /** @name PalletParachainStakingRoundInfo (556) */
  ...
  /** @name PalletParachainStakingDelegator (557) */
  ...
  /** @name PalletParachainStakingCandidateMetadata (562) */
  ...
  /** @name PalletParachainStakingCapacityStatus (563) */
  ...
  /** @name PalletParachainStakingCandidateBondLessRequest (565) */
  interface PalletParachainStakingCandidateBondLessRequest extends Struct {
    readonly amount: u128;
    readonly whenExecutable: u32;
  }

  /** @name PalletParachainStakingCollatorStatus (566) */
  ...
  /** @name PalletParachainStakingDelegationRequestsScheduledRequest (569) */
  ...
  /** @name PalletParachainStakingBondWithAutoCompound (581) */
  ...
  /** @name PalletParachainStakingDelayedPayout (582) */
  ...
  /** @name PalletParachainStakingInflationInflationInfo (583) */
  ...
  /** @name PalletParachainStakingError (584) */
  interface PalletParachainStakingError extends Enum {
    ...
    readonly isEmptyMigrationBatch: boolean;
    readonly type:
      | "DelegatorDNE"
  ...
  /** @name PalletAuthorInherentError (585) */
  ...
  /** @name PalletAuthorMappingRegistrationInfo (586) */
  ...
  /** @name PalletAuthorMappingError (587) */
  ...
  /** @name PalletMoonbeamOrbitersCollatorPoolInfo (588) */
  ...
  /** @name PalletProxyProxyDefinition (597) */
  ...
  /** @name PalletProxyAnnouncement (601) */
  ...
  /** @name PalletIdentityRegistration (605) */
  ...
  /** @name PalletIdentityRegistrarInfo (613) */
  ...
  /** @name PalletMoonbeamLazyMigrationsError (625) */
  ...
  /** @name EthereumReceiptReceiptV4 (634) */
  ...
  /** @name PalletSchedulerScheduled (646) */
  ...
  /** @name PalletSchedulerRetryConfig (648) */
  ...
  /** @name PalletPreimageOldRequestStatus (650) */
  ...
  /** @name PalletPreimageRequestStatus (653) */
  ...
  /** @name PalletConvictionVotingVoteVoting (661) */
  ...
  /** @name PalletConvictionVotingVoteCasting (662) */
  ...
  /** @name PalletConvictionVotingDelegations (666) */
  interface PalletConvictionVotingDelegations extends Struct {
    readonly votes: u128;
    readonly capital: u128;
  }

  /** @name PalletConvictionVotingVotePriorLock (667) */
  interface PalletConvictionVotingVotePriorLock extends ITuple<[u32, u128]> {}

  /** @name PalletConvictionVotingVoteDelegating (668) */
  ...
  /** @name PalletConvictionVotingError (672) */
  ...
  /** @name PalletReferendaReferendumInfo (673) */
  ...
  /** @name PalletReferendaReferendumStatus (674) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (706) */
  ...
  /** @name PalletCrowdloanRewardsError (708) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelDetails (713) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundState (714) */
  ...
  /** @name CumulusPalletXcmpQueueOutboundChannelFlags (715) */
  interface CumulusPalletXcmpQueueOutboundChannelFlags extends Struct {
    readonly bits: u32;
  }

  /** @name CumulusPalletXcmpQueueQueueConfigData (719) */
  ...
  /** @name CumulusPalletXcmpQueueError (720) */
  ...
  /** @name PalletXcmVersionMigrationStage (731) */
  ...
  /** @name PalletXcmRemoteLockedFungibleRecord (733) */
  ...
  /** @name PalletXcmAuthorizedAliasesEntry (740) */
  ...
  /** @name FrameSupportStorageDisabled (741) */
  type FrameSupportStorageDisabled = Null;

  /** @name PalletXcmMaxAuthorizedAliases (742) */
  type PalletXcmMaxAuthorizedAliases = Null;

  /** @name XcmRuntimeApisAuthorizedAliasesOriginAliaser (744) */
  interface XcmRuntimeApisAuthorizedAliasesOriginAliaser extends Struct {
    readonly location: XcmVersionedLocation;
    readonly expiry: Option<u64>;
  }

  /** @name PalletXcmError (746) */
  ...
  /** @name PalletXcmErrorsExecutionError (747) */
  ...
  /** @name PalletXcmTransactorRelayIndicesRelayChainIndices (748) */
  ...
  /** @name PalletXcmTransactorError (749) */
  ...
  /** @name PalletEthereumXcmError (750) */
  ...
  /** @name PalletErc20XcmBridgeError (751) */
  interface PalletErc20XcmBridgeError extends Enum {
    readonly isErc20AlreadyTeleportable: boolean;
    readonly isErc20NotTeleportable: boolean;
    readonly isErc20AlreadyRemoved: boolean;
    readonly type: "Erc20AlreadyTeleportable" | "Erc20NotTeleportable" | "Erc20AlreadyRemoved";
  }

  /** @name PalletMessageQueueBookState (752) */
  ...
  /** @name PalletMessageQueueNeighbours (754) */
  ...
  /** @name PalletMessageQueuePage (756) */
  ...
  /** @name PalletMessageQueueError (758) */
  ...
  /** @name PalletMoonbeamForeignAssetsAssetStatus (760) */
  ...
  /** @name PalletXcmWeightTraderError (766) */
  ...
  /** @name PalletEmergencyParaXcmXcmMode (767) */
  ...
  /** @name PalletRandomnessRequestInfo (773) */
  ...
  /** @name PalletRandomnessRequestType (774) */
  ...
  /** @name BpHeaderChainHeaderChainError (788) */
  ...
  /** @name BpRuntimeStorageProofStorageProofError (789) */
  ...
  /** @name BpMessagesInboundLaneData (790) */
  ...
  /** @name BpMessagesOutboundLaneData (794) */
  ...
  /** @name BpMessagesMessageKey (795) */
  interface BpMessagesMessageKey extends Struct {
    readonly laneId: H256;
    readonly nonce: u64;
  }

  /** @name PalletBridgeMessagesError (797) */
  ...
  /** @name PalletBridgeMessagesLanesManagerLanesManagerError (798) */
  ...
  /** @name BpMessagesVerificationError (799) */
  ...
  /** @name PalletBridgeMessagesOutboundLaneReceptionConfirmationError (800) */
  ...
  /** @name BpXcmBridgeHubBridgeState (802) */
  ...
  /** @name PalletXcmBridgeHubError (803) */
  ...
  /** @name BpXcmBridgeHubBridgeLocationsError (804) */
  ...
  /** @name CumulusPalletWeightReclaimStorageWeightReclaim (806) */
  ...
  /** @name MoonriverRuntimeBridgeRejectObsoleteHeadersAndMessages (817) */
  type MoonriverRuntimeBridgeRejectObsoleteHeadersAndMessages = Null;

  /** @name FrameMetadataHashExtensionCheckMetadataHash (818) */
  interface FrameMetadataHashExtensionCheckMetadataHash extends Struct {
    readonly mode: FrameMetadataHashExtensionMode;
  }

  /** @name FrameMetadataHashExtensionMode (819) */
